...
+ Reizen {#orchestrate-journeys}
   ...
   + Uw reizen beheren {#manage-journey}
      + [Beheer van profieltoegang](using/building-journeys/entry-management.md)
      + [Tijdzonebeheer](using/building-journeys/timezone-management.md)
      + [Beëindig je traject](using/building-journeys/end-journey.md)
      + [Een journey naar een andere sandbox kopiëren](using/building-journeys/copy-to-sandbox.md)
      + [Los je traject op](using/building-journeys/troubleshooting.md)
      + [ integreer met de Intelligente Diensten ](using/building-journeys/ai-services-overview.md)
...
+ Campagnes {#campaigns}
   ...
   + [Een campagne evalueren en activeren](using/campaigns/review-activate-campaign.md)
...
+ Communicatiekanalen {#channels}
   ...
   + {#in-app}
      ...
      + [Een webbericht in de app maken](using/in-app/create-in-app-web.md)
      + [Ontwerp uw In-app-inhoud](using/in-app/design-in-app.md)
      + [Uw In-app-melding controleren en verzenden](using/in-app/send-in-app.md)
   ...
   + {#code-based-experience}
      ...
      + [Creëer op code gebaseerde ervaringsconfiguratie](using/code-based/code-based-configuration.md)
      + [Voorbeelden van implementatiemethoden](using/code-based/code-based-implementation-samples.md)
      + [Creëer op code gebaseerde ervaringen](using/code-based/create-code-based.md)
...
+ Landingspagina’s {#landing-pages}
   ...
   + Inhoud ontwerpen {#landing-pages-design}
      + [Over het ontwerpen van de openingspagina](using/landing-pages/design-lp.md)
...
+ Inhoudsbeheer {#content-management}
   + Werken met de AI-assistent {#ai-assistant}
      ...
      + [Webgeneratie met AI](using/content-management/generative-web.md)
   ...
   + Werken met meertalige inhoud {#content-multilingual}
      + [Aan de slag met meertalige content](using/content-management/multilingual-gs.md)
      + [Meertalige content maken met handmatige vertaling](using/content-management/multilingual-manual.md)
      + [Creëer meertalige content met geautomatiseerde vertaling](using/content-management/multilingual-automated.md)
   + {#content-experiment}
      + [Aan de slag met het experimenteren met content](using/content-management/get-started-experiment.md)
      + [Een contentexperiment maken](using/content-management/content-experiment.md)
      + Technische opmerkingen {#technotes}
         + [Statische berekeningen begrijpen](using/content-management/experiment-calculations.md)
         + [Statische berekeningen in het Experimentenrapport begrijpen](using/content-management/experiment-report-calculations.md)
   + {#assets-images}
   ...
   + Personalisatie {#personalization}
      ...
      + {#expression-editor}
         ...
         + [ voeg attributen aan favorieten toe ](using/personalization/personalization-favorites.md)
   ...
   + Inhoudssjablonen {#content-templates}
      ...
      + [Sjablonen voor inhoud maken](using/content-management/create-content-templates.md)
      + [Inhoud in e-mailsjablonen vergrendelen](using/content-management/content-locking.md)
      + [Sjablonen voor inhoud testen](using/content-management/test-content-templates.md)
      + [Inhoudssjablonen gebruiken](using/content-management/use-content-templates.md)
   + Herbruikbare contentfragmenten {#fragments}
...
+ Soorten publiek, profielen en identiteit {#audiences-profiles-identities}
   + Soorten publiek {#audiences}
      ...
      + Doelgroepen samenstellen {#audience-orchestration}
         + [Aan de slag met doelgroepcompositie](using/audience/get-started-audience-orchestration.md)
         + [Compositieworkflows maken](using/audience/create-compositions.md)
         + [Werken met het compositicanvas](using/audience/composition-canvas.md)
         + [Toegang tot en beheer doelgroepen](using/audience/access-audiences.md)
...
+ {#reporting}
   ...
   + Bijgewerkte rapportervaring {#channel-report}
      + [Aan de slag met de bijgewerkte rapportage-ervaring](using/reports/report-gs-cja.md)
      ...
      + {#reporting}
         ...
         + [Rapport voor contentkaartcampagne](using/reports/campaign-global-report-cja-content.md)
         + [Rapport voor directmailcampagne](using/reports/campaign-global-report-cja-direct.md)
   ...
   + Reisrapporten {#reports}
      + [Trajectrapporten maken](using/reports/sharing-overview.md)
      ...
      + Gebeurtenisvelden voor oudere stappen {#legacy-step-event-fields}
         ...
         + [Velden voor het ophalen van gegevens](using/reports/sharing-fetch-fields.md)
...
+ {#decisioning}
   + Beslissingsbeheer {#offer-decisioning}
      + Aan de slag met beslissingsbeheer {#get-started-decision}
         + [Informatie over besluitvormingsbeheer](using/offers/get-started/starting-offer-decisioning.md)
      ...
      + Classificaties maken {#rankings}
         + [Aan de slag met rangschikkingen](using/offers/ranking/get-started-rankings.md)
         + [Beoordelingsformules](using/offers/ranking/create-ranking-formulas.md)
      ...
      + API-referentie {#api-reference}
         ...
         + Aanbiedingen maken en beheren met behulp van API’s {#offers-api}
            ...
            + Verouderde API&#39;s {#legacy-api}
               + [Informatie over verouderde API&#39;s](using/offers/api-reference/offers-api/legacy-apis/about-legacy-apis.md)
               + Plaatsingen {#placements}
   ...
   + Beslissing (LA) {#experience-decisioning}
      ...
      + API-referentie {#api-reference}
         ...
         + Items verzamelen {#items-collections}
            + [Itemverzamelingen maken](using/experience-decisioning/api-reference/items-collections/create.md)
            ...
            + [Items collecties bijwerken](using/experience-decisioning/api-reference/items-collections/update.md)
