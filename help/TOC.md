...
+ Inhoudsbeheer {#content-management}
   + AI-assistent voor het genereren van inhoud {#ai-assistant}
   ...
   + Personalisatie {#personalization}
      ...
      + Werken met de verpersoonlijkingseditor {#expression-editor}
         + [ krijgen begonnen met de verpersoonlijkingsredacteur ](using/personalization/personalization-build-expressions.md)
...
+ Beslissingsmogelijkheden {#decisioning}
   ...
   + Decisioning {#experience-decisioning}
      ...
      + API-referentie {#api-reference}
         + Aanbiedingsitems maken en beheren {#create-manage}
