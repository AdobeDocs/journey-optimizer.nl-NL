...
+ Aan de slag {#get-started}
   ...
   + Efficiënt werken {#work-efficiently}
      ...
      + [Reizen vs. campagnes](using/start/journeys-vs-campaigns.md)
+ Journeys {#orchestrate-journeys}
   + [Aan de slag met reizen](using/building-journeys/journey.md)
   + [Aan de slag met de reis](using/building-journeys/journey-get-started.md)
   + [Reistypen en selectiehandleiding](using/building-journeys/journey-types-selection.md)
   ...
   + Een journey maken {#create-journey}
      ...
      + [Verzenden met gebruik van golven tijdens reizen](using/building-journeys/send-using-waves.md)
   ...
   + Uw reizen beheren {#manage-journey}
      ...
      + [Organiseren met tags](using/building-journeys/tags.md)
   ...
   + Expressies maken {#building-advanced-conditions-journeys}
      ...
      + Functies {#main-functions-journey}
         ...
         + [inAudience, functie](using/building-journeys/functions/functioninaudience.md)
   ...
   + Gebruiksscenario&#39;s {#journey-use-cases}
      ...
      + [E-mails alleen verzenden tijdens weekdagen](using/building-journeys/weekday-email-uc.md)
...
+ Campagnes {#campaigns}
   ...
   + Geordende campagnes {#orchestrated-campaigns}
      ...
      + De database opvragen {#query-database}
         ...
         + [Werken met vooraf gedefinieerde filters](using/orchestrated/predefined-filters.md)
      ...
      + Gebruikskwesties leren {#use-cases}
         + [Updates van wenslijstitems verzenden](using/orchestrated/wishlist-uc.md)
      ...
      + Geavanceerde bewerkingen {#orchestrated-advanced}
         + [Trigger Orchestrated campagnes gebruikend een signaal](using/orchestrated/trigger-orchestrated-campaign.md)
+ Conflict en prioriteit {#conflict-prioritization}
   ...
   + Reisarbitrage {#journey-arbitration}
      + [Formules gebruiken om reizen te rangschikken](using/conflict-prioritization/journey-ranking-formulas.md)
      + [AI-modellen gebruiken om reizen te rangschikken](using/conflict-prioritization/journey-ai-models.md)
+ Testen en goedkeuren {#test}
   + [Testen, valideren en goedkeuren](/help/rp_landing_pages/test-landing-page.md)
...
+ Monitor en problemen oplossen {#monitor}
   + [Aan de slag met bewaking en probleemoplossing](/help/rp_landing_pages/troubleshoot-journey-landing-page.md)
   + [Tekstspatiëring in Journey Optimizer](using/start/get-started-tracking.md)
...
+ Communicatiekanalen {#channels}
   ...
   + SMS/MMS/RCS-kanaal {#sms}
      ...
      + [Aanbevolen procedures voor optimalisatie van de SMS-kosten](using/sms/sms-cost-optimization.md)
      + SMS/MMS/RCS-kanaal configureren {#configure-sms}
         ...
         + [Webhaak maken](using/sms/sms-webhook.md)
   ...
   + Live activiteiten {#live-activity}
      ...
      + Actief activiteitenkanaal configureren {#configure}
         ...
         + [Live-activiteit configureren, integratie met SDK](using/mobile-live/mobile-live-configuration-sdk.md)
+ Inhoudsbeheer {#content-management}
   ...
   + Herbruikbare inhoudsfragmenten {#fragments}
      ...
      + [Contextafhankelijke kenmerken toevoegen aan gepubliceerde fragmenten](using/content-management/manage-fragments-contextual-attributes.md)
   ...
   + AI Assistant voor het genereren van inhoud {#ai-assistant}
      ...
      + Merken {#brands}
         ...
         + [Je merken aanpassen](using/content-management/brands-personalize.md)
         + [Generatieve modellen maken en beheren](using/content-management/generative-models.md)
         + [Uw inhoud evalueren](using/content-management/brands-score.md)
...
+ Beslissingsmogelijkheden {#decisioning}
   ...
   + Beslissing {#experience-decisioning}
      ...
      + Migreren naar beslissing {#migrate-to-decisioning}
         + [Voordelen van migratie naar besluitvorming](using/experience-decisioning/migrate-to-decisioning.md)
         + [Migratie-API voor besluitvorming](using/experience-decisioning/decisioning-migration-api.md)
      ...
      + Classificaties maken {#experience-decisioning-rankings}
         ...
         + AI-modellen {#experience-decisioning-ai-models}
            ...
            + [De prestaties van uw AI-modellen controleren](using/experience-decisioning/ranking/ai-model-observability.md)
      ...
      + Aanbiedingen leveren met behulp van besluitvormingsbeleid {#decision-policies}
         ...
         + [Hefboomfragmenten in besluitvormingsbeleid](using/experience-decisioning/fragments-decision-policies.md)
   ...
   + Beslissingsbeheer {#offer-decisioning}
      ...
      + Aanbiedingen maken en beheren {#managing-offers-in-the-offer-library}
         ...
         + Aanbiedingen configureren {#configure-offers}
            ...
            + [Ondersteunde functies in de verpersoonlijkingseditor](using/offers/offer-library/personalization-editor-supported-functions.md)
...
+ Kanaalconfiguratie {#configuration}
   ...
   + E-mailsubdomeinen delegeren {#delegate-subdomains}
      ...
      + [Migreren van CNAME naar aangepaste delegatie](using/configuration/custom-subdomain-migration.md)
