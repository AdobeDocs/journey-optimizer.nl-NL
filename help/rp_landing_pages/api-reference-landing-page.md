...
title: API-naslag
description: Leer om de bibliotheek-API en leverings-API's van de Aanbieding te gebruiken om Beslissingsbeheer in uw workflows te integreren en persoonlijke aanbiedingen op schaal te leveren.
...
[API&#39;s voor levering verkennen](offer-delivery-api-landing-page.md)
:::

:::
![icon]( https://cdn.experienceleague.adobe.com/icons/list-check.svg)

Aanbiedingen maken en beheren met behulp van API&#39;s

Toegang API-referenties voor het beheer van plaatsingen, beslissingsregels, verzamelingskwalificatietekens, persoonlijke aanbiedingen, verzamelingen, fallback-aanbiedingen en beslissingen.

[Bladeren in de bibliotheek-API van de aanbieding](../using/offers/api-reference/getting-started.md)
:::
