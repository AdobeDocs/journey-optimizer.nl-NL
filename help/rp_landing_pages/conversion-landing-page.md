...
[Leer hoe u de functie toBool gebruikt](../using/building-journeys/functions/conversion-functions.md#toBool)
:::
...
[Leer hoe u de functie toDateOnly gebruikt](../using/building-journeys/functions/conversion-functions.md#toDateOnly)
:::
...
[Leer hoe u de functie toDateTime gebruikt](../using/building-journeys/functions/conversion-functions.md#toDateTime)
:::
...
[Leer hoe u de functie toDateTimeOnly gebruikt](../using/building-journeys/functions/conversion-functions.md#toDateTimeOnly)
:::
...
[Leer hoe u de functie toDecimal gebruikt](../using/building-journeys/functions/conversion-functions.md#toDecimal)
:::
...
[Leer hoe u de functie toDuration gebruikt](../using/building-journeys/functions/conversion-functions.md#toDuration)
:::
...
- **[toInteger Functie](../using/building-journeys/functions/conversion-functions.md#toInteger)** - zet diverse gegevenstypes in gehelen om gebruikend de toInteger functie.
- **[toString Functie](../using/building-journeys/functions/conversion-functions.md#toString)** - zet gegevenstypes in hun koordvertegenwoordiging om gebruikend de toString functie.
