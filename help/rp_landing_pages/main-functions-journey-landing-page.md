...
- **[Wiskundige Functies](../using/building-journeys/functions/math-functions.md)** - onderzoek wiskundige functies als willekeurig en rond voor numerieke berekeningen in reisuitdrukkingen.
- **[Functies van het Koord in Adobe Journey Optimizer](../using/building-journeys/functions/string-functions.md)** - Manipuleer koorden gebruikend functies voor aaneenschakeling, substring extractie, het formatteren, en meer in reisuitdrukkingen.
