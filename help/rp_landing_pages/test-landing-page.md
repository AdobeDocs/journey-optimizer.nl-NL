...
<img alt="Verstuur aan tijd gebonden berichten" src="../using/assets/do-not-localize/calendar.jpeg">
</a>
<div>
...
**[de werkschema&#39;s van de Goedkeuring](../using/test-approve/gs-approval.md)** - het multi-step overzichtsproces die de goedkeuring van belanghebbenden vóór activering vereisen. Vereist configuratie goedkeuringsbeleid. [ de goedkeuringen van de opstelling ](../using/test-approve/gs-approval.md) | [ creeer beleid ](../using/test-approve/approval-policies.md)
