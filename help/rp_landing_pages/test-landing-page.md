...
Synthetische klantprofielen (geen echte klanten) die worden gebruikt om gepersonaliseerde inhoud voor te vertonen. Gemarkeerd in Real-Time Customer Profile Service. Vereist voor testmodus en voorvertoning van inhoud. [&#x200B; Leer meer &#x200B;](../using/content-management/test-profiles.md) | [&#x200B; Leer hoe te om testprofielen tot stand te brengen &#x200B;](../using/audience/creating-test-profiles.md)

+++

+++**wijze van de Test**

De simulatieeigenschap van de reis die testprofielen door reiswegen verzendt. Beperkingen: alleen conceptreizen; vereist naamruimte, alleen testprofielen. [Meer informatie](../using/building-journeys/testing-the-journey.md)

+++

+++**Droog looppas**

Analyseprogramma voor de uitvoering van de reis dat paden traceert zonder berichten te verzenden of API-aanroepen te maken. Hoofdlettergebruik: logica valideren zonder bronnen te verbruiken. [Meer informatie](../using/building-journeys/journey-dry-run.md)

+++

+++**de inputgegevens van de Steekproef**

CSV- of JSON-bestanden met profielkenmerkwaarden voor het testen van personalisatie. Ondersteunt maximaal 30 varianten. U kunt ook testprofielen maken. [Meer informatie](../using/test-approve/simulate-sample-input.md)

+++

+++**Zaadlijsten**

E-mailadressen van interne belanghebbenden worden automatisch opgenomen in de feitelijke leveringen (niet het verzenden van tests). Alleen e-mailkanaal. Gebruik hoofdletters/kleine letters: kwaliteitsbewaking en naleving. [Meer informatie](../using/configuration/seed-lists.md)

+++

+++**experimenten van de Inhoud**

A/B-tests of multigewapende bandiproeven waarbij variaties in de inhoud worden vergeleken. Alleen campagnes, niet beschikbaar op reizen. [&#x200B; Leer meer &#x200B;](../using/content-management/get-started-experiment.md) | [&#x200B; creeer experimenten &#x200B;](../using/content-management/content-experiment.md)

+++

+++**Proofs**

Test e-mailleveringen die naar specifieke e-mailadressen zijn verzonden met behulp van testprofielgegevens. Verschil van zaadlijsten (proefdrukken zijn handtest verzendt, zaadlijsten zijn automatische exemplaren van de belanghebbende). [Meer informatie](../using/content-management/proofs.md)

+++

+++**de opsporing van het Conflict**

Gereedschap dat overlappende campagnes en reizen identificeert die op hetzelfde publiek gericht zijn. Beperkte reisondersteuning: alleen eenheids-, Audience Qualification- en Read Audience-typen. [&#x200B; Leer meer &#x200B;](../using/conflict-prioritization/conflicts.md) | [&#x200B; Leer over conflictbeheer &#x200B;](../using/conflict-prioritization/gs-conflict-prioritization.md)

+++

+++**de werkschema&#39;s van de Goedkeuring**

Meerfasebeoordelingsproces dat goedkeuring van de belanghebbende vereist alvorens activering. Vereist configuratie goedkeuringsbeleid. [&#x200B; Leer meer &#x200B;](../using/test-approve/gs-approval.md) | [&#x200B; creeer beleid &#x200B;](../using/test-approve/approval-policies.md)

+++

+++**het Teruggeven tests**

Validatie van de e-mailweergave voor alle e-mailclients (Gmail, Outlook, Apple Mail) en apparaten. Vereist Litmus-integratie. [Meer informatie](../using/content-management/rendering.md)

+++

+++**de playground van Personalization**

Interactieve leeromgeving om met verpersoonlijkingssyntaxis en testuitdrukkingen met steekproefgegevens te experimenteren. Geen live datasets vereist. [Meer informatie](../using/personalization/personalize.md#playground)
