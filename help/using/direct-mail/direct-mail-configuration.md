...
1. A [ dossier dat configuratie ](#file-routing-configuration) verplettert om de server te specificeren waar het dossier zal worden uitgevoerd en het dossier, indien nodig coderen.
...
1. A [ direct-mailconfiguratie ](#direct-mail-configuration) die het dossier zal van verwijzingen voorzien dat configuratie verplettert. Als u geen dossier gevormd hebt dat optie verplettert, zult u geen directe-mailconfiguratie kunnen tot stand brengen.
...
>additional-url="https://experienceleague.adobe.com/en/docs/journey-optimizer/using/communication-channels/direct-mail/create-direct-mail" text="Een direct-mailbericht maken"
...
1. Selecteer SFTP als **[!UICONTROL Server type]** om de direct-mailbestanden te exporteren.
...
1. Selecteer Azure **[!UICONTROL Server type]** om de direct-mailbestanden te exporteren.
...
>additional-url="https://experienceleague.adobe.com/en/docs/journey-optimizer/using/communication-channels/direct-mail/direct-mail-configuration#file-routing-configuration" text="Bestands-routering configureren"
