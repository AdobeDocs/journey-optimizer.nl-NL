...
* **slechts het Beheer van het Besluit** - Deze functionaliteit wordt gesteund in Beslissingsbeheer slechts, niet in Beslissing.
...
In Beslissingsbeheer, slechts worden bepaalde functies gesteund wanneer het personaliseren van inhoud-zie [&#x200B; Gesteunde functies in de verpersoonlijkingsredacteur &#x200B;](offer-library/personalization-editor-supported-functions.md).
