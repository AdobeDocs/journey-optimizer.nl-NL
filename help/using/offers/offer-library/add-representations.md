...
>
>Wanneer u de verpersoonlijkingsredacteur in Beslissingsbeheer gebruikt, slechts wordt een ondergroep van functies gesteund-zie [&#x200B; Gesteunde functies in de uitdrukkingsredacteur &#x200B;](../personalization-editor-supported-functions.md).
...
U kunt URLs personaliseren gebruikend de verpersoonlijkingsredacteur. Leer meer over [&#x200B; verpersoonlijking &#x200B;](../../personalization/personalize.md#use-expression-editor). In Beslissingsbeheer, slechts worden bepaalde functies gesteund-zie [&#x200B; Gesteunde functies in de uitdrukkingsredacteur &#x200B;](../personalization-editor-supported-functions.md).
...
1. Typ de tekst die in de aanbieding wordt weergegeven.
   ...
   U kunt uw inhoud personaliseren gebruikend de verpersoonlijkingsredacteur. Leer meer over [&#x200B; verpersoonlijking &#x200B;](../../personalization/personalize.md#use-expression-editor). In Beslissingsbeheer, slechts worden bepaalde functies gesteund-zie [&#x200B; Gesteunde functies in de uitdrukkingsredacteur &#x200B;](../personalization-editor-supported-functions.md).
