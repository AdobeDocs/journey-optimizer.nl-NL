...
U kunt een fragment van de Inhoud van Adobe Experience Manager direct in uw aanbieding opnemen door **[!UICONTROL Content Fragment]** te klikken Leer meer over [ het fragmentintegratie van de Inhoud met Journey Optimizer ](../../integrations/aem-fragments.md).
