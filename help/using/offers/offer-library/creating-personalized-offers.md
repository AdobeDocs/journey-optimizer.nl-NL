...
Selecteer de **[!UICONTROL Edit]** knoop om naar de wijze van de aanbiedingsuitgave terug te gaan, waar u de 1} details van de aanbieding [ kunt wijzigen, ](#create-offer) vertegenwoordiging [, evenals ](#representations) geschiktheidsregels en beperkingen [ uitgeven.](#eligibility)
