...
Selecteer de **[!UICONTROL Edit]** knoop om naar de wijze van de aanbiedingsuitgave terug te gaan, waar u de 1&rbrace; details van de aanbieding [&#x200B; kunt wijzigen, &#x200B;](#create-offer) vertegenwoordiging [, evenals &#x200B;](#representations) geschiktheidsregels en beperkingen [&#x200B; uitgeven.](#eligibility)
...
Op deze manier hebt u toegang tot gedetailleerde informatie voor dat aanbod. Selecteer het **[!UICONTROL Change log]** lusje aan [&#x200B; controle alle veranderingen &#x200B;](../get-started/user-interface.md#monitoring-changes) die aan de aanbieding zijn aangebracht.
