...
1. Voeg representaties toe om te bepalen waar je voorstel in het bericht wordt weergegeven. [Meer informatie](add-representations.md)
   ...
   Wanneer het personaliseren van vertegenwoordigingsinhoud, slechts worden bepaalde functies gesteund-zie [&#x200B; Gesteunde functies in de uitdrukkingsredacteur &#x200B;](../personalization-editor-supported-functions.md).
