...
title: Ondersteunde functies in de verpersoonlijkingseditor
description: Leer welke functies van de verpersoonlijkingsredacteur worden gesteund wanneer het personaliseren van aanbiedingsinhoud in Beslissingsbeheer (Offer Decisioning).
...
>[!NOTE]
>
>Deze functielijst is **slechts op het personaliseren van aanbiedingsinhoud** (vertegenwoordiging) van toepassing. Beslissingsregels en rangschikkingsformules maken gebruik van verschillende editors en zijn niet beperkt tot deze subset.
