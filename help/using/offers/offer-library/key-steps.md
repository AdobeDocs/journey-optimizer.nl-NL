...
1. [&#x200B; creeer aanbiedingen &#x200B;](creating-personalized-offers.md), en vorm hun inhoud en eigenschappen. Wanneer u aanbiedingsinhoud (vertegenwoordiging) personaliseert, slechts worden bepaalde functies gesteund-zie [&#x200B; Gesteunde functies in de verpersoonlijkingsredacteur &#x200B;](personalization-editor-supported-functions.md).
