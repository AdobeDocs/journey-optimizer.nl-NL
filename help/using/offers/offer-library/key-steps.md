...
1. [ creeer aanbiedingen ](creating-personalized-offers.md), en vorm hun inhoud en eigenschappen. Wanneer u aanbiedingsinhoud (vertegenwoordiging) personaliseert, slechts worden bepaalde uitdrukkingsfuncties gesteund-zie [ Gesteunde functies in de uitdrukkingsredacteur ](../personalization-editor-supported-functions.md).
