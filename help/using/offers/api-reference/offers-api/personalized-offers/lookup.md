...
U kunt specifieke gepersonaliseerde aanbiedingen opzoeken door een verzoek van de GET tot de [!DNL Offer Library] API die of de gepersonaliseerde aanbieding omvat `@id` of de naam van de gepersonaliseerde aanbieding in het verzoekpad.
