...
# Een alternatieve aanbieding bijwerken
...
Een succesvolle reactie retourneert de bijgewerkte details van de fallback-aanbieding, inclusief de unieke instantie-id en fallback-aanbieding `@id`.
