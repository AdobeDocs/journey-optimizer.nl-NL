...
| Parameter | Beschrijving | Voorbeeld | | `{ENDPOINT_PATH}` | Het eindpuntpad voor API&#39;s van gegevensopslagruimten. | `https://platform.adobe.io/data/core/xcore/` | | `{CONTAINER_ID}` | De container waarin de labels zich bevinden. | `e0bd8463-0913-4ca1-bd84-6309134ca1f6` | | `{INSTANCE_ID}` | De instantie-id van de tag die u wilt bijwerken. | `d48fd160-13dc-11eb-bc55-c11be7252432` |
