...
| `xdm:enrichedAudience` | Stel deze parameter in op `true` als u zich richt op een publiek voor Aangepaste upload (CSV) en verrijkingsgegevens wilt ophalen in de reactie op het besluit van de aanbieding. [&#x200B; Leer meer over het gebruiken van publiek CSV voor besluit &#x200B;](../../custom-upload-decisioning.md#must-read) | `"xdm:enrichedAudience": true` |
