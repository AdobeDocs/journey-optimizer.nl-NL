...
# Aanbiedingen leveren met behulp van de Besluiten-API {#deliver-offers-using-decisions-api}
...
U kunt voorstellen tot stand brengen en leveren door een verzoek van de POST aan [!DNL Decisions] API.
