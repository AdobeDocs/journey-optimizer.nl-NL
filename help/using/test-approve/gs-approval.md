...
Zorg ervoor dat u eerst de juiste bron toevoegt. **goedkeuren en publiceer Campagnes** toestemming vereist het **3} middel van Campagnes {dat aan de rol moet worden toegevoegd, en** keur en publiceer Reizen **vereist het** 7} middel van de Schavens {. **** Beide moeten afzonderlijk worden toegevoegd. [ Leer hoe te om op goedkeuring betrekking hebbende toestemmingen ](#prerequisites) toe te wijzen
