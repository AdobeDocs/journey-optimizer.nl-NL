...
>[!NOTE]
>
>**Numerieke gebeurtenis IDs vereist backticks.** Als uw gebeurtenis-id een getal is (bijvoorbeeld `1697323153` ), plaatst u deze in achtertikken (`` ` `` ) in het expressiepad. Zonder backticks leidt de parser van PQL tot een syntaxisfout.
>
>```handlebars
>context.journey.events.`1697323153`.fieldName
>```
>
>Voor meer details en een volledig voorbeeld met inbegrip van datum het formatteren van gebeurtenistimestamps, zie [ Formatterend een timestamp van een contextgebeurtenis ](../personalization/functions/dates.md#format-date).
...
**fundamentals van Personalization:** [ begonnen met verpersoonlijking ](personalize.md) | [ voeg verpersoonlijking ](personalization-build-expressions.md) toe | [ de syntaxis van Personalization ](personalization-syntax.md) | [ Helperfuncties ](functions/helpers.md) | [ creeer voorwaardelijke regels ](create-conditions.md)

**configuratie van de Reis:** [ Ongeveer gebeurtenissen ](../event/about-events.md) | [ vormt douaneacties ](../action/about-custom-action-configuration.md) | [ de inzamelingen van de Pas in de parameters van de douaneactie ](../building-journeys/collections.md#passing-collection) | [ Gebruik API vraagreacties in douaneacties ](../action/action-response.md) | [ lost uw douaneacties ](../action/troubleshoot-custom-action.md) problemen op | [ de gegevens van Adobe Experience Platform van het Gebruik in reizen ](../building-journeys/dataset-lookup.md) supplementen | [ Gebruik alle herkenningstekens in reizen ](../building-journeys/supplemental-identifier.md) | [ Grafieken en beperkingen ](../start/guardrails.md) | [ Test uw reis ](../building-journeys/testing-the-journey.md)

**de uitdrukkingsfuncties van de Reis:** [ Geavanceerde uitdrukkingsredacteur ](../building-journeys/expression/expressionadvanced.md) | [ het beheersfuncties van de Inzameling ](../building-journeys/expression/collection-management-functions.md) (eerst, allen, laatste) | [ Lijstfuncties ](../building-journeys/functions/list-functions.md) (serializeList, filter, soort) | [ de functies van de Serie ](../personalization/functions/arrays-list.md) (hoofd, staart)

**Personalization gebruiksgevallen:** [ de verlaten e-mail van de gebruiksPlaats van de kunst ](personalization-use-case-helper-functions.md) | [ de statusbericht van de Orde ](personalization-use-case.md)

**het ontwerp van het Bericht:** [ wordt begonnen met e-mailontwerp ](../email/get-started-email-design.md) | [ creeer dupberichten ](../push/create-push.md) | [ creeer SMS berichten ](../sms/create-sms.md) | [ Voorproef en test uw inhoud ](../content-management/preview-test.md)
