...
description: Leer meer over de manieren u de inhoud en de vertoning van uw berichten kunt aanpassen.
...
De inhoud en weergave van door [!DNL Journey Optimizer] U kunt op verschillende manieren een persoonlijk tintje geven. In elke gebieden met het redacteurspictogram, kunt u de verpersoonlijkingsredacteur (die ook als verpersoonlijkingsredacteur wordt bekend) openen en verpersoonlijking bepalen.
...
In beide gevallen hebt u toegang tot de personalisatie-editor.
...
Leer hoe u een persoonlijke URL invoegt in [deze sectie](personalization-syntax.md#perso-urls).
