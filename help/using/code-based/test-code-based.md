...
Wanneer uw op code-gebaseerde ervaring [&#x200B; het Beslissen van de Ervaring &#x200B;](../experience-decisioning/gs-experience-decisioning.md) gebruikt, kunt u voorproef de besluitvormingspunten die zullen worden geleverd: selecteer één of meerdere testprofielen in **[!UICONTROL Simulate content]** en de voorproef toont de besluitpunten die voor elk profiel kwalificeren.

>[!NOTE]
>
>Deze voorproef is **slechts inhoudsvoorproef 0&rbrace;: het toont welke besluitvormingspunten voor het geselecteerde testprofiel kwalificeren en hoe de geschreven inhoud teruggeeft.** **de gegevens van de Context** die in levende Edge verzoeken worden verzonden (bijvoorbeeld, worden de gegevens gebruikt in besluitvormingscriteria of van verwijzingen voorzien in uw cliëntimplementatie) niet gesimuleerd in **[!UICONTROL Simulate content]** voorproef.
...
1. De verbindingen van de voorproef worden geproduceerd voor het geselecteerde testprofiel en, als u [&#x200B; Experiment van de Inhoud &#x200B;](../content-management/content-experiment.md) in uw reis of campagne, voor de geselecteerde behandeling gebruikt.
   ...
   <!--
Als u de inhoud hebt gewijzigd of een andere behandeling of testprofiel hebt geselecteerd, schuift u omlaag naar de onderkant van het pop-upmenu **[!UICONTROL Preview on device]** en klikt u op **[!UICONTROL Refresh preview link]** om de huidige status te weerspiegelen.
...
<!--When creating a content experiment, you need to select a given treatment and click the **[!UICONTROL Simulate content]** button to obtain the link corresponding to that treatment, then select another treatment, click the **[!UICONTROL Simulate content]** button to obtain a new preview link, and so on.-->
     ...
     wanneer het bijwerken van de inhoud, of het selecteren van een verschillend testprofiel of een behandeling, wordt de voorproefverbinding automatisch verfrist. U kunt de verbinding in verschillende browser lusjes kopiëren, en de ervaringen vergelijken.
