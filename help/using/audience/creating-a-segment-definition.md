...
1. Sleep de gewenste velden vanuit het linkerdeelvenster naar de werkruimte in het midden en configureer ze op basis van uw behoeften.
   ...
   * **Attributen**: profielen die in Atlanta, San Francisco of Seattle na 1980 worden geboren.
     ...
     >[!NOTE]
     >
     >Het kenmerk `frequencyMap` wordt niet ondersteund voor gebruik in segmentdefinities en kan niet worden gebruikt als onderdeel van segmenteringscriteria voor het publiek. Voor frequentiegerichte gericht richten denk na gebruikend de regels van de frequentiecontrole onder bedrijfsregels.
