...
* **creeer veelvoudige wegen in een reis** die op regels wordt gebaseerd die hefboomwerking de de verrijkingsattributen van het gerichte publiek. Om dit te doen, richt het publiek gebruikend a [&#x200B; gelezen publiek &#x200B;](../building-journeys/read-audience.md) activiteit dan tot regels in [&#x200B; optimaliseer &#x200B;](../building-journeys/optimize.md) activiteit die op de verrijkingsattributen van het publiek wordt gebaseerd.
