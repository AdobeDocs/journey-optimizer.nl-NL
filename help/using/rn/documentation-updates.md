...
* De op code-gebaseerde documentatie van implementatiemonsters is bijgewerkt om het tokens gebied in propositionAction voor nauwkeurige het volgen en attributie in Beslissing te omvatten. [Meer informatie](../code-based/code-based-implementation-samples.md)
