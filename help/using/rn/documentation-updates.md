...
* Een guardrail bij het richten van pseudoniem profielen met binnenkomende kanalen is toegevoegd aan het [&#x200B; Web &#x200B;](../web/web-prerequisites.md#profile-management-guardrail), [&#x200B; In-app &#x200B;](../in-app/inapp-configuration.md#profile-management-guardrail), [&#x200B; code-gebaseerde ervaring &#x200B;](../code-based/code-based-prerequisites.md#profile-management-guardrail), en [&#x200B; inhoudskaart &#x200B;](../content-card/content-card-configuration-prereq.md#profile-management-guardrail) eerste vereisten pagina&#39;s, evenals aan de [&#x200B; Gidsen en de beperkingen &#x200B;](../start/guardrails.md) pagina. In deze handleiding wordt opgegeven dat bij het maken van doelprofielen die niet voor authentiek zijn of nog niet bekend zijn, het totale aantal controleerbare profielen toeneemt en dat dit van invloed kan zijn op uw facturering. Daarom raadt Adobe aan een &#39;Time-to-Live&#39; (TTL) in te stellen voor het automatisch verwijderen van profielen om het aantal bedrijfsgerelateerde profielen en de bijbehorende kosten te beheren.
