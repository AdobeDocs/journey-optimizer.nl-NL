...
* Er is een notitie toegevoegd aan de sectie Fragments, waarin wordt aangegeven dat wanneer het bijhouden is ingeschakeld in een reis of een campagne, als er koppelingen aanwezig zijn in een fragment en als dit fragment wordt gebruikt in een e-mail, deze koppelingen worden bijgehouden, zoals alle andere koppelingen die in het bericht zijn opgenomen. [Meer informatie](../content-management/create-fragments.md#content)
