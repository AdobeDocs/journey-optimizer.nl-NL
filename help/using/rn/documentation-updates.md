...
Deze pagina bevat alle documentatie-updates voor [!DNL Journey Optimizer].
...
* Er is een nieuwe pagina toegevoegd over de integratie van Journey Optimizer. [Meer informatie](../start/ajo-integrations.md)
...
* Er is een lijst toegevoegd met alle rapportgegevens die beschikbaar zijn in Adobe Reader Optimizer.
...
* Er is een beperking toegevoegd voor ritten die gebruikmaken van leessegmentactiviteiten. [Meer informatie](../building-journeys/read-segment.md)
...
* De lijst met Adobe Journey Optimizer-gegevenssets met queryvoorbeelden is toegevoegd. [Meer informatie](../data/datasets-query-examples.md)
* De toegestane lijstpagina is verplaatst naar de sectie van de Configuratie. [Meer informatie](../configuration/allow-list.md)
...
* Koppelingen naar belangrijke bronnen zijn bijgewerkt op de pagina met documentatie bij Journey Optimizer.
...
* Video&#39;s voor beslissingsbeheermogelijkheden zijn bijgewerkt om de gebruikersinterface van Journey Optimizer te weerspiegelen. [Meer informatie](../offers/get-started/starting-offer-decisioning.md)
...
* Er zijn koppelingen toegevoegd naar hulplijnen en opmerkingen bij de release van het product **Documentatie voor Adobe Reis Optimizer** homepage. [Meer informatie](https://experienceleague.adobe.com/docs/journey-optimizer.html)
...
* Er is een nieuwe pagina toegevoegd aan de **Beslissing voorstel** , met inbegrip van een grondige beschrijving van de [model voor automatische optimalisatie](../offers/ranking/auto-optimization-model.md), het gebruikte algoritme en meer technische details. [Meer informatie](../offers/ranking/ai-models.md)
...
* De **Bepaling van AI-classificaties aanbieden** is bijgewerkt met een meer gedetailleerde beschrijving van het model voor automatische optimalisatie. [Meer informatie](../offers/ranking/auto-optimization-model.md)
...
* De **Koppelingen invoegen** is bijgewerkt om de recente wijzigingen in de gebruikersinterface te weerspiegelen. [Meer informatie](../email/message-tracking.md#insert-links)
...
* De volgende functiepagina&#39;s zijn bijgewerkt: [zeuren](../building-journeys/functions/functionsethours.md), [getListItem](../building-journeys/functions/functiongetlistitem.md), [inSegment](../building-journeys/functions/functioninsegment.md)

* De volgende functies zijn toegevoegd: [filter](../building-journeys/functions/functionfilter.md), [doorsnijden](../building-journeys/functions/functionintersect.md), [toDateOnly](../building-journeys/functions/functiontodateonly.md)

* Het datumtype dateOnly is toegevoegd in de documentatie van de uitdrukkingsredacteur. [Meer informatie](../building-journeys/expression/data-types.md)

* Meer informatie over de cache-duur van de aangepaste handeling. [Meer informatie](../datasource/external-data-sources.md#custom-authentication-mode)
...
* Nu zijn alle functies voor Beslissingsbeheer die in de desbetreffende sectie worden beschreven, ook van toepassing op de gebruikers van het Adobe Experience Platform die gebruikmaken van de toepassingsservice voor Beslissing van aanbiedingen. [Meer informatie](../offers/get-started/starting-offer-decisioning.md)
...
* Toegevoegde notities bij de lijst Onderdrukking, Toegestane lijst en Globale rapporten/Live-rapporten via e-mail om op te geven dat profielen met de status Onderdrukt en Niet toegestaan zijn uitgesloten van de metriek van het e-mailrapport Verzonden. [Meer informatie](../reports/global-report.md)
* Er is een nieuwe sectie toegevoegd waarin wordt beschreven hoe e-mailadressen of domeinen kunnen worden opgehaald die zijn uitgesloten van een verzendende server omdat deze zich niet in de toegestane lijst bevinden. [Meer informatie](../configuration/allow-list.md#reporting)
* De sectie Enable the allow list section is bijgewerkt. [Meer informatie](../configuration/allow-list.md#enable-allow-list)
