...
* Een nieuwe **[Gebeurtenissen die wegens een geblokkeerde weginstantie](../building-journeys/troubleshooting-execution.md#max-instance-stack-events-reached)** sectie worden verworpen is toegevoegd aan de documentatie van het het oplossen van problemen van de reis, die de `maxInstanceStackEventsReached` verklaring verklaren verwerpen, wanneer het voorkomt, en hoe te om het te verlichten. De guardrails en de pagina&#39;s in de lijst met stapgebeurtenissen zijn ook dienovereenkomstig bijgewerkt.

* De **fragmenten van de Leverage in besluitvormingsbeleid** documentatie omvat nu guardrailnota&#39;s voor het **E-mail** kanaal: **[!UICONTROL Simulate content]** toont geen uitdrukkingsfragmenten van het besluitvormingspunt, terwijl **[!UICONTROL Send proof]** en geactiveerde campagnes. De pagina verklaart ook dat **[!UICONTROL Visual fragments]** niet aan een besluitpunt kan worden toegewezen — slechts **uitdrukkingsfragmenten** worden gesteund in deze context. [Meer informatie](../experience-decisioning/fragments-decision-policies.md)

## maart 2026 {#march-2026}

* De documentatie voor **previewing op code-gebaseerde ervaringen met het Beslissen van de Ervaring** verduidelijkt nu dat **[!UICONTROL Simulate content]** slechts inhoudsvoorproef is. Contextgegevens van live Edge-verzoeken worden niet gesimuleerd in de ontwerpvoorvertoning. [Meer informatie](../code-based/test-code-based.md#preview-code-based)

* De **gegevens van Adobe Experience Platform van het Gebruik** documentatie is bijgewerkt: de guardrails niet meer verklaren dat de datasetraadplegingen niet kunnen worden geketend, die huidig productgedrag weerspiegelen. [Meer informatie](../data/lookup-aep-data.md)

* De **de activiteitendocumentatie van het Profiel van 0&rbrace; Update is bijgewerkt aan documentsteun voor het bijwerken van tot vijf profielattributen in één enkele actie.** [Meer informatie](../building-journeys/update-profiles.md)

* De **Gelezen activiteit van het publiek** en **eigenschappen van de Reis** documentatie zijn bijgewerkt om de 91-dag reislevenscyclus voor altijd-op terugkomende reizen te verduidelijken. De planningssectie bevestigt nu uitdrukkelijk dat terugkerende reizen zonder einddatum Levend blijven afgelopen 91 dagen, en de globale onderbreking FAQ is uitgebreid om 91-dagprofiel TTL van het 91-dag rapporteringsvenster te onderscheiden. [Meer informatie](../building-journeys/read-audience.md#schedule)

* De **raadpleging van de Dataset** activiteitendocumentatie is bijgewerkt om te verduidelijken dat de raadplegingssleutel op geavanceerde wijze voor de `@datasetLookup{}` syntaxis moet worden gevormd om in stroomafwaartse voorwaardenactiviteiten te werken. Een het oplossen van problemensectie is toegevoegd met begeleiding bij het oplossen van de &quot;niet gevonden&quot;fout van de raadpleging van de Dataset. [Meer informatie](../building-journeys/dataset-lookup.md#troubleshooting)

* De **functies van de Tijd van de Datum** documentatie is bijgewerkt met een nieuw voorbeeld dat toont hoe te om een timestamp van een attribuut van de contextgebeurtenis, met inbegrip van het `toDateTime()` vereiste, backtick syntaxis voor numerieke gebeurtenis IDs, en een gemeenschappelijke foutencallout voor PQL &quot;verkeerd gecompenseerde input&quot;fout te formatteren. [Meer informatie](../personalization/functions/dates.md#format-date)

* De **Geordende campagnebegeleiding en de beperkingen** en **krijgen begonnen met Bronschakelaars** documentatie zijn bijgewerkt om te verduidelijken dat voor op dossier-gebaseerde Vastlegging van Gegevens van de Verandering, het `_change_request_type` gebied wordt vereist en zijn waarden moeten zijn in kleine letters `u` (upsert) of `d` (schrapping), niet in hoofdletters. [Meer informatie](../orchestrated/guardrails.md)

* **voegt verbindingen en spoorberichten** documentatie toe is bijgewerkt met begeleiding op hoe het volgen herkenningstekens (urlID) worden geproduceerd: een unieke urlID wordt slechts toegewezen wanneer zowel URL als het etiket uniek zijn. Als gebruikers dezelfde URL in meerdere e-mails (of meerdere keren in één e-mail) willen bijhouden, moeten ze een uniek label gebruiken voor elke vergelijkbare URL. Als dat niet het geval is, kan [!DNL Journey Optimizer] niet bepalen op welke koppeling is geklikt. [Meer informatie](../email/message-tracking.md#track-across-multiple-emails)

* **creeer testprofielen** documentatie is bijgewerkt met een belangrijke nota over de vereisten van de identiteitsbeschrijver: wanneer een dataset wordt geschrapt en ontspannen, moet het schema de correcte identiteitsbeschrijver op het primaire identiteitsgebied behouden. Zonder deze optie worden ingesloten profielen niet gemarkeerd als `testProfile = true` , zelfs niet als de opname correct is voltooid. Er is een controlelijst voor probleemoplossing toegevoegd. [Meer informatie](../audience/creating-test-profiles.md)

* De **Gelezen de activiteitendocumentatie van het publiek** is bijgewerkt om te verduidelijken dat de activiteit van de Gebeurtenis van de a **Bedrijfs** een uitzondering op de regel is die het publiek lezen de eerste activiteit in een reis moet zijn. Een nota is ook toegevoegd verwijzend **optimaliseer** activiteit als geavanceerd alternatief voor het controleren van publiek dat richt. [Meer informatie](../building-journeys/read-audience.md)

* **verzendt gebruikend golven** in reizen is nu over het algemeen beschikbaar. De markering Beperkte beschikbaarheid is uit de documentatie verwijderd. [Meer informatie](../building-journeys/send-using-waves.md)

* De **de activiteitendocumentatie van de Jump** is verrijkt met een nieuwe sectie van de ontwerpstrategie — **BBT-gerangschikte subtrajecten** — die verklaren hoe te om complexe stromen van begin tot eind in kleinere, geconcentreerde subtrajecten te breken die via de activiteit van de Jump worden verbonden. [Meer informatie](../building-journeys/jump.md#jump-strategy)

* De **documentatie van Markeringen** is bijgewerkt met begeleiding bij het gebruiken van markeringscategorieën als alternatief voor complexe noemende overeenkomsten. In een nieuwe sectie wordt uitgelegd hoe u tagcategorieën kunt instellen voor schaalbaar reisbeheer. [Meer informatie](../building-journeys/tags.md)

* De **Ongeveer gegevensbronnen** documentatie omvat nu een nieuwe sectie die artsen helpen tussen drie strategieën van de gegevenstoegang kiezen: de toegang tot van externe gegevens via douaneacties, die een dataset gebruiken niet voor Profiel wordt toegelaten, of het gebruiken van een profiel-toegelaten dataset. Elke optie wordt beschreven met compromissen en geadviseerde gebruiksgevallen. [Meer informatie](../datasource/about-data-sources.md#data-access-strategy)

* De **documentatie van het het berichtontwerp van de duw** is bijgewerkt met een nota die het gedrag van universele verbindingen op iOS verduidelijkt: als het bericht URL als universele verbinding wordt geregistreerd, zal bijbehorende app ongeacht de gekozen actie van URL openen. Er zijn aanwijzingen toegevoegd voor het openen van een browser. [Meer informatie](../push/design-push.md)

* Een nieuwe **Monitor uw AI modellen** pagina is nu beschikbaar in de documentatie van het Besluit. Hierin wordt uitgelegd hoe u de gezondheid, trainingsstatus en prestaties van gepersonaliseerde optimalisatiemodellen rechtstreeks kunt bijhouden in [!DNL Journey Optimizer] . [Meer informatie](../experience-decisioning/ranking/ai-model-observability.md)

* De **geavanceerde redacteur van HTML** (deskundige wijze) voor e-mailmalplaatjes is nu beschikbaar in Beperkte Beschikbaarheid. De documentatiepagina is nu openbaar toegankelijk. Met deze functie kunt u de onbewerkte HTML-bron van sjablonen voor e-mailinhoud rechtstreeks vanuit de e-mailtoepassing Designer bekijken en bewerken. [Meer informatie](../content-management/email-template-expert-mode.md)

* Het **volgen URL** en **het oplossen van problemendocumentatie van de Reis** zijn bijgewerkt om het gedrag van `context.system.source.actionId` in gesloten reizen te documenteren. Gesloten of niet-opnieuw gepubliceerde reizen kunnen lege plaatsaanduidingen voor `{}` opleveren voor het bijhouden van URL&#39;s. Er zijn aanwijzingen toegevoegd over de wijze waarop het probleem kan worden opgelost door de reis opnieuw te publiceren of de betreffende parameter te verwijderen. [Meer informatie](../email/url-tracking.md)

* De **gegevens bron van Adobe Experience Platform** documentatie is bijgewerkt met een nota dat slechts de individuele op profiel-gebaseerde schema&#39;s XDM in de configuratie van Source van Gegevens worden gesteund. [Meer informatie](../datasource/adobe-experience-platform-data-source.md)

* De **tijd-aan-levende (TTL) guardrails van Datasets** documentatie is verbeterd met een nieuwe ingang van FAQ om duidelijk te identificeren welke datasets aan TTL onderworpen zijn. TTL is uitsluitend van toepassing op gegevensreeksen uit tijdreeksen — gegevensreeksen van recordtype zoals gegevenssets voor entiteiten, gegevenssets voor classificaties en gegevensbanken voor besluitvormingsobjecten zijn niet onderworpen aan GVTO en zullen niet worden beïnvloed door de uitrol van de garantie. [Meer informatie](../data/datasets-ttl.md)

* De **eigenschappen van de Reis** en **pauzeren een reis** documentatie zijn bijgewerkt om de nieuwe pauze te documenteren en gebieden nu te hervatten beschikbaar in de reis technische details. De **technische details van het Exemplaar** knoop omvat nu `lastPausedAt`, `lastPausedBy`, `lastPausedById`, `lastResumedAt`, `lastResumedBy`, en `lastResumedById`, naast het bestaande `pausedJourneySettings` blok. Een nieuwe sectie is ook toegevoegd aan **Pauzeer een reis** pagina die verklaart hoe te pauze en hervat tijdstempels direct van reiseigenschappen. [Meer informatie](../building-journeys/journey-properties.md)

## februari 2026 {#february-2026}

* Er is nu een nieuwe pagina beschikbaar voor het beheer van besluiten. Het maakt een lijst van alle exploitanten, helpers, en functies die wanneer het personaliseren van aanbiedingsinhoud (vertegenwoordiging) met de verpersoonlijkingsredacteur worden gesteund. Gebruik deze lijst om runtimefouten te voorkomen. Alleen de gedocumenteerde functies worden ondersteund bij het aanpassen van inhoud in Offer Decisioning. [Meer informatie](../offers/offer-library/personalization-editor-supported-functions.md)

* **creeer besluitvormingsbeleid** en **het besluitvormingsbeleid van het Gebruik in berichten** documentatie is bijgewerkt voor E-mail: een nota verklaart nu dat wanneer de zelfde aanbieding door meer dan één besluitbeleid in het e-maillichaam kan worden geselecteerd, de motor aanbiedingen (elke plaatsing ontvangt een verschillende aanbieding) dedupliceert. Om de zelfde aanbieding in veelvoudige plaatsen (bijvoorbeeld, kopbal en footer) te tonen, gebruik **hergebruik besluitoutput**. [Meer informatie](../experience-decisioning/create-decision-policy.md)
...
* Een opmerking toegevoegd in het gedeelte Condition Activity van de reis om te documenteren dat de evaluatie van de voorwaarde zal mislukken voor profielen die meer dan twee apparaatidentiteiten bevatten. [Meer informatie](../building-journeys/conditions.md)
...
* De ingebouwde pagina met kanaalacties is opnieuw ingedeeld. [Meer informatie](../building-journeys/journey-action.md)
