...
* Er is nu een nieuwe pagina beschikbaar met uitleg over de beslissingsmogelijkheden van Journey Optimizer, waaronder de verschillen tussen het beslissingskader van de volgende generatie en de bestaande oplossing voor Beslissingsbeheer, en de belangrijkste voordelen voor het aanbieden van persoonlijke aanbiedingen via verschillende kanalen. [Meer informatie](../experience-decisioning/gs-decision.md)

* Er is nu een nieuwe pagina beschikbaar waarin wordt uitgelegd wat een ervaringsoppervlak op basis van code is, inclusief oppervlakte-URI&#39;s, hoe oppervlakken op elk hiërarchisch niveau werken als containers (webpagina&#39;s, mobiele apps, inhoudslocaties) en hoe ze de implementatie van de toepassing verbinden met kanaalconfiguratie. [Meer informatie](../code-based/code-based-surface.md)

* Er is nu een nieuwe pagina beschikbaar over het publiceren en beheren van op code gebaseerde ervaringen, waaronder het activeren van campagnes, het controleren van levering, het aanbrengen van wijzigingen en het stoppen van campagnes. [Meer informatie](../code-based/publish-code-based.md)

* Er is nu een nieuwe pagina beschikbaar voor het testen van op code gebaseerde ervaringen, waarin wordt uitgelegd hoe u een voorvertoning van inhoud kunt weergeven met testprofielen, hoe u de implementatie kunt valideren met de gereedschappen voor browserontwikkeling of mobiele foutopsporing en hoe u kunt controleren of de inhoud correct wordt weergegeven voordat u de inhoud publiceert. [Meer informatie](../code-based/test-code-based.md)
...
* Een nieuwe pagina is nu beschikbaar in de sectie van het Beslissen van de Ervaring op hoe te om gegevensinzameling voor het volgen van beelden, kliks, en douanegebeurtenissen te vormen. [Meer informatie](../experience-decisioning/data-collection/schema-requirement.md)
...
* Er is een lijst met instructies toegevoegd aan de sectie waarin wordt beschreven hoe u fragmenten die zijn gekoppeld aan besluitvormingselementen, kunt gebruiken in het besluitvormingsbeleid. [Meer informatie](../experience-decisioning/create-decision.md#guardrails-limitations)
