...
* Er is informatie toegevoegd over de manier waarop de representaties van aanbiedingen op basis van contextgegevens kunnen worden aangepast [Meer informatie](../offers/offer-library/add-representations.md#context-data)
