...
* Er is nu een nieuwe pagina beschikbaar voor het beheer van besluiten. Het bevat een lijst met alle operatoren, helpers en functies die worden ondersteund bij het samenstellen van expressies in de inhoud van de aanbieding, beslissingsregels en rangschikkingsformules. Gebruik deze lijst om runtimefouten te voorkomen. Alleen de gedocumenteerde functies worden ondersteund door het besluitvormingsbeheer. [Meer informatie](../offers/personalization-editor-supported-functions.md)
