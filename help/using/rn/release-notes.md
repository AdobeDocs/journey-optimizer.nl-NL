...
## Updates van maart 1926 {#march-26-rn}
...
* **Verandering in de Secundaire Dataset van de Gebeurtenis van de Terugkoppeling van AJO Secundaire Ontvanger** - de Dataset van de Gebeurtenis van de Terugkoppeling van de E-mail BCC van AJO wordt anders genoemd aan de Secundaire Begunstigde Dataset van de Gebeurtenis van de Terugkoppeling van AJO.
   * **Bestaande gebruikers**: Slechts verandert de vertoningsnaam. De onderliggende tabelnaam blijft ongewijzigd.
   * **Nieuwe gebruikers en nieuwe zandbakken**: Zowel gebruiken de vertoningsnaam en lijstnaam de nieuwe naam.
   * **Bestaande gebruikers/organisaties met nieuwe zandbakken**: Zowel veranderen de vertoningsnaam en lijstnaam in de nieuwe naam.
...
* **Beslissende voorproef in op code-gebaseerd kanaal van de Ervaring** - u kunt besluitvormingspunten nu voorproef wanneer het vormen van Beslissing met het op code-Gebaseerde kanaal van de Ervaring. Voorvertoning is rechtstreeks beschikbaar in de ontwerpinterface voordat u live gaat.
