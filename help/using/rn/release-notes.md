...
De onderstaande kenmerken en verbeteringen zullen later in maart/begin april worden gepubliceerd. Releasedatums en het toepassingsgebied kunnen zonder voorafgaande kennisgeving worden gewijzigd.
...
<tr>
<td>
<p>U kunt nu een georkestreerde campagne activeren via een signaal dat via API's wordt verzonden. Vorm de doelcampagne als "teweeggebracht door een signaal"en publiceer het. Gebruik vervolgens een API-aanroep om de campagne te starten. De API-aanroep kan parameters bevatten die beschikbaar zijn als variabelen in de getriggerde campagne. Opmerking: een georkestreerde campagne die door een signaal wordt gestart, is nog steeds een **batch** campagne en is niet hetzelfde als API-getriggerde campagnes.</p>
...
<p>Beschikbaarheidsdatum: 26 maart 2026 - Deze capaciteit zal de komende dagen geleidelijk aan voor alle regio's worden ingezet.</p>
</td>
</tr>
</tbody>
</table>
...
* **Globale variabelen in Geordende Campagnes** - Geordende Campagnes steunen nu globale variabelen die eens kunnen worden bepaald en over alle activiteiten binnen een werkschema opnieuw worden gebruikt, die configuratie vereenvoudigen en consistentie in dynamische waarden en uitdrukkingen verzekeren. <br/> Beschikbaarheidsdatum: 1 April, 2026
