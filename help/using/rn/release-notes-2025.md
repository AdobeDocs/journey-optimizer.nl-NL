...
## Opmerkingen bij de release van oktober 1925 {#25-10-rn}
...
<thead>
<tr>
<th><strong>Afbeelding naar HTML-converter</strong><br/></th>
</tr>
</thead>
<tbody>
<tr>
<td>
<p>De afbeelding naar HTML-converter is een door AI aangedreven functie die statische afbeeldingsontwerpen omzet in volledig aanpasbare, modulaire HTML-sjablonen voor e-mailinhoud. Met dit codeprogramma kunnen marketers visuele ontwerpen transformeren in responsieve, bewerkbare e-mailsjablonen zonder dat hiervoor technische expertise nodig is. Dit is perfect voor platformmigratie, het snel maken van sjablonen en het bouwen van herbruikbare sjabloonbibliotheken.</p>
...
<p>Beschikbaarheidsdatum: 30 oktober 2025</p>
</td>
</tr>
</tbody>
</table>
...
<tr>
<td>
<p>Dit vermogen verstrekt beter zicht in de gezondheid en de prestaties van het de actiepuntpunt van de douaneactie. Een nieuwe douaneactie controledashboard en overeenkomstige gebieden in de dataset van de de gebeurtenisgebeurtenis van de reisstap zullen u succesvolle vraag, fouten, productie, reactietijd en rij wachttijd voor uw eindpunten van de douaneactie controleren. U kunt nu snel begrijpen wanneer, waar en waarom een afwijkende situatie zich voordoet in een aangepaste handeling.</p>
<p>Deze mogelijkheid is momenteel beperkt beschikbaar voor klanten.</p>
<p>Raadpleeg de <a href="../action/reporting.md">gedetailleerde documentatie</a> voor meer informatie.</p>
<p>Beschikbaarheidsdatum: 28 oktober 2025</p>
</td>
</tr>
</tbody>
</table>
...
<p>Deze mogelijkheid is momenteel beperkt beschikbaar voor klanten in de Verenigde Staten en Australië. Neem contact op met uw Adobe-vertegenwoordiger voor toegang.</p>
<p><img src="assets/do-not-localize/forms.gif"/></p>
<p>Raadpleeg de <a href="../landing-pages/lp-forms.md">gedetailleerde documentatie</a> voor meer informatie.</p>
<p>Beschikbaarheidsdatum: 23 oktober 2025</p>
</td>
</tr>
</tbody>
</table>
...
<p>De regels voor de korte uren zijn momenteel alleen beschikbaar voor een aantal organisaties (Beperkte Beschikbaarheid).  Deze zullen in toekomstige versies geleidelijk beschikbaar zijn voor alle klanten.</p>
...
<thead>
<tr>
<th><strong>Hoge doorvoer voor door API geïnitieerde e-mailcampagnes</strong><br/></th>
</tr>
</thead>
<tbody>
<tr>
...
### Verbeteringen {#oct-25-10-improvements}
...
* **steun Webhaak voor API-teweeggebrachte campagnes**\
  API-getriggerde campagnes ondersteunen nu webhaken. Configureer een URL van een webhaak om statusupdates in real time te ontvangen voor elk bericht, waardoor de zichtbaarheid wordt verbeterd en een naadloze bewaking en automatisering mogelijk wordt. [Meer informatie](../configuration/feedback-webhooks.md)
...
<p>Bovendien kunt u op profielattributen-gebaseerde uitgangscriteria (eerder genoemd "globale filter") toepassen op gepauzeerde reizen om profielen uit te sluiten die op hun attributen worden gebaseerd.</p>
...
<p>Voor meer informatie, verwijs naar de <a href="../content-management/gs-message-optimization.md"> gedetailleerde documentatie </a></p>
</td>
</tr>
</tbody>
</table>
...
* **Configuratie**
   ...
   * **de kenmerkensteun van de Douane met één-Klik unsubscribe URL** - met Journey Optimizer, als u toestemming buiten Adobe beheert, kunt u een extern douaneeindpunt plaatsen door uw eigen te bepalen unsubscribe verbinding in de e-mailconfiguratie. Wanneer uw ontvangers op de koppeling voor afmelden klikken, voegt Journey Optimizer enkele standaardprofielspecifieke parameters toe aan de gebeurtenis voor het bijwerken van de toestemming.
     ...
     Als u uw koppeling voor het opzeggen van uw abonnement met één klik verder wilt aanpassen, kunt u nu aangepaste kenmerken definiëren die ook aan de gebeurtenis voor toestemming worden toegevoegd. Deze mogelijkheid is beschikbaar in Beperkte Beschikbaarheid. [Meer informatie](../email/list-unsubscribe.md#custom-attributes)
...
<tr>
<td>
<p>U kunt, Rich Communication Services (RCS) berichten nu vormen aanpassen en leveren door een externe provider te integreren met de oplossing van de aangepaste SMS-provider.</p>
...
<p>Raadpleeg de <a href="../content-management/generative-full-content.md">gedetailleerde documentatie</a> voor meer informatie.</p>
</td>
</tr>
</tbody>
</table>
