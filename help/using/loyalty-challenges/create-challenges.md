...
>title="Doelgroep"
>abstract="Kies op het tabblad Publiek wie aan de uitdaging kan deelnemen via het beschikbare Adobe Experience Platform-publiek."
...
## De uitdaging aangaan {#launch}

Het lanceren van een uitdaging vereist **drie stappen**: (1) publiceer de uitdaging, (2) produceert de reis, (3) publiceert de reis. Alle drie moeten voor de uitdaging worden voltooid die aan klanten moet worden geleverd.

1. Controleer uw uitdagingsconfiguratie om ervoor te zorgen alle vereiste gebieden worden voltooid.

1. Klik op het pictogram ![](assets/do-not-localize/Smock_More_18_N.svg) en selecteer **[!UICONTROL Publish]** .

   ![](assets/challenge-create-publish.png)

1. Selecteer **[!UICONTROL Generate Journey]** om de reis tot stand te brengen die uw uitdagingslevering zal ordenen.
