...
title: Formulieren maken en gebruiken voor uw bestemmingspagina's
description: Meer informatie over het maken en gebruiken van formulieren voor landingspagina's in Journey Optimizer
...
Als u profielgegevens wilt vastleggen met uw [!DNL Journey Optimizer] -bestemmingspagina&#39;s en de [!DNL Experience Platform] -gegevenssets wilt verrijken, kunt u formulieren gebruiken in uw bestemmingspagina&#39;s. Voor een overzicht van gegevens vangen scenario&#39;s en vereisten, zie [&#x200B; Gegevens vangen met het landen van pagina&#39;s &#x200B;](get-started-lp.md#data-capture-lp).
...
Zodra de gegevens op het stromen eindpunt landen, is het verbonden met de datasetinformatie. Gebruikend de geproduceerde bron/doelverbindingen en bronstroom, worden de gegevens dan geduwd in de dataset.
...
1. Selecteer de **[!UICONTROL Streaming connection]** die u voor dat formulier wilt gebruiken. Dit is het streamingeindpunt waar gegevens worden verzonden bij het verzenden van het formulier.
   ...
   >[!IMPORTANT]
   >
   >Een HTTP API-streamingverbinding die in de vervolgkeuzelijst wordt weergegeven, kan alleen worden weergegeven als deze in Adobe Experience Platform aan de volgende vereisten voldoet:
   >
   >* **het type van Gegevens** moet aan **XDM** (niet Ruwe gegevens) worden geplaatst
   >* **Authentificatie** moet **&#x200B;**&#x200B;(niet-voor authentiek verklaarde verbinding) worden onbruikbaar gemaakt
   >
   >Als de streamingverbinding niet in de lijst wordt weergegeven, controleert u of aan beide voorwaarden is voldaan. <!--Learn how to [create a non-authenticated connection with XDM data type](https://experienceleague.adobe.com/nl/docs/experience-platform/sources/ui-tutorials/create/streaming/http#create-a-streaming-connection){target="_blank"}.-->
...
1. Selecteer een **[!UICONTROL Dataset]** die u aan het formulier wilt koppelen. Hier worden de reacties op het formulier opgeslagen en weergegeven. U kunt typen om een specifieke dataset te zoeken of het van de lijst te selecteren.
   ...
   >[!NOTE]
   >
   >Momenteel slechts **profiel-toegelaten** en **niet-profiel-toegelaten** [!DNL Adobe Experience Platform] datasets zijn beschikbaar voor selectie. Eén dataset kan tegelijk worden geselecteerd. De datasets van het systeem kunnen niet voor het opslaan van vormgegevens worden gebruikt. [&#x200B; leer meer over datasets &#x200B;](../data/get-started-datasets.md)
...
1. Selecteer in de sectie **[!UICONTROL Embed form]** het formulier dat u hebt gemaakt.
   ...
   >[!NOTE]
   >
   >U kunt het geselecteerde formulier bijwerken met de knop **[!UICONTROL Edit form]** . Het formulier wordt geopend op een nieuw tabblad. De stappen om de vorminhoud uit te geven zijn gedetailleerd in [&#x200B; deze sectie &#x200B;](#edit-form).
...
Zodra uw het landen pagina [&#x200B; wordt gepubliceerd &#x200B;](create-lp.md#publish-landing-page) en gebruikt in een reis, wanneer de gebruikers de vorm invullen, wordt de ingegane informatie opgenomen in de geselecteerde dataset. De gegevens mogen maximaal 15 minuten worden verwerkt en beschikbaar zijn voor gebruik.
...
## Veelgestelde vragen {#lp-forms-faq}

+++Welk type landingspagina moet ik een formulier gebruiken?

Wanneer u een openingspagina maakt, selecteert u **[!UICONTROL Data Capture]** als het type openingspagina. Dit is het enige type bestemmingspagina dat het insluiten van een formulier voor gegevensverzameling ondersteunt.

+++

+++Kan ik een gegevensset gebruiken met een formuliervoorinstelling?

Slechts **profiel-toegelaten** en **niet-profiel-toegelaten** [!DNL Adobe Experience Platform] datasets zijn beschikbaar voor selectie. De datasets van het systeem kunnen niet worden gebruikt om vormgegevens te bewaren, en slechts één dataset kan per vooraf ingesteld worden geselecteerd.

+++

+++Kan ik dezelfde gegevensset of streamingverbinding opnieuw gebruiken voor meerdere formuliervoorinstellingen?

Ja. Dezelfde gegevensset of streamingverbinding kan opnieuw worden gebruikt voor meerdere voorinstellingen. U kunt ook meerdere voorinstellingen instellen met behulp van verschillende combinaties van gegevenssets en streamingverbindingen voor de ondersteuning van verschillende scenario&#39;s voor gegevensvastlegging.

+++

+++Kan ik een conceptformulier gebruiken op een bestemmingspagina?

Nee. Slechts **gepubliceerde** vormen kunnen in een het landen pagina worden geselecteerd en worden ingebed.

+++

+++Als ik een formulier dat al is ingesloten op een live landingspagina, bewerkt en opnieuw publiceert, welke versie wordt dan door de bestemmingspagina gebruikt?

De het landen pagina gebruikt altijd de **recentste gepubliceerde versie** van de vorm. Conceptwijzigingen worden pas van kracht nadat het bijgewerkte formulier is gepubliceerd.

+++

+++Kan ik gebruikers omleiden naar verschillende pagina&#39;s op basis van de manier waarop ze het formulier hebben ingevuld?

Ja. U kunt een **[!UICONTROL Conditional redirect]** op de pagina Bedankt configureren en regels definiëren om verschillende vervolgacties weer te geven op basis van formulierreacties. Zo kunt u bezoekers in het ene land bijvoorbeeld doorsturen naar de ene pagina en bezoekers in het andere land naar een andere pagina, met een standaardfallback voor alle anderen. [Meer informatie](#thank-you-page)

+++

+++Kunnen formuliervelden vooraf worden ingevuld met bestaande profielgegevens?

Ja. Wanneer u een veld configureert, kunt u de optie **[!UICONTROL Prefilled Enabled]** inschakelen, zodat het veld automatisch wordt ingevuld op basis van de bekende profielgegevens wanneer deze beschikbaar zijn.

+++

+++Kan ik een veld verplicht maken zodat gebruikers het niet kunnen overslaan?

Ja. Selecteer **[!UICONTROL Field behaviors]** in de sectie **[!UICONTROL Required]** van de configuratie van een veld. Gebruikers kunnen het formulier pas verzenden nadat alle vereiste velden zijn ingevuld.

+++

+++Waar gaan de gegevens van de formulierverzending nadat een gebruiker het formulier heeft verzonden?

Wanneer de vorm wordt voorgelegd, wordt het gegeven verzonden naar **het stromen verbinding** die in de vorm wordt bepaald vooraf ingesteld. Het wordt dan geduwd in de verbonden **[!DNL Experience Platform]dataset** door een automatisch geproduceerde bronstroom die afbeelding, transformatie, en bevestiging behandelt.
