...
Beginnen met het maken van inhoud van uw landing [primaire pagina](create-lp.md#configure-primary-page) of [subpagina](create-lp.md#configure-subpages)Houd de muis boven de inhoud van de primaire pagina en klik op **[!UICONTROL Open Designer]** of klik op de bijbehorende knop in het rechterpalet.
...
>[!NOTE]
>
>De ontwerper van de landingspagina-inhoud is meestal vergelijkbaar met de ontwerper van de e-mail. Meer informatie over het ontwerpen van inhoud met [!DNL Journey Optimizer] [hier](../design-emails.md).

Volg onderstaande stappen om specifieke inhoud voor de landingspagina te definiëren.
...
1. Kies wat tussen de drie volgende opties wordt bijgewerkt:
   ...
   * **[!UICONTROL Subscription list]**: U moet de abonnementenlijst selecteren die wordt bijgewerkt als het profiel dit selectievakje selecteert. Meer informatie over abonnementlijsten in [deze sectie](subscription-list.md).
   ...
   * **[!UICONTROL Email entity]**: De opt-in of opt-out is alleen van toepassing op het e-mailadres dat is gebruikt voor toegang tot de bestemmingspagina. Als een profiel bijvoorbeeld twee e-mailadressen heeft, ontvangt alleen het profiel dat is gebruikt om u aan te melden, communicatie van uw merk.
...
1. Klikken **[!UICONTROL Call to action]** om de corresponderende sectie uit te vouwen. Hiermee kunt u het gedrag van de knop in het dialoogvenster **[!UICONTROL Form]** component.
...
1. Definieer wat er gebeurt wanneer op de knop wordt geklikt in het geval een fout optreedt:
   ...
   * **[!UICONTROL Redirect URL]**: Voer de URL in van de pagina waarnaar de gebruikers worden omgeleid.
   * **[!UICONTROL Error text]**: Typ de fouttekst die wordt weergegeven. U kunt de fouttekst voorvertonen door het bijbehorende selectievakje in te schakelen.
