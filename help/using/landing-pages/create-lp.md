...
>[!NOTE]
>
>Alvorens uw eerste het landen pagina te creëren, voltooi [&#x200B; het landen pagina&#39;s &#x200B;](../../rp_landing_pages/lp-configuration-landing-page.md) opstelling vormen. Dit omvat het configureren van een subdomein voor het hosten van bestemmingspagina&#39;s en het definiëren van ten minste één voorinstelling die het subdomein en andere kanaalinstellingen opgeeft. U moet een voorinstelling selecteren wanneer u de openingspagina maakt.
...
1. Selecteer het type landingspagina dat u wilt maken.

   ![](assets/lp_create-lp-data-capture.png){width=60%}

   * **[!UICONTROL Subscription/Unsubscription]**: Gebruik dit type om een openingspagina te maken voor gebruik bij abonnementen of abonnementen. [Meer informatie](lp-use-cases.md#subscription-to-a-service)
   * **[!UICONTROL Data Capture]**: Gebruik dit type om een bestemmingspagina te maken voor het vastleggen van gegevens. [Meer informatie](get-started-lp.md#data-capture-lp)
...
>[!CAUTION]
>
>* Als u bestemmingspagina&#39;s wilt publiceren, moet u de **[!UICONTROL Publish Messages]** toestemming hebben.
>* Controleer en los alle waarschuwingen op voordat u ze publiceert. [Meer informatie](#check-alerts)
