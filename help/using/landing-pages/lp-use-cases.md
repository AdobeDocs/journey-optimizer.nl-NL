...
1. De **[!UICONTROL Events]** categorie en een **[!UICONTROL Segment Qualification]** op uw canvas. [Meer informatie](../building-journeys/segment-qualification-events.md)
