...
1. [ wijs een plaatsing ](#placement) toe (E-mailkanaal slechts)

>[!AVAILABILITY]
>
>Het beleid van het besluit is beschikbaar voor de **op code-gebaseerde Ervaring**, **Push- bericht**, **SMS**, en **E-mail** kanalen.

## Een beslissingsbeleid toevoegen {#add}

Open een reis of een campagne, selecteer de actie van het a [ kanaal ](../building-journeys/journey-action.md) en geef de inhoud van uw bericht uit.
...
1. Voeg een nieuw besluitvormingsbeleid toe, gebruikend of de **verpersoonlijkingsredacteur** of het **Beslissende** menu beschikbaar in de E-mailontwerper.
   ...
   >[!NOTE]
   >
   >Met de optie **[!UICONTROL Reuse decision output]** kunt u een beslissingsbeleid opnieuw gebruiken dat al in deze e-mail is gemaakt. Het is vooral handig als u hetzelfde aanbod op meerdere locaties wilt weergeven (bijvoorbeeld kop- en voettekst).
   >
   >Wanneer dezelfde aanbieding door meer dan één beslissingsbeleid in de e-mailhoofdtekst kan worden geselecteerd, dedupliceert de engine de aanbiedingen: elke plaatsing ontvangt een andere aanbieding, zodat dezelfde aanbieding niet op beide plaatsen wordt weergegeven. Als u dezelfde aanbieding op meerdere plaatsen wilt weergeven, gebruikt u **[!UICONTROL Reuse decision output]** om de uitvoer van een bestaand beslissingsbeleid in deze e-mail opnieuw te gebruiken.

   +++

U kunt ook beleidsregels voor beslissingen toevoegen wanneer u de modus **[!UICONTROL Code your own]** in de Designer-e-mail gebruikt. Navigeer hiertoe naar **[!UICONTROL Decision policies]** om de code voor het beslissingsbeleid in te voegen. [ Leer hoe te om uw eigen e-mailinhoud ](../email/code-content.md) te coderen.

![](assets/decision-policy-add-code-your-own.png)

>[!NOTE]
>
>In de modus **[!UICONTROL Code your own]** kunt u slechts één beslissingsitem per beleid retourneren, omdat de component **[!UICONTROL Repeat Grid]** niet beschikbaar is.
