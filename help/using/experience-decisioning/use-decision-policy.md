...
1. Selecteer **[!UICONTROL Insert policy]** (op code gebaseerde ervaring) of **[!UICONTROL Insert syntax]** (e-mail) om de code toe te voegen die overeenkomt met het beslissingsbeleid.
