...
>
>Het besluit voor het **E-mail** kanaal is beschikbaar in Beperkte Beschikbaarheid slechts. Neem contact op met uw Adobe-vertegenwoordiger als u toegang wilt aanvragen. Voor volledige details over de de versiecyclus en beschikbaarheidsfasen, zie [&#x200B; de versiecyclus van Journey Optimizer &#x200B;](../rn/releases.md).
...
3. Als er nog geen plaatsing aan de component is toegewezen, selecteert u een plaatsing in de lijst en klikt u op **[!UICONTROL Assign]** .
   ...
   >[!NOTE]
   >
   >Als u in dezelfde e-mail meerdere beleidsregels voor beslissingen gebruikt (bijvoorbeeld een voor de kop- en een voor de voettekst), wordt dezelfde aanbieding over de verschillende plaatsen gededupliceerd: de aanbieding wordt niet tweemaal weergegeven. Het tweede besluitvormingsbeleid zal om het even welke inhoud terugkeren en zal een lege ruimte tonen, tenzij u een reserveaanbieding hebt gevormd, in welk geval in plaats daarvan zal de reserve worden getoond.
