---
title: Een beslissingsitem opzoeken
...
Om specifieke besluitpunten op te zoeken door een GET- verzoek aan de Bibliotheek API van het Aanbod te doen die identiteitskaart in de verzoekweg omvat.
...
| `{ID}` | De id van de entiteit die u wilt opzoeken. | `offerItem1234` |
...
Een succesvol antwoord retourneert de details van het beslissingsitem.
