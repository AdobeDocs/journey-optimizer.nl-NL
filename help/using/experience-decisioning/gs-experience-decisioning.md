...
>[!IMPORTANT]
>
>Het beleid van het besluit is beschikbaar aan alle klanten voor de **op code-gebaseerde Ervaring**, **Push bericht**, en **SMS** kanalen. Het besluit voor het **E-mail** kanaal is beschikbaar in Beperkte Beschikbaarheid slechts. Neem contact op met uw Adobe-vertegenwoordiger als u toegang wilt aanvragen. Voor volledige details over de de versiecyclus en beschikbaarheidsfasen, zie [&#x200B; de versiecyclus van Journey Optimizer &#x200B;](../rn/releases.md).
