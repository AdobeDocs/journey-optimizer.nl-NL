...
## Toegang tot AI-modellen {#access-ai-models}

Ga naar **[!UICONTROL Decisioning]** > **[!UICONTROL Strategy setup]** en selecteer **[!UICONTROL AI models]** om de lijst met AI-modellen te openen. Alle in uw exemplaar gemaakte AI-modellen worden hier weergegeven.
...
1. Ga naar het menu **[!UICONTROL Decisioning]** > **[!UICONTROL Strategy setup]** en selecteer **[!UICONTROL AI models]** .
   ...
   Alle AI-modellen die tot nu toe op uw exemplaar zijn gemaakt, worden hier weergegeven.
...
1. Het gedeelte **[!UICONTROL Optimization metric]** bevat informatie over de conversiegebeurtenis die door het AI-model wordt gebruikt om de rangorde van aanbiedingen te berekenen.
   ...
   * **de gebeurtenissen van de Omzetting** (aanbiedingen die in kliks via e-mail of Web) resulteren.
   ...
   Deze gebeurtenissen worden automatisch vastgelegd met de Web SDK of de Mobile SDK die is opgegeven. Leer meer in het [&#x200B; overzicht van SDK van het Web 0&rbrace; Adobe Experience Platform.](https://experienceleague.adobe.com/docs/experience-platform/edge/home.html?lang=nl-NL)
...
1. Sla het AI-model op en activeer het. Zodra uw model levend is, kunt u [&#x200B; zijn opleidingsstatus en prestaties controleren &#x200B;](ai-model-observability.md).
