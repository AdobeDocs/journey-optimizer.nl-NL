...
Het besluit is beschikbaar aan alle klanten voor de **op code-gebaseerde Ervaring**, **duw bericht**, en **SMS** kanalen. Het besluit voor het **E-mail** kanaal is beschikbaar in Beperkte Beschikbaarheid. Neem contact op met uw Adobe-vertegenwoordiger als u toegang tot de beslissing via e-mail wilt aanvragen. Voor volledige details over de de versiecyclus en beschikbaarheidsfasen, zie [&#x200B; de versiecyclus van Journey Optimizer &#x200B;](../rn/releases.md).
