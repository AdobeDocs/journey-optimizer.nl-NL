...
|| Guardrail | Limiet |
|| — | — |
|| Op code gebaseerde API-aanvraag voor ervaring met beslissingsbeleid met Edge-segmentatie | 150 |
...
|| Totaal aantal aangeboden objecten | 10 K |
|| Totaal aantal plaatsen | 1 K |
