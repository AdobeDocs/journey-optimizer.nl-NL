...
1. Kies **Eenheidgebeurtenissen** in het veld **[!UICONTROL Type]**.

   ![](../assets/jo-event3bis.png)

1. Selecteer in het veld **[!UICONTROL Event ID type]** het type gebeurtenis-id dat u wilt gebruiken: **Op regel gebaseerd** of **Door het systeem gegenereerd**. Lees meer over de types van gebeurtenisID in [deze sectie](../event/about-events.md#event-id-type).
...
1. Selecteer een XDM-schema in de lijst en klik op het veld **[!UICONTROL Payload]** of op het pictogram **[!UICONTROL Edit]**.
   ...
   >[!NOTE]
   >
   >Controleer of u de mix &quot;orkest&quot; aan het XDM-schema hebt toegevoegd. Dit zal ervoor zorgen dat uw schema alle vereiste informatie bevat om met [!DNL Journey Optimizer] te werken.
...
## De gebeurtenistoets {#define-the-event-key} definiëren
