...
Met Adobe Journey Optimizer kunt u georkestreerde campagnes maken tot een visueel canvas om kanaalprocessen te ontwerpen, zoals segmentatie, uitvoering van campagnes en bestandsverwerking.
...
## Belangrijke stappen om een georkestreerde campagne te maken {#gs-ms-campaign-steps}

De belangrijkste stappen om georkestreerde campagne te creëren zijn als volgt:
