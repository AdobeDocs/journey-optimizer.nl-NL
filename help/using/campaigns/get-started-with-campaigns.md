...
>title="Campagnes"
>abstract="Maak uw segmentatiestroom, maak uw berichten over meerdere kanalen en plan uw campagnes. Ondersteunde kanalen: E-mail, SMS, pushberichten, Direct mail."
...
>title="Campagnes"
>abstract="Lever enige of terugkomende uitgaande transactionele acties. Ondersteunde kanalen: e-mail, sms, pushberichten."
...
* **Toestemmingen** - u hebt aangewezen toestemmingen nodig die op het campagnetype worden gebaseerd. Neem contact op met de beheerder als u geen toegang hebt tot campagnefuncties. [ leer over ingebouwde rollen → ](../administration/ootb-product-profiles.md)
  ...
  |-------------|---------------|
  | **campagnes van de Actie** &amp; **API teweeggebrachte campagnes** | De beheerder van de campagne <br> Campagne goedkeurde {<br> Manager van de Campagne <br> de kijker van de Campagne |
...
5. **vorm programma** (voor campagnes van de Actie) of API details (voor API-teweeggebracht). Voor de campagnes van de Actie, kunt u het gebruiken van golven [ ook verzenden om het bericht in partijen in tijd te leveren.](send-using-waves.md)
...
**Type-specifieke gidsen:** [ de campagnecontent van de Actie ](campaign-content.md) | [ API-getriggerde campagneinhoud ](api-triggered-campaign-content.md) | [ Geordende campagneinhoud ](../orchestrated/create-orchestrated-campaign.md)
...
[Stille uren configureren](../conflict-prioritization/quiet-hours.md)
:::
