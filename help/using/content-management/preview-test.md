...
U kunt ook testleveringen van uw e-mailberichten naar specifieke ontvangers of abonnees verzenden voor tests en validatie, en hun rendering controleren bij populaire desktops, mobiele en webclients. Bovendien kunt u algemene aspecten van de inhoudkwaliteit evalueren, zoals leesbaarheid en doeltreffendheid. [ leer meer over de bevestiging van de inhoudskwaliteit ](brands-score.md#validate-quality)
...
>[!IMPORTANT]
>
>Als u **[!UICONTROL Simulate Content]** van een **Geordende campagne** kanaalactiviteit gebruikt, zie [ Controle en test uw inhoud ](../orchestrated/activities/channels.md#simulate-content-test-profiles) voor meer informatie en belangrijke nota&#39;s.
...
* **Vereiste toestemmingen** - u moet de **[!DNL Manage Simulate Content]** toestemming hebben inbegrepen in het **[!DNL Content Library Manager]** productprofiel. [Meer info](../administration/ootb-product-profiles.md#content-library-manager).
