...
title: Webpagina's genereren met AI Assistant
description: Beginnen met het genereren van webpagina-inhoud en -elementen met AI Assistant in Journey Optimizer.
...
1. Selecteer een **[!UICONTROL Text component]** als u alleen een specifieke inhoud als doel wilt instellen. en opent u het menu **[!UICONTROL Show AI Assistant]** .
   ...
   ![&#x200B; de ontwerper van het Web met de geselecteerde component van de Tekst en toon AI Hulp menuknoop &#x200B;](assets/web-gen-full-1.png){zoomable="yes"}
...
1. Verfijn de inhoud door te beschrijven wat u wilt genereren in het veld **[!UICONTROL Prompt]** .
   ...
   ![&#x200B; AI Medewerker paneel voor Web-pagina tekst met de selecteur van het Merk, het gebied van de Vragen, en de knoop van de Bibliotheek van de Vragen &#x200B;](assets/web-gen-full-2.png){zoomable="yes"}
...
1. Volg uw vraag met de optie **[!UICONTROL Text settings]** :
   ...
   * **Lengte van de Tekst**: Gebruik de schuif om de gewenste lengte van uw tekst te selecteren.
   ...
   ![&#x200B; het instellingenpaneel van de Tekst die Communicatie strategie, Talen, Toon, en de schuif van de Lengte van de Tekst voor Webinhoud tonen &#x200B;](assets/web-gen-full-3.png){zoomable="yes"}
...
1. Klik op het percentagepictogram om uw **[!UICONTROL Brand Alignment Score]** weer te geven en eventuele onjuiste uitlijningen met uw merk te identificeren.
   ...
   ![&#x200B; Gegenereerde de variaties van de Web-pagina tekst met het percentageindicator van de Score van de Groepering &#x200B;](assets/web-gen-full-4.png){zoomable="yes"}
...
1. Navigeer naar de optie **[!UICONTROL Refine]** in het **[!UICONTROL Preview]** -venster voor toegang tot extra aanpassingsfuncties:
   ...
   * **[!UICONTROL Use simpler language]**: Gebruik AI Assistant om uw taal te vereenvoudigen, zodat een groter publiek helderheid en toegankelijkheid krijgt.
   ...
   ![&#x200B; verfijnen menu voor Webtekst die Elaborate, Samenvatten, Hervatten, de eenvoudigere taal van het Gebruik met dropdown van de Toon toont &#x200B;](assets/web-gen-full-5.png){zoomable="yes"}
...
1. Selecteer **[!UICONTROL Show AI Assistant]** in het rechtermenu.
   ...
   ![&#x200B; de ontwerper van het Web met geselecteerde beeldactiva en toon AI Medewerkend paneel dat voor beeldgeneratie wordt geopend &#x200B;](assets/web-gen-img-1.png){zoomable="yes"}
...
1. Verfijn de inhoud door te beschrijven wat u wilt genereren in het veld **[!UICONTROL Prompt]** .
   ...
   ![&#x200B; AI Hulp beeldgeneratie voor Web met de stijlknevel van de Verwijzing, de selecteur van het Merk, en het gebied van de Vragen &#x200B;](assets/web-gen-img-2.png){zoomable="yes"}
...
1. Volg uw vraag met de optie **[!UICONTROL Image settings]** :
   ...
   * **[!UICONTROL Composition]**: dit heeft betrekking op de rangschikking van elementen binnen het kader van een afbeelding
   ...
   ![&#x200B; de montagespaneel van het Beeld voor Web met de Verhouding, het type van Inhoud, Visuele intensiteit, Kleur en toon, Belichting, en Samenstelling &#x200B;](assets/web-gen-img-3.png){zoomable="yes"}
...
1. Klik op het percentagepictogram om uw **[!UICONTROL Brand Alignment Score]** weer te geven en eventuele onjuiste uitlijningen met uw merk te identificeren.
   ...
   ![&#x200B; Gegenereerde de veranderingen van het Web-pagina beeld met de Score van de Uitlijning van het Merk en voorproefcontroles &#x200B;](assets/web-gen-img-4.png){zoomable="yes"}
...
[Meer informatie over Adobe Express-integratie](../integrations/express.md)
   ...
   * **[!UICONTROL Save]** gebruiken om de elementen op te slaan, zodat u ze later kunt gebruiken.
   ...
   ![&#x200B; verfijnen opties voor Webbeelden die Gelijkaardig tonen, in Adobe Express, uitgeven, en sparen knopen tonen &#x200B;](assets/web-gen-img-5.png){zoomable="yes"}
