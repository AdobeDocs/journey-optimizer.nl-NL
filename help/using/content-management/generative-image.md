...
title: Afbeeldingen genereren met AI Assistant
description: Leer hoe u afbeeldingen genereert met AI Assistant in Journey Optimizer.
...
1. Selecteer **[!UICONTROL AI Assistant]** (of **[!UICONTROL Show Content Assistant]** voor web) in het rechtermenu.
   ...
   {de activa van het 0} Beeld selecteerde en AI Hulp geopend paneel ![](assets/image-genai-1.png){zoomable="yes"}
...
1. Verfijn de inhoud door te beschrijven wat u wilt genereren in het veld **[!UICONTROL Prompt]** .
   ...
   ![&#x200B; AI Hulp het deelvenster van de beeldgeneratie met opties &#x200B;](assets/image-genai-2.png){zoomable="yes"}

1. Volg uw vraag met de optie **[!UICONTROL Image settings]** :

   * **[!UICONTROL Generative model]**: maak een keuze uit de gebruiksklare versie van **[!UICONTROL Adobe model]** , de **[!UICONTROL Partner model]** voor gespecialiseerde functies of **[!UICONTROL Custom models]** die is opgeleid voor uw eigen middelen. [Meer informatie](generative-models.md). Om de partner (**Gemini**) model met **tekstbedekkingen** op geproduceerde beelden te gebruiken, zie [&#x200B; Gebruik Gemini als generatief model voor tekst-bedekking beeld &#x200B;](generative-uc.md#generative-gemini).
   ...
   * **[!UICONTROL Composition]**: dit heeft betrekking op de rangschikking van elementen binnen het kader van een afbeelding
     ...
     ![&#x200B; de montagespaneel van het Beeld met controles &#x200B;](assets/image-genai-4.png){zoomable="yes"}
...
1. Klik op het percentagepictogram om uw **[!UICONTROL Brand Alignment Score]** weer te geven en eventuele onjuiste uitlijningen met uw merk te identificeren.
   ...
   ![&#x200B; de groeperingsscore van de Merk voor variaties &#x200B;](assets/image-genai-6.png){zoomable="yes"}
...
[Meer informatie over Adobe Express-integratie](../integrations/express.md)
   ...
   * **[!UICONTROL Save]** gebruiken om de elementen op te slaan, zodat u ze later kunt gebruiken.
     ...
     ![&#x200B; verfijnen opties die beschikbare acties tonen &#x200B;](assets/image-genai-5.png){zoomable="yes"}
...
1. Verfijn de inhoud door te beschrijven wat u wilt genereren in het veld **[!UICONTROL Prompt]** .
   ...
   ![&#x200B; AI Hulp beeldgeneratie voor duw &#x200B;](assets/push-gen-img.png){zoomable="yes"}

1. Selecteer **[!UICONTROL Image]** als veld dat u wilt genereren.
...
1. Kies uw **[!UICONTROL Image settings]** :
   ...
   * **[!UICONTROL Composition]**: dit heeft betrekking op de rangschikking van elementen binnen het kader van een afbeelding
     ...
     ![&#x200B; AI Hulp beeldgeneratie voor duw &#x200B;](assets/push-gen-img-3.png){zoomable="yes"}
...
1. Klik op het percentagepictogram om uw **[!UICONTROL Brand Alignment Score]** weer te geven en eventuele onjuiste uitlijningen met uw merk te identificeren.
   ...
   ![&#x200B; de groeperingsscore van de Merk voor variaties &#x200B;](assets/push-gen-img-2.png){zoomable="yes"}
