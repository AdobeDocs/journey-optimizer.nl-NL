...
1. Volg uw vraag met de optie **[!UICONTROL Image settings]** :
   ...
   * **[!UICONTROL Generative model]**: maak een keuze uit de gebruiksklare versie van **[!UICONTROL Adobe model]** , de **[!UICONTROL Partner model]** voor gespecialiseerde functies of **[!UICONTROL Custom models]** die is opgeleid voor uw eigen middelen. [Meer informatie](generative-models.md)
