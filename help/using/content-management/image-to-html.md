...
title: Afbeeldingen converteren naar sjablonen voor e-mailinhoud
description: Leer hoe u met de AI-afbeelding naar HTML-converter afbeeldingsontwerpen omzet in bewerkbare sjablonen voor e-mailinhoud
...
Houd rekening met de volgende beperkingen wanneer u afbeeldingen omzet in sjablonen voor e-mailinhoud.
...
* **Beperkte Beschikbaarheid**: Als Beperkte eigenschap van de Beschikbaarheid, wordt deze convertor onophoudelijk verbeterd. De functionaliteit en nauwkeurigheid kunnen variëren en uw feedback kan de functie verbeteren.
...
1. Voer in de sectie **[!UICONTROL Convert image to template]** de volgende stappen uit:
   ...
   * Als u een afbeelding wilt uploaden, moet u ervoor zorgen dat deze geen persoonlijk identificeerbare gegevens (PII) of andere vertrouwelijke gegevens bevat. Schakel de desbetreffende optie in om te bevestigen dat u het bestand hebt gereviseerd.
...
1. Nadat u de afbeelding hebt geselecteerd, klikt u op **[!UICONTROL Open]** om het omzettingsproces op basis van AI te starten.

   >[!NOTE]
   >
   >Het generatieproces kan maximaal 5 minuten in beslag nemen, afhankelijk van de complexiteit en de grootte van het afbeeldingsontwerp. U kunt buiten dit scherm navigeren en aan andere taken werken terwijl de conversie bezig is.

1. Nadat de conversie is voltooid, wordt de inhoudssjabloon automatisch opgeslagen als concept.
...
* [Inhoud helemaal opnieuw ontwerpen](../email/content-from-scratch.md)
