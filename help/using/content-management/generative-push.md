...
title: Push generation met de AI Assistant in Journey Optimizer for Content Acceleration
description: Beginnen met het genereren van push-inhoud met de AI-assistent in Journey Optimizer for Content Acceleration
...
# Push generation met de AI Assistant in Journey Optimizer - Content Accelerator  {#generative-push}
...
Als u uw berichten hebt gemaakt en gepersonaliseerd, neemt u de inhoud van uw pushmelding naar het volgende niveau met de AI Assistant in Journey Optimizer for Content Acceleration.
...
In dit voorbeeld leert u hoe u een aansprekende pushmelding verzendt met gebruik van AI Assistant in Journey Optimizer for Content Acceleration.
...
1. Schakel de optie **[!UICONTROL Use original content]** voor de AI-assistent voor versnelling van inhoud in om de nieuwe inhoudsoptie aan te passen op basis van de geselecteerde inhoud.
...
1. Volg uw vraag met de optie **[!UICONTROL Text settings]** :
   ...
   * **[!UICONTROL Tone]**: De toon van uw pushberichten zou met uw publiek moeten resoneren. Of u informatief wilt klinken, playful, of overtuigend, de Medewerker van AI kan het bericht dienovereenkomstig aanpassen.
...
In dit voorbeeld leert u hoe u de AI-assistent in Journey Optimizer for Content Acceleration kunt gebruiken voor specifieke inhoud. Voer de volgende stappen uit:
...
1. Volg uw vraag met de optie **[!UICONTROL Text settings]** :
   ...
   * **[!UICONTROL Communication strategy]**: Kies de meest geschikte communicatiestijl voor de gegenereerde tekst.
   * **[!UICONTROL Tone]**: De toon van uw pushmelding zou op uw publiek moeten passen. Of u informatief wilt klinken, playful, of overtuigend, de Medewerker van AI kan het bericht dienovereenkomstig aanpassen.
...
1. Selecteer **[!UICONTROL Generate Similar]** om afbeeldingsvariaties weer te geven die sterk overeenkomen met de huidige optie, zodat alternatieve ontwerpen een consistent thema krijgen.
