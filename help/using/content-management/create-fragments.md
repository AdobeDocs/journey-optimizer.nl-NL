...
U kunt geheel nieuwe fragmenten maken in het menu links van **[!UICONTROL Fragments]** . Bovendien kunt u een deel van bestaande inhoud als fragment opslaan bij het ontwerpen van inhoud. [&#x200B; leer hoe &#x200B;](save-fragments.md#)

Zodra je het fragment hebt opgeslagen, kun je het gebruiken in een traject, campagne of sjabloon. Je kunt dit fragment gebruiken bij het bouwen van content binnen trajecten en campagnes. Zie [&#x200B; visuele fragmenten &#x200B;](../email/use-visual-fragments.md) en [&#x200B; de uitdrukkingsfragmenten van de Leverage &#x200B;](../personalization/use-expression-fragments.md) toevoegen.
...
* Voor visuele fragmenten kunt u de inhoud naar wens bewerken, net zoals u dat zou doen voor elke e-mail in een rit of campagne. [Meer informatie](../email/get-started-email-design.md)
  ...
  >[!CAUTION]
  >
  >Fragmenten zijn niet kruiscompatibel tussen de modi Thema&#39;s gebruiken en Handmatige stijlen. Wanneer u een fragment in e-mailinhoud gebruikt, moet u een thema toepassen dat u voor dit fragment hebt gedefinieerd. [Meer informatie](../email/apply-email-themes.md#leverage-themes-fragment)

* Voor expressiefragmenten gebruikt u de [!DNL Journey Optimizer] personalisatie-editor met alle personalisatie- en ontwerpmogelijkheden om uw fragmentinhoud samen te stellen. [Meer informatie](../personalization/personalization-build-expressions.md)

  ![](assets/fragment-expression-editor.png)

  >[!NOTE]
  >
  >Expressiefragmenten van het JSON-type worden syntactisch gevalideerd bij het opslaan, waarbij eventuele fouten als waarschuwingsberichten worden weergegeven.
...
1. Als het fragment tijdens een live reis of campagne wordt gebruikt, wordt een bericht geopend om u op de hoogte te brengen. Klik op de koppeling **[!UICONTROL See more]** om de lijst met reizen en/of campagnes te openen waarnaar wordt verwezen. [&#x200B; Leer hoe te om verwijzingen van een fragment &#x200B;](../content-management/manage-fragments.md#explore-references) te onderzoeken
   ...
   Klik op **[!UICONTROL Confirm]** om het fragment te publiceren en bij te werken in de live trajecten/campagnes waarin het wordt gebruikt.
