...
title: E-mailgeneratie met AI Assistant
description: E-mailinhoud en -middelen genereren met de AI Assistant
...
Met de AI Assistant kunt u de doeltreffendheid van uw campagnes verbeteren door complete e-mails, op maat gemaakte tekstfragmenten en aangepaste afbeeldingen te maken die rechtstreeks met uw publiek spreken, waardoor betrokkenheid en interactie worden bevorderd.
...
In het volgende voorbeeld gebruiken we de AI-assistent om een bestaande e-mailsjabloon te verfijnen.

1. Nadat u uw e-mailcampagne hebt gemaakt en geconfigureerd, klikt u op **[!UICONTROL Edit content]**.

   Raadpleeg voor meer informatie over het configureren van uw e-mailcampagne de [deze pagina](../campaigns/create-campaign.md).

1. Pas uw e-mail naar wens aan en open de **[!UICONTROL AI Assistant]** -menu.

   ![](assets/full-email-1.png){zoomable=&quot;yes&quot;}

1. De optie **[!UICONTROL Use original content]** in dat geval past de AI Assistant de nieuwe inhoud aan op basis van de inhoud van de campagne, de naam en het geselecteerde publiek.
...
1. U kunt schakelen tussen **[!UICONTROL Subject line]** en **[!UICONTROL Preheader]** opties om hen aan de variantgeneratie op te nemen.
...
1. Voeg verpersoonlijkingsgebieden in om uw e-mailinhoud aan te passen die op profielgegevens wordt gebaseerd. Klik vervolgens op de knop **[!UICONTROL Simulate content]** om de rendering te beheren en personalisatie-instellingen te controleren met testprofielen. [Meer informatie](../personalization/personalize.md)
...
In het volgende voorbeeld gebruiken we de AI-assistent om de inhoud van onze e-mail te verbeteren.

1. Nadat u uw e-mailcampagne hebt gemaakt en geconfigureerd, klikt u op **[!UICONTROL Edit content]**.

   Raadpleeg voor meer informatie over het configureren van uw e-mailcampagne de [deze pagina](../email/create-email.md).
...
1. Vul de **[!UICONTROL Basic details]** voor uw campagne. Klik op **[!UICONTROL Edit email content]**.
...
1. De optie **[!UICONTROL Reference style]** voor de AI-assistent om nieuwe inhoud aan te passen aan de inhoud van de referentie. U kunt ook een afbeelding uploaden om context aan uw variatie toe te voegen.
...
Leer hoe u de AI-assistent gebruikt om volledige e-mail, tekst of afbeeldingen te genereren.
