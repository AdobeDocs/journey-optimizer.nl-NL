...
1. Open het menu **[!UICONTROL Show AI Assistant]** .
   ...
   {het bericht van SMS van 0} redacteur met AI het Hulp geopende paneel tonen van de selecteur van het Merk en het gebied van de Vragen ![](assets/sms-genai-1.png){zoomable="yes"}
...
1. Verfijn de inhoud door te beschrijven wat u wilt genereren in het veld **[!UICONTROL Prompt]** .
   ...
   ![&#x200B; AI Medewerker voor SMS met de selecteur van het Merk, het gebied van de Vragen, en de toegangsknoop van de Bibliotheek van de Vragen &#x200B;](assets/sms-genai-2.png){zoomable="yes"}
...
1. Volg uw vraag met de optie **[!UICONTROL Text settings]** :
   ...
   * **[!UICONTROL Length]**: selecteer de lengte van de inhoud met de schuifregelaar voor het bereik.
   ...
   ![&#x200B; de montagespaneel van de Tekst voor SMS die Communicatie strategie, Talen, Toon, en de schuifcontroles van de Lengte tonen &#x200B;](assets/sms-genai-3.png){zoomable="yes"}
...
1. Klik op het percentagepictogram om uw **[!UICONTROL Brand Alignment Score]** weer te geven en eventuele onjuiste uitlijningen met uw merk te identificeren.
   ...
   ![&#x200B; Gegenereerde de variaties van SMS met het percentageindicator van de Score van de Groepering en voorproefopties &#x200B;](assets/sms-genai-5.png){zoomable="yes"}
...
1. Navigeer naar de optie **[!UICONTROL Refine]** in het **[!UICONTROL Preview]** -venster voor toegang tot extra aanpassingsfuncties en perfectioneer uw variatie aan uw voorkeuren:
   ...
   * **[!UICONTROL Use simpler language]**: Gebruik AI Assistant om uw taal te vereenvoudigen, zodat een groter publiek helderheid en toegankelijkheid krijgt.
   ...
   ![&#x200B; verfijnen opties voor SMS die Rehrase tonen, Gebruik eenvoudigere taal met Toon en Communicatie strategiedropdowns &#x200B;](assets/sms-genai-4.png){zoomable="yes"}
