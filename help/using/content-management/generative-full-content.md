...
1. Kies uw **[!UICONTROL Image settings]** :
   ...
   * **[!UICONTROL Generative model]**: maak een keuze uit beschikbare ingebouwde modellen, aangepaste Firefly-modellen die zijn opgeleid voor uw merkmiddelen of externe leveranciers van images om afbeeldingen te maken die zijn afgestemd op uw specifieke behoeften en merkvereisten. [Meer informatie](generative-models.md)
