...
title: Volledige inhoud genereren met AI Assistant
description: Leer hoe u volledige inhoud kunt genereren met AI Assistant in Journey Optimizer.
...
1. Kies uw **[!UICONTROL Image settings]** :
   ...
   * **[!UICONTROL Generative model]**: maak een keuze uit beschikbare ingebouwde modellen, aangepaste Firefly-modellen die zijn opgeleid voor uw merkmiddelen of externe leveranciers van images om afbeeldingen te maken die zijn afgestemd op uw specifieke behoeften en merkvereisten. [Meer informatie](generative-models.md). Voor **Gemini** met **tekstbedekkingen** op beelden, zie [&#x200B; Gebruik Gemini als generatief model voor tekst-bedekking beeld &#x200B;](generative-uc.md#generative-gemini).
