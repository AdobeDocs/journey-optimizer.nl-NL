...
### Voorbeeld: aanpasbaar expressiefragment {#example}
...
RTF-tekst, zoals regeleinden, vet, cursief, enz., kan aan een aanpasbaar fragment worden toegevoegd met HTML-componenten. Volg de onderstaande stappen om dit te doen.
<!--
...
### RTF-tekst gebruiken in aanpasbare fragmenten {#use-rich-text}

Wanneer u het fragment aan uw e-mail toevoegt, kunt u nu de rijke tekstinhoud en opmaak bewerken die u hebt gemaakt. Voer als markeerteken de onderstaande stappen uit.
