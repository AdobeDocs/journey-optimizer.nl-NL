...
>[!AVAILABILITY]
>
> De Experimentation Accelerator is momenteel in bèta, met functies die geleidelijk worden geïmplementeerd.
...
* **KPI Controle**: De metriek van het spoor zoals lift, opbrengst, en vertrouwen over experimenten.
...
Ga als volgt te werk om **[!UICONTROL Experimentation Accelerator]** te openen:

* Selecteer in het linkermenu de optie **[!UICONTROL Experimentation Accelerator]** in de vervolgkeuzelijst **[!UICONTROL Experimentation]** .

* U kunt ook **[!UICONTROL Experimentation Accelerator]** selecteren via de schakeloptie Apps.

Gebruikers met alleen een Target-licentie hebben er alleen toegang toe via de Apps-schakeloptie.
