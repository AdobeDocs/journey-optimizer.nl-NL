...
* Cliënt-kant slechts - om wijzigingen aan uw website toe te voegen, moet u [ Adobe Experience Platform Web SDK ](https://experienceleague.adobe.com/docs/platform-learn/implement-web-sdk/overview.html){target="_blank"} uitvoeren  op uw website.
