...
* Als er naar wordt verwezen door een live reis. Als u probeert een configuratie die nog wordt gebruikt, te deactiveren tijdens een live reis, treedt er een fout op.

  Om een kanaalconfiguratie te deactiveren, zorg ervoor dat alle levende reizen die deze configuratie gebruiken worden gesloten of tegengehouden. [&#x200B; leer om een reis &#x200B;](../building-journeys/end-journey.md) te beëindigen
