...
>
>Wanneer het uitgeven van een e-mailconfiguratie, kunt u geen nieuwe [ profielattributen ](../personalization/personalization-build-expressions.md#sources) aan kopbalparameters toevoegen. U moet a [ nieuwe kanaalconfiguratie ](#create-channel-surface) tot stand brengen.
...
1. Bewerk de eigenschappen naar wens.
   ...
   >[!NOTE]
   >
   >* Wanneer de configuratie de status **[!UICONTROL Active]** heeft, zijn de velden **[!UICONTROL Name]** , **[!UICONTROL Select channel]** en **[!UICONTROL Subdomain]** alleen-lezen en kunnen deze niet worden gewijzigd.
   >* U kunt uw wijzigingen op elk gewenst moment als concept opslaan en de update later hervatten.
   >* Bewerkingen die beperkt zijn tot de velden **[!UICONTROL Description]** , **[!UICONTROL Email type]** en/of **[!UICONTROL Email retry parameters]** , worden onmiddellijk van kracht, zonder vertraging bij de verwerking.
