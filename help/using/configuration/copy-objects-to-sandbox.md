...
>[!NOTE]
>
>De het exemplaarinformatie van de campagnesandbox in deze subsection is op **acties** campagnes en **API-teweeggebrachte** campagnes van toepassing. **Geordende** campagnes worden niet gesteund voor exemplaar tussen zandbakken.

Voor **actie** en **API-teweeggebrachte** campagnes, worden de campagnes gekopieerd samen met alle punten met betrekking tot het profiel, het publiek, het schema, de gealigneerde berichten, en afhankelijke voorwerpen. Nochtans, worden de volgende punten **niet** gekopieerd:
