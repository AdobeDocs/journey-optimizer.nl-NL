...
**het In kaart brengen van het gebruik/throttling APIs voor:**
* Het aantal API-aanroepen per seconde beperken
* Gelijktijdige verbindingen met uw eindpunt beheren
* Uw externe systeem beschermen tegen overbelasting

Neem contact op met Adobe om de egress-proxy voor uw organisatie in te schakelen als u een statische IP nodig hebt voor voegende op lijst van gewenste personen doeleinden.
