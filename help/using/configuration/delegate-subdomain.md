...
* Delegeer een douane subdomain - [ Leer hoe ](delegate-custom-subdomain.md)
...
1. Alvorens dat subdomain te kunnen gebruiken om berichten te verzenden, zorg ervoor dat alle DNS verslagen behoorlijk worden gecreeerd, dan wacht tot Adobe de vereiste controles uitvoert, die tot 3 uren kan vergen. [Meer info](#subdomain-validation).
