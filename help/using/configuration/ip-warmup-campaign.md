...
>[!NOTE]
>
>Wanneer een levende campagne in een IP warmup plan wordt gebruikt, nadat het plan [ zoals voltooid ](ip-warmup-execution.md#mark-as-completed) duidelijk is, verandert de [ status ](../campaigns/manage-campaigns.md#statuses) van die campagne in **[!UICONTROL Stopped]**.
