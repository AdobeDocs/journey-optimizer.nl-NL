...
1. Creeer een [ e-mail ](../email/email-settings.md) kanaal [ oppervlakte ](channel-surfaces.md) voor het domein en IPs dat u voor uw warmlopingsplan hebt geïdentificeerd.

   >[!NOTE]
   >
   >* Leer hoe te om het domein en IPs te selecteren in een e-mailoppervlakte in [ deze sectie ](../email/email-settings.md#subdomains-and-ip-pools) te gebruiken.
   >
