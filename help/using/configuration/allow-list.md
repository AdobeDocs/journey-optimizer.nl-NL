...
1. Selecteer **[!UICONTROL Activate allowed list]**. De lijst van gewenste personen is nu actief.
   ...
   >[!NOTE]
   >
   >* Na activering duurt het 10 minuten voordat de lijst van gewenste personen tijdens reizen en campagnes van kracht wordt. Het kan ook 10 minuten duren voordat de lijst van gewenste personen- en suppressielijst wordt bijgewerkt.
   >* Wanneer actief, wordt de lijst van gewenste personen afgedwongen niet alleen in levende reizen, maar ook wanneer het testen van berichten met [&#x200B; proeven &#x200B;](../content-management/proofs.md) en reizen op [&#x200B; testwijze &#x200B;](../building-journeys/testing-the-journey.md).
