...
1. Selecteer in de vervolgkeuzelijst de IP-adressen die u in de pool wilt opnemen en klik op **[!UICONTROL Submit]** . Alle IP adressen die met uw instantie worden geleverd zijn beschikbaar in de lijst.
...
1. Bewerk de eigenschappen naar wens. U kunt de beschrijving wijzigen en IP adressen toevoegen of verwijderen. Merk op dat de IP poolnaam niet editable is — om het anders te noemen, de pool te schrappen en nieuwe te creëren.
...
>[!NOTE]
>
>* Wanneer [&#x200B; creërend een kanaalconfiguratie &#x200B;](channel-surfaces.md#create-channel-surface), als u een IP pool in **[!UICONTROL Processing]** status selecteert die nooit met geselecteerde subdomain is geassocieerd, kunt u niet met configuratieverwezenlijking te werk gaan. [Meer informatie](channel-surfaces.md#create-channel-surface)
>* Zodra een IP pool met succes wordt bijgewerkt, sta een paar notulen toe alvorens het voor berichten in real time van kracht wordt, of wacht tot de volgende partijbaan voor partijberichten.
