...
Voordat u uw gegevens kunt exporteren, stelt u het exportproces in door de bestemming [!DNL Experience Platform] en de exportstroom van de gegevensset te definiëren.

Voor gedetailleerde stappen, gesteunde wolkenbestemmingen, vereiste toestemmingen, en meer informatie, zie [&#x200B; deze sectie &#x200B;](../data/export-datasets.md#export-datasets).
