...
Bij het instellen van een DMARC-record wordt een DNS TXT-record toegevoegd aan de DNS-instellingen van uw domein. In deze record wordt het DMARC-beleid opgegeven, bijvoorbeeld of berichten die niet worden geautoriseerd, in quarantaine moeten worden geplaatst of moeten worden afgewezen.

DNS de veranderingen vergen tijd over Internet, typisch tussen een paar minuten aan 48 uren te verspreiden.

Als u zojuist een DMARC-configuratiewijziging hebt aangebracht en probeert de update onmiddellijk te verifiëren, worden mogelijk fouten weergegeven of zijn de wijzigingen nog niet gedetecteerd.

Toestaan voldoende tijd voor de DNS verslagen om zich te verspreiden alvorens te proberen om uw opstelling van DMARC te verifiëren.
