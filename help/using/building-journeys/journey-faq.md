...
>[!IMPORTANT]
>
>Plaats geen a **[!UICONTROL Wait]** activiteit tussen de [ kanaalactie ](journeys-message.md) en de **[!UICONTROL Reaction]** activiteit. De **[!UICONTROL Reaction]** moet onmiddellijk na de kanaalactie komen. Gebruik de ingebouwde time-outfunctie van **[!UICONTROL Reaction]** om te wachten op reacties van klanten.
