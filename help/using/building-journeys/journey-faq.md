...
description: Veelgestelde vragen over Journey Orchestration in Adobe Journey Optimizer
...
Zoek antwoorden op veelgestelde vragen over Journey Orchestration in Adobe Journey Optimizer.
...
* **Streaming publiek kwalificatietiming**: Voor reizen die de Kwalificatie van het Publiek met het stromen publiek gebruiken, kunnen de profielen niet ingaan als zij reeds in het publiek waren alvorens de reis werd gepubliceerd, of als de reis zijn activeringsperiode (tot 10 minuten na het publiceren) niet heeft voltooid
