...
Adobe Journey Optimizer ondersteunt drie soorten publiek, elk met verschillende kenmerken en kenmerken:
...
* **las de reizen van het Publiek**: Alle drie gesteunde publiekstypes; de partijuitvoer komt voor wanneer de reis loopt
* **ritten van de Kwalificatie van het publiek van het publiek**: Het stromen aanbevolen publiek; het partijpubliek heeft vertraagde kwalificatieopsporing; upload niet gesteund publiek
...
Leer meer over [ publiek ](../audience/about-audiences.md), [ creërend segmenten ](../audience/creating-a-segment-definition.md), en [ douane uploadt publiek ](../audience/custom-upload.md).
