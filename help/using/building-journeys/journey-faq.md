...
title: Journey Orchestration - Veelgestelde vragen
description: Veelgestelde vragen over Journey Orchestration in  [!DNL Adobe Journey Optimizer]
feature: Journeys, Get Started
topic: Content Management
role: User
level: Beginner, Intermediate
keywords: reis, vragen, antwoorden, problemen oplossen, hulp, gids, orchestratie
...
# Journey Orchestration - Veelgestelde vragen {#faq-journeys}
...
+++ Wat is een reis in [!DNL Adobe Journey Optimizer]?
...
[!DNL Adobe Journey Optimizer] ondersteunt vier soorten reizen:
...
* **lees de reizen van het Publiek**: Begin met een publiek van [!DNL Adobe Experience Platform] en verzend berichten in partij aan alle profielen in dat publiek.
...
**Beste praktijken**: De reizen van het gebruik [&#x200B; &#x200B;](journey.md) voor complexe, gebeurtenis-teweeggebrachte overeenkomst met geavanceerde orchestratie. Gebruik [&#x200B; actiecampagnes &#x200B;](../campaigns/create-campaign.md) voor geplande, op publiek-gebaseerde mededelingen. Het gebruik [&#x200B; API-teweeggebrachte campagnes &#x200B;](../campaigns/api-triggered-campaigns.md) voor programmatic het teweegbrengen van externe systemen. Het gebruik [&#x200B; georkestreerde campagnes &#x200B;](../orchestrated/gs-orchestrated-campaigns.md) voor multi-step mededelingen met campagne-specifieke vereisten.
...
[!DNL Adobe Journey Optimizer] biedt ondersteuning voor vier soorten publiek, elk met verschillende kenmerken en hulplijnen:
...
* **Guardrails**:
   ...
   * Profielen moeten bestaan in [!DNL Adobe Experience Platform]

**4. FAC (Federated Audience Composition)-publiek**

* **Beschrijving**: Het publiek leidde tot het gebruiken van gefedereerde gegevens, die u toestaan om publiek van externe gegevenspakhuizen te vragen en samen te stellen zonder gegevens in [!DNL Adobe Experience Platform] te kopiëren
...
* **las de reizen van het Publiek**: Alle vier gesteunde publiekstypes; de partijuitvoer komt voor wanneer de reis loopt
...
* **op publiek-gebaseerde reizen**: Creeer publiek in [!DNL Adobe Experience Platform]
...
* **de raadpleging van de Dataset**: Als u gegevens van externe systemen in [!DNL Adobe Experience Platform] kunt laden, gebruik de eigenschap van de datasetraadpleging om informatie terug te winnen die in de datasets van Experience Platform wordt opgeslagen.
...
Leer meer over [&#x200B; voorwaarden &#x200B;](conditions.md).

+++

+++ Kan ik berichten naar profielen verzenden tijdens een reis?

Ja. Journey Optimizer omvat **ingebouwde kanaalacties** die u toestaan om berichten door e-mail, dupberichten, SMS/MMS/RCS, in-app berichten, Webervaringen, op code-gebaseerde ervaringen, inhoudskaarten, WhatsApp, en LIJN te verzenden. U kunt berichtinhoud rechtstreeks in Journey Optimizer ontwerpen en deze toevoegen als actieactiviteiten tijdens uw reis.
...
Leer meer over [&#x200B; berichten in reizen &#x200B;](journey-action.md) en [&#x200B; douaneacties &#x200B;](using-custom-actions.md).
...
Leer meer over [&#x200B; gebeurtenisconfiguratie &#x200B;](../event/about-events.md) en [&#x200B; e-mailacties &#x200B;](journey-action.md).

+++

+++ Kan ik een bericht opnieuw verzenden als iemand het niet opent of klikt?

Ja. Gebruik a **[!UICONTROL Reaction]** gebeurtenis met a **Onderbreking**:

1. Na het verzenden van uw bericht, voeg a **[!UICONTROL Reaction]** gebeurtenis **onmiddellijk** na de kanaalactie (zonder enige **[!UICONTROL Wait]** activiteit binnen tussen) toe
2. Configureer een time-outperiode (bijvoorbeeld 3 dagen) voor de **[!UICONTROL Reaction]** -gebeurtenis om te luisteren naar het openen van e-mail of het klikken erop
3. Twee paden maken:
...
Leer meer over [&#x200B; gebeurtenissen van de Reactie &#x200B;](reaction-events.md).

+++

+++ Hoe creëer ik een ritje voor het verlaten van een winkelwagen?

Een door een gebeurtenis geïnitieerde reis maken met behulp van een **[!UICONTROL Reaction]** -gebeurtenis met een Time-out:
...
2. **verzend een eerste bericht** (facultatief): E-mail erkennend de punten van het karretje
3. **voegt a [!UICONTROL Reaction] gebeurtenis onmiddellijk na de kanaalactie** toe: Vorm het om op een gebeurtenis van de Aankoop te luisteren
4. **plaats een onderbrekingsperiode**: Bepaal een onderbreking (b.v., 1-2 uren) op de **[!UICONTROL Reaction]** gebeurtenis om de klantentijd te geven om natuurlijk te voltooien
5. **creeer twee wegen**:
...
6. **Facultatief**: Voeg een andere **[!UICONTROL Reaction]** gebeurtenis **onmiddellijk na** de herinnering e-mail met onderbreking (24 uren) toe en verzend een tweede herinnering met een stimulans (b.v., 10% korting)

>[!IMPORTANT]
>
>**[!UICONTROL Reaction]** gebeurtenissen moeten onmiddellijk na [&#x200B; kanaalacties &#x200B;](journey-action.md) worden geplaatst. Plaats geen **[!UICONTROL Wait]** -activiteiten tussen de kanaalactie en de **[!UICONTROL Reaction]** -activiteit.
...
Leer meer over [&#x200B; voorwaarden &#x200B;](optimize.md#conditions) en [&#x200B; publiekskwalificatie &#x200B;](audience-qualification-events.md).
...
Leer meer over [&#x200B; het publiceren reizen &#x200B;](publish-journey.md).
...
Leer meer over [&#x200B; reisversies &#x200B;](journey-ui.md#journey-filter).
...
Leer meer over [&#x200B; beëindigende reizen &#x200B;](end-journey.md) en [&#x200B; het publiceren reizen &#x200B;](publish-journey.md).
...
* **Streaming publiekskwalificatietiming**: Voor reizen die de Kwalificatie van het Publiek met het stromen publiek gebruiken, kunnen de profielen niet ingaan als zij reeds in het publiek waren alvorens de reis werd gepubliceerd. Zij kunnen ook worden uitgesteld als de reis niet de activeringsperiode heeft voltooid (tot 10 minuten na publicatie).

Leer meer over [&#x200B; ingangsbeheer &#x200B;](entry-management.md) en [&#x200B; het stromen overwegingen van de publiekskwalificatie van de tijdbepaling &#x200B;](audience-qualification-events.md#streaming-entry-caveats).
...
Ja. Gebruik **[optimaliseer activiteit](conditions.md)** aan routeprofielen die op hun aangewezen kanaal worden gebaseerd:

1. Voeg [&#x200B; toe optimaliseer activiteit &#x200B;](optimize.md) in uw reis
...
Leer meer over [&#x200B; voorwaarden &#x200B;](conditions.md), [&#x200B; berichtacties &#x200B;](journeys-message.md), en [&#x200B; kanaalselectie &#x200B;](../channels/gs-channels.md).
...
* Voeg een [&#x200B; toe optimaliseer activiteit &#x200B;](conditions.md) vroeg in de reis om ongewenste profielen weg te gaan
...
+++ Hoe kan ik [!DNL Adobe Campaign] gebruiken bij reizen?

Journey Optimizer integreert native met [!DNL Adobe Campaign] om de geavanceerde mogelijkheden ervan te benutten:

* **[!DNL Adobe Campaign]Standaard**: Campaign Standard-handelingen gebruiken om transactiemeldingen te verzenden
* **[!DNL Adobe Campaign]v7/v8**: Trigger-workflows voor campagnes en gebruik de leveringsinfrastructuur van de campagne
...
**beleid van de Fusie** bepaalt hoe [!DNL Adobe Experience Platform] gegevens van veelvoudige bronnen combineert om een verenigde profielmening tot stand te brengen. Zij bepalen regels voor gegevens prioritering en identiteit stitching wanneer de profielfragmenten over verschillende datasets bestaan.
...
Leer meer over [&#x200B; voorwaarden &#x200B;](optimize.md#conditions) en [&#x200B; wachten activiteiten &#x200B;](wait-activity.md).
...
* Optimaliseer [&#x200B; voorwaardelogica &#x200B;](conditions.md) om verwerkingsingewikkeldheid te verminderen
...
* Bewaar vaak gebruikte gegevens in [!DNL Adobe Experience Platform] gebruikend [&#x200B; datasetraadpleging &#x200B;](dataset-lookup.md) in plaats van het doen van externe vraag, wanneer mogelijk
* Herzie en optimaliseer [&#x200B; berichtlevering &#x200B;](journey-action.md) prestaties
