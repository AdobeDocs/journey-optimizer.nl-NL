...
Deze handleiding bevat praktische instructies, voorbeelden uit de praktijk en aanbevolen procedures voor het beheer van de criteria voor het betreden en verlaten van reizen in [!DNL Adobe Journey Optimizer] .
...
* **op voorwaarde-Gebaseerde** - de uitgang van Profielen wanneer [ specifieke voorwaarden ](conditions.md), als inactiviteit over een vastgestelde periode of veranderingen in profielattributen worden voldaan.
...
Maak een gepersonaliseerde eerste indruk door nieuwe abonnees automatisch te begeleiden door een introductie van uw merk, producten en services.
...
Recapture heeft inkomsten verloren door klanten te herinneren aan objecten die ze hebben achtergelaten en door prikkels te bieden om hun aankoop te voltooien.
...
Beloon uw waardevolste klanten met exclusieve voordelen en gepersonaliseerde mededelingen die merkloyaliteit versterken en levenwaarde verhogen.
...
Verzamel inzichten over klantentevredenheid en productprestaties door terug te verzoeken op het optimale ogenblik na levering.
...
* **[gebeurtenis-Gebaseerde Trekkers](../event/about-events.md)**: De gebeurtenissen van het gebruik zoals &quot;profielverwezenlijking,&quot;uitgevoerde transactie,&quot;of douanegebeurtenissen om van een reis af te schoppen. [ vormt gebeurtenissen ](../event/about-creating.md) in **[!UICONTROL Administration]** > **[!UICONTROL Events]** en bepaalt [ gebeurtenisschema en gebieden ](../event/experience-event-schema.md). Dan voeg de gebeurtenis van het **[!UICONTROL Events]** palet in de [ reisontwerper ](using-the-journey-designer.md) toe.

* **[publiek-Gebaseerde Ingang](read-audience.md)**: De reizen van het doel aan profielen die tot specifiek publiek behoren, of als eenmalig partij of op een terugkerend programma. [ creeer publiek ](../audience/creating-a-segment-definition.md) in het **[!UICONTROL Audiences]** menu, dan voeg a **[!UICONTROL Read Audience]** activiteit toe en [ vorm het programma ](journey-properties.md#schedule). Na ingang, gebruiksvoorwaarden aan [ segment, sluit, of verenigt takken ](read-audience.md#audience-targeting-in-journeys) uit.
...
* **[Onderbreking van de Inactiviteit](wait-activity.md)**: De profielen van de uitgang als geen overeenkomst binnen een vastgestelde timeframe voorkomt. De Criteria van de uitgang van het gebruik [ met publiek dat laatste betrokkenheidsdatum controleert, plaatst ](journey-properties.md#exit-criteria) activiteiten [ met bepaalde duur wachten, en gebruik ](wait-activity.md) voorwaarden [ om op activiteit te controleren.](conditions.md)
...
>[!TIP]
>
>Doorblader alle beschikbare gebruiksgevallen in de [ bibliotheek van de gebruiksgevallen van de Reis ](jo-use-cases.md) voor meer patronen en implementaties. De voorbeelden omvatten [ opwaartse leveranties ](ramp-up-deliveries-uc.md), [ de patronen van de ervaringsgebeurtenis ](exp-event-lookup.md), en [ verwijderend profielen uit levende reizen ](journey-pause.md#apply-an-exit-criteria-in-a-paused-journey).

## Aanbevolen werkwijzen voor het beheer van toegang en vertrek {#best-practices}

**Duidelijke definitie**

Stel duidelijke documentatie en naamgevingsconventies in om ervoor te zorgen dat uw team begrijpt hoe profielen door uw reizen lopen:
...
Vermijd klantverwarring en berichtconflicten door uw reisstrategie over campagnes te coördineren:
...
Evalueer voortdurend de reisprestaties en verfijn uw entry- en exit-criteria op basis van het werkelijke gedrag van de klant:
...
Houd het vertrouwen en de betrokkenheid van klanten door berichtfrequentie over al uw reismededelingen te controleren:
...
De criteria voor het betreden en afsluiten van reizen zijn essentieel voor het bieden van persoonlijke, actuele en effectieve klantervaringen met [!DNL Adobe Journey Optimizer] . Door zorgvuldig deze voorwaarden te creëren, kunnen de marketers overeenkomst opvoeren, wrijving verminderen, en sterkere klantenverhoudingen bouwen.
...
[ het toegangsbeheer van het Profiel ](entry-management.md) | [ eigenschappen van de Reis en uitgangscriteria ](journey-properties.md) | [ hoe de reizen ](end-journey.md) beëindigen | [ Aanvullende herkenningstekens ](supplemental-identifier.md) | [ de ontwerper van de Reis ](using-the-journey-designer.md)

**Zelfstudies en voorbeelden**

[ de gebruiksgevallen van de Reis ](jo-use-cases.md) | [ Klant op het instappen video ](https://experienceleague.adobe.com/en/docs/journey-optimizer-learn/tutorials/use-cases/customer-onboarding) | [ Verlaten kartvideo ](https://experienceleague.adobe.com/en/docs/journey-optimizer-learn/tutorials/use-cases/abandoned-cart) | [ Communautaire blog: De Criteria van de Ingang en van de Uitgang ](https://experienceleaguecommunities.adobe.com/t5/journey-optimizer-blogs/mastering-journey-entry-and-exit-criteria-in-adobe-journey/ba-p/760958)

**Verwante mogelijkheden**

[ de kwalificatiegebeurtenissen van het publiek ](audience-qualification-events.md) | [ de metriek en de doelstellingen van het Succes ](success-metrics.md) | [ het beheer van het Conflict ](../conflict-prioritization/conflicts.md) | [ het in kaart brengen van de Frequentie ](../conflict-prioritization/rule-sets.md) | [ het Testen reizen ](testing-the-journey.md) | [ optimaliseert activiteit ](optimize.md) | [ gebeurtenissen van de Reactie ](reaction-events.md)[](wait-activity.md)
