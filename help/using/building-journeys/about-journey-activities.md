...
Combineer gebeurtenis, orchestratie, en actieactiviteiten om multi-stap, kanaalscenario&#39;s te bouwen.

## Gebeurtenisactiviteiten {#event-activities}

Persoonlijke reizen beginnen met gebeurtenissen zoals een online aankoop. Zodra een profiel een reis binnengaat, beweegt het zich door het op zich. Elk profiel kan een ander pad en een andere snelheid hebben. Wanneer u met een gebeurtenis begint, wordt de tocht geactiveerd wanneer de gebeurtenis aankomt. Elk profiel volgt dan de stappen die in uw reis worden bepaald.

Gebeurtenissen die door de technische gebruiker worden gevormd (zie [ deze pagina ](../event/about-events.md)) verschijnen in de eerste categorie van het palet. Deze categorie bevindt zich aan de linkerkant van het scherm. De volgende gebeurtenisactiviteiten zijn beschikbaar:
...
Orchestratieactiviteiten zijn omstandigheden die helpen de volgende stap in de reis te bepalen. Deze voorwaarden kunnen onder meer bepalen of de persoon een open ondersteuningsgeval heeft of een aankoop heeft voltooid. Ze kunnen ook rekening houden met de plaatselijke weersvoorspelling of de persoon 10.000 loyaliteitspunten heeft bereikt.
...
U kunt de categorie **[!UICONTROL Events]** vinden in het palet links op het scherm, onder **[!UICONTROL Orchestration]** en **[!UICONTROL Actions]** . De volgende activiteiten zijn beschikbaar:

* [ Ingebouwde kanaalacties ](../building-journeys/journey-action.md) beschikbaar bij de **Actie** activiteit
...
* Raadpleeg de volgende secties als u met [!DNL Adobe Campaign] en [!DNL Adobe Journey Optimizer] werkt:

   * [[!DNL Adobe Journey Optimizer] en  [!DNL Adobe Campaign]  v7/v8](../action/acc-action.md)
   * [[!DNL Adobe Journey Optimizer] en  [!DNL Adobe Campaign]  Standaard](../action/acs-action.md)
   * [[!DNL Adobe Journey Optimizer] en  [!DNL Adobe Marketo Engage]](../action/marketo-engage.md)

## Best practices {#best-practices}

Gebruik deze aanbevelingen om ritten leesbaar, verenigbaar, en gemakkelijk te houden om problemen op te lossen.
...
Zie ook [ Controle &amp; het oplossen van problemen ](../../rp_landing_pages/troubleshoot-journey-landing-page.md)
