...
1. Voeg een **[!UICONTROL Optimize]** activiteit aan de reis toe. [Meer informatie](optimize.md).

1. Stel in de activiteitsinstellingen van **[!UICONTROL Condition]** het maximumaantal ontvangers in voor uw levering:

   1. Selecteer in de instellingen voor **[!UICONTROL Optimize]** activity de methode **[!UICONTROL Conditions]** en stel het veld **[!UICONTROL Type]** in op **[!UICONTROL Profile cap]** . [Meer informatie](conditions.md#profile_cap).
