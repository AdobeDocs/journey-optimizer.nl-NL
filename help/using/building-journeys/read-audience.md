...
* **`inAudience()`voorwaarde timing:** wanneer het gebruiken van `inAudience()` in een voorwaardenknoop binnen een Reis van de Audience van het Lezen, wordt het segmentlidmaatschap gelezen van de partijprojectie van het profiel. De versheid van gegevens in deze projectie draagt SLT van tot **2 uren** na opname. Voor volledige details op scenario&#39;s van de propagatietiming, verwijs naar de [ documentatie van de functie InAudience ](functions/functioninaudience.md#propagation-timing).
