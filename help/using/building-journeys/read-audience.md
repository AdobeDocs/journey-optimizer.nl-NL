...
Gebruik de activiteit van het publiek lezen om reizen met bepaald publiek te beginnen. U kiest het publiek en wanneer het loopt; dan gebruik [ voorwaarden om, takken ](#audience-targeting-in-journeys), tijdopnemers, en acties te segmenteren, uit te sluiten of samen te voegen om de weg van elk profiel te personaliseren.
...
**Zeer belangrijke grenzen:** Één Gelezen Publiek per reis (moet de eerste activiteit zijn, of de tweede na een BedrijfsGebeurtenis); één publiek per activiteit; tot vijf gelijktijdige Gelezen looppas van de Publiek per organisatie; 20.000 profielen per seconde per zandbak; de baanonderbreking van 12 uur. De volledige details in [ Grafieken en aanbevelingen ](#must-read).
...
* Er kan slechts één **[!UICONTROL Read Audience]** -activiteit worden gebruikt tijdens een rit. Het moet de eerste activiteit in het canvas, behalve in reizen zijn die met de activiteit van de Gebeurtenis van de a **Bedrijfs** beginnen, in welk geval het de tweede activiteit is.
...
>[!TIP]
>
>Om uitgaande berichten in partijen in tijd in plaats van allen te leveren tegelijkertijd, kunt u golf vormen die in het reisprogramma verzendt. [ leer hoe te om het gebruiken golven in reizen te verzenden ](send-using-waves.md)
...
>[!NOTE]
>
>[**optimaliseert** activiteit ](optimize.md) verstrekt een alternatief voor geavanceerde weg die met inbegrip van het experimenteren en het richten van regels verplettert. Het is momenteel in Beperkte Beschikbaarheid — neem contact op met uw Adobe-vertegenwoordiger voor meer informatie.
...
Als de tellingswanverhoudingen of nul-profiel looppas na de stappen hierboven voortduurt, [ de steun van contactAdobe ](../start/user-interface.md#support-ticket-guidelines). Heb klaar: publieksnaam/identiteitskaart, reisnaam/identiteitskaart, geplande runtime(s), zandbak, en een korte beschrijving van de discrepantie (b.v. &quot;het publiek toont 10K gerealiseerde, slechts 2K ging de reis op [ datum ] binnen.)
