...
* [Gebruik van soorten publiek in omstandigheden](../building-journeys/conditions.md#using-a-segment)
...
* Als u toegang tot [[!DNL Adobe Experience Platform]  Gegevens Distiller &#x200B;](https://experienceleague.adobe.com/nl/docs/experience-platform/query/data-distiller/overview){target="_blank"} hebt, vorm geautomatiseerde vragen om de vereiste gegevens uit de gebeurtenis te halen, het te manipuleren om het gebruiksgeval te passen, en het terug naar a [&#x200B; profiel-toegelaten dataset &#x200B;](https://experienceleague.adobe.com/nl/docs/experience-platform/catalog/datasets/user-guide#enable-profile){target="_blank"} voor activering te schrijven.
