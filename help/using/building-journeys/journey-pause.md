...
| [&#x200B; optimaliseren &#x200B;](optimize.md) | Hetzelfde gedrag als tijdens een live reis |
...
| [&#x200B; Actie van het Kanaal &#x200B;](journey-action.md) | Profielen worden geparkeerd of verwijderd op basis van wat de gebruiker heeft gekozen wanneer de reis is gepauzeerd |
...
## Weergeven wanneer een reis is gepauzeerd of hervat {#view-pause-resume-info}

Om te zien wanneer een reis het laatst werd gepauzeerd of hervat, en door wie, open de reis en ga naar zijn **eigenschappen** (klik het potloodpictogram naast de reisnaam). Gebruik de **technische details van het Exemplaar** knoop om technische informatie te kopiëren die omvat:

* De datum en het tijdstip van de laatste pauze en hervat
* De weergavenaam en id van de gebruiker die de laatste pauze en de laatste hervatting heeft uitgevoerd
* Gepauzeerde instellingen voor reizen (pauzeren, maximale pauzeduur, status automatisch hervatten, pauze-id)

Deze informatie is nuttig voor het oplossen van problemen, controle, of het delen met steun. Voor de volledige lijst van gekopieerde gebieden, zie [&#x200B; Toegang tot de eigenschappen van een reis &#x200B;](journey-properties.md#access-properties).
...
Deze limiet telt het totale aantal profielen dat wordt aangehouden voor alle gepauzeerde reizen, niet voor afzonderlijke profielen. Als bijvoorbeeld dezelfde 5M-profielen in twee gepauzeerde ritten worden bewaard, wordt de limiet van 10M bereikt.
...
U kunt de [[!DNL Adobe Experience Platform]  Dienst van de Vraag &#x200B;](https://experienceleague.adobe.com/docs/experience-platform/query/api/getting-started.html?lang=nl-NL){target="_blank"} gebruiken aan de gebeurtenissen van de vraagstap, die meer informatie over profielverwerping kunnen verstrekken, afhankelijk van wanneer zij voorkwamen.
