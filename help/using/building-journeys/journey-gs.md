...
>[!TIP]
>
>Voor reizen met meerdere fasen of veel aanraakpunten kunt u overwegen de end-to-end flow te splitsen in kleinere, gerichte subreizen die verband houden met de **[!UICONTROL Jump]** -activiteit. Deze aanpak vermindert de complexiteit en maakt elke subreis gemakkelijker om onafhankelijk te testen en te onderhouden. Leer meer in [&#x200B; strategie van het Ontwerp: beetje-gerangschikte sub-reizen &#x200B;](jump.md#jump-strategy).
