...
>[!TIP]
>
>Op zoek naar praktische begeleiding met echte voorbeelden? Zie onze [&#x200B; uitvoerige gids aan de criteria van de reisingang en van de uitgang &#x200B;](entry-exit-criteria-guide.md), die gebruiksgevallen zoals welkome campagnes omvat, verlaten wortelterugwinning, en loyaliteitsprogramma&#39;s met volledige ingang en uitgangsconfiguratievoorbeelden.

## Soorten reizen {#types-of-journeys}

Met [!DNL Adobe Journey Optimizer] kunt u de volgende soorten reizen maken:
...
[Alle soorten reizen vergelijken met gebruiksgevallen →](journey.md#journey-types)
...
* **leest publiek** reizen (partijscenario, waar u een publiek van profielen richt en een reis voor dat volledige publiek teweegbrengt): het maximum is 20.000 TPS (transacties per seconde). Dit is de quota beschikbaar op het niveau van de a **zandbak**. Als er meerdere reizen tegelijk worden uitgevoerd in die sandbox, is 20.000 TPS mogelijk niet haalbaar. Beschouw dit maximum als een best-case scenario.
...
* **Bedrijfs gebeurtenis** reizen (een unitary-aan-partijscenario omdat een bedrijfsgebeurtenis altijd door een Gelezen publiek wordt gevolgd): de bedrijfsgebeurtenissen tellen naar het 5.000 TPS quotum. De activiteit van het Leespubliek die volgt heeft de zelfde grens zoals reizen die met een Gelezen publiek beginnen (20.000 TPS).
...
Tot slot **actie** de activiteiten kunnen door de profiellading worden beïnvloed die uit reizen komt en kunnen ook verwerkingstarief beïnvloeden. Deze omvatten native kanalen zoals E-mail, SMS en Push, plus aangepaste handelingen, sprongen naar andere reizen en update profielactiviteiten. Bijvoorbeeld, zal een douaneactie gericht op een extern eindpunt met een hoge reactietijd het tarief van de reisverwerking vertragen.
...
![&#x200B; Wisselen de montages van de terugkeer in reiseigenschappen &#x200B;](assets/journey-re-entrance.png)
...
![&#x200B; het beheeropties van de het gebeurtenisingang van de Zaken in reisconfiguratie &#x200B;](assets/business-entry.png)
...
* [&#x200B; vorm uitgangscriteria &#x200B;](journey-properties.md#exit-criteria) - bepaal wanneer de profielen uw reis zouden moeten verlaten
* [&#x200B; Eind een reis &#x200B;](end-journey.md) - begrijp hoe de reizen sluiten en beëindigen
* [&#x200B; de gebruiksgevallen van de Reis &#x200B;](jo-use-cases.md) - zie volledige voorbeelden met ingang en uitgangsconfiguraties
