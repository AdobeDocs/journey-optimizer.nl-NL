...
* **Steun voor Geneste Arrays in de Acties van de Douane**
  ...
  [!DNL Adobe Journey Optimizer] steunt genestelde series van voorwerpen in douaneactie **antwoordladloads**, maar deze steun is beperkt in **verzoekladloads**.
...
* [&#x200B; herhaalt over contextuele gegevens &#x200B;](../personalization/iterate-contextual-data.md#arrays-in-journeys) - leer hoe te met series in de uitdrukkingen van de Reis werken en over de reacties van de douaneactie, gebeurtenisgegevens, en datasetraadplegingen in berichtverpersoonlijking herhalen
