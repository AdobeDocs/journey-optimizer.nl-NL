...
1. Klik op de knop **[!UICONTROL Test mode]** in de rechterbovenhoek om de testmodus te activeren.
   ...
   >[!NOTE]
   >
   >Wacht na het inschakelen van de testmodus ongeveer 1-2 minuten voordat u een profielingang activeert. Dit staat het besluitvormingspakket toe om zich volledig door het besluitvormingssysteem te verspreiden. Het uitlokken van een profielingang onmiddellijk nadat de testmodus is ingeschakeld, kan ertoe leiden dat de reis af en toe mislukt.
