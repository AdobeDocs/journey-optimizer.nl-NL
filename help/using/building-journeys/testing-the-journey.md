...
>additional-url="https://experienceleague.adobe.com/nl/docs/journey-optimizer/using/orchestrate-journeys/create-journey/journey-dry-run" text="Reizen op reis"
...
Bekijk deze notities voordat u tests uitvoert op uw reis.
...
* **Vereiste Namespace** - de wijze van de Test is beschikbaar slechts voor ontwerp reizen die een namespace gebruiken. In de testmodus moet worden gecontroleerd of een persoon die de reis betreedt een testprofiel is of niet en moet dus [!DNL Adobe Experience Platform] kunnen bereiken.
...
Als voorwaarde moet u weten welke profielen als testprofielen zijn gemarkeerd in [!DNL Adobe Experience Platform] . In de testmodus zijn deze profielen alleen toegestaan tijdens de reis.
...
De testmodus maakt automatisch een Experience Event en verzendt deze naar [!DNL Adobe Experience Platform] . De naam van de bron voor deze ervaringsgebeurtenis is &quot;Journey Orchestration Test Events&quot;.
