...
|--- |--- |
| string | datumtijd in ISO-8601-indeling. Een tekenreeksrepresentatie van een datetime met tijdzonegegevens |
| string | tijdzone-id. Een tijdzone-id (bijvoorbeeld &quot;UTC&quot;, &quot;Europa/Parijs&quot;) |
| dateOnly | vertegenwoordigt een datum zonder een tijdzone, die als jaar wordt bekeken maand-dag |
| dateTimeOnly | vertegenwoordigt een datetime zonder een tijdzone, die als jaar-maand-dag-minuut-seconde-milliseconde wordt bekeken |
| integer | geheel-getalwaarde van een tijdperk in milliseconden |
...
De ISO-8601-tekenreeks bevat al tijdzonegegevens.

`toDateTime("Europe/Paris", toDateOnly("2023-08-18"))`

Keert 2023-08-18T00 :00: 00.000+02 :00 terug

Dit leidt tot een dateTime door een timezone met een datum-enige waarde te combineren. De tijd wordt geplaatst aan middernacht (00 :00: 00) in gespecificeerde timezone.

`toDateTime("UTC", toDateTimeOnly("2023-08-18T23:17:59.123"))`

Keert 2023-08-18T23 :17: 59.123Z terug

Dit leidt tot een dateTime door een timezone op een dateTimeOnly waarde toe te passen (die geen timezone informatie heeft).

`toDateTime(1560762190189)`

Keert 2019-06-17T09 :03: 10.189Z terug

Converteert een Unix-tijdstempel in milliseconden naar een dateTime-waarde.
