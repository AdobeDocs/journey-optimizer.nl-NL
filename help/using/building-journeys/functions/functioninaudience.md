...
* **vóór een Wacht activiteit (of in een Gelezen reis van het Publiek):** Journey Optimizer leest van de partijprojectie van het profiel. De gegevens in deze projectie worden verfrist binnen **2 uren** na opname. Het publiek dat op dag-gebaseerde of op tijd-gebaseerde voorwaarden steunt kan extra vertraging ervaren. Voeg een korte [&#x200B; toe wacht activiteit &#x200B;](../wait-activity.md) bij het begin van de reis, of laat buffertijd toe om het recentste segmentlidmaatschap te verzekeren wordt weerspiegeld.
