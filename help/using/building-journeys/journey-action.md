...
De **activiteit van de Actie** is het enige ingangspunt voor alle kanaalacties in het wegcanvas. Het vervangt de vorige geïntegreerde kanaalactiviteiten en consolideert e-mail, Duw, SMS, In-app, Web, Code-based ervaring, en de Kaart van de Inhoud in één verenigd activiteitstype.
