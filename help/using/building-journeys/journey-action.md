...
De **activiteit van de Actie** is het enige ingangspunt voor alle kanaalacties in het wegcanvas.

Het vervangt de vorige geïntegreerde kanaalactiviteiten en consolideert e-mail, Duw, SMS, In-app, Web, Code-based ervaring, en de Kaart van de Inhoud in één verenigd activiteitstype.

Gebruik dit om:

* Vorm om het even welke ingebouwde kanaalactie van één enkele, gestroomlijnde interface.
* Bouw multi-action binnenkomende actiegroepen.
* Pas optimalisatie toe op elke kanaalactie.
...
## Oudere kanaalactiviteiten

De inheemse kanaalactiviteiten van de erfenis (E-mail, Duw, SMS, In-app, Web, op code-gebaseerde ervaring, en de Kaart van de Inhoud) zijn verouderd vanaf de versie van Maart 2026 **.**

Bestaande reizen die gebruikmaken van deze activiteiten blijven zonder wijzigingen werken; er is geen migratie vereist.

Ook in deze gevallen blijven activiteiten met betrekking tot oude native kanalen behouden:

* **dupliceer een reis** — De gedupliceerde reis blijft erfenisactiviteiten gebruiken. U kunt de migratie naar wens bewerken en publiceren. Er is geen migratie vereist.
* **creeer een nieuwe reisversie** - de nieuwe versie blijft erfenisactiviteiten gebruiken. U kunt de migratie naar wens bewerken en publiceren. Er is geen migratie vereist.
* **Kopieer en plak erfenisactiviteiten in een reis** — Gedekte activiteiten blijven erfenisactiviteiten. U kunt deze bestanden op de huidige manier bewerken en publiceren. Er is geen migratie vereist.
