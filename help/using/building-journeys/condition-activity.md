...
U kunt een voorwaarde ook baseren op het lidmaatschap van een publiek. Zie deze secties:

* [&#x200B; Gebruik een publiek in een voorwaarde &#x200B;](#using-a-segment) - voeg wegen toe die op worden gebaseerd of de profielen tot een publiek behoren.
* [&#x200B; bouwt en doelpubliek &#x200B;](../audience/about-audiences.md) - creeer en beheer publiek in het menu van het Publiek.
* [&#x200B; publiek richtend in reizen &#x200B;](read-audience.md#audience-targeting-in-journeys) - na een Gelezen activiteit van het Publiek, sluit, of verenigt takken gebruikend voorwaarden uit.
