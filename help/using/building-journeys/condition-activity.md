...
Gebruik de voorwaardenactiviteit aan routeprofielen aan verschillende wegen die op regels en gegevens worden gebaseerd.
...
U kunt het publiek ook rechtstreeks in reisomstandigheden gebruiken. Zie:

* [&#x200B; Gebruikend een publiek in een voorwaarde &#x200B;](#using-a-segment) — filter die de profielen een bepaalde weg nemen die op publiekslidmaatschap wordt gebaseerd
* [&#x200B; bouwt en beheert publiek &#x200B;](../audience/about-audiences.md) — leer hoe te om, publiek in [!DNL Adobe Experience Platform] tot stand te brengen te evalueren en te richten
* [&#x200B; Publiek richtend patronen in reizen &#x200B;](read-audience.md#audience-targeting-in-journeys) - segment, sluit, of verenigt publiekstakken na een Gelezen ingang van de Publiek uit
...
Met de geavanceerde expressieeditor kunt u geavanceerdere voorwaarden instellen voor het manipuleren van verzamelingen of het gebruik van gegevensbronnen waarvoor parameters moeten worden doorgegeven. [Meer info](../datasource/external-data-sources.md).
