...
>[!CAUTION]
>
>Als u een reis wilt stoppen, hebt u **[!DNL Manage journeys]** toestemming nodig. Als de reis gealigneerde campagnes of overseinenknopen omvat, hebben de gebruikers ook **Campagnes > publiceer campagnes** toestemmingen nodig. Als tijdens de rit elementen worden gebruikt (bijvoorbeeld in e-mails), moeten gebruikers toegang hebben tot deze mappen met middelen. Leer meer over het beheren van [!DNL Journey Optimizer] de toegangsrechten van gebruikers in [&#x200B; deze sectie &#x200B;](../administration/permissions-overview.md).
