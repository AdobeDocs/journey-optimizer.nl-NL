...
In deze sectie vindt u een verzameling praktijkvoorbeelden om u te helpen het beste uit [!DNL Adobe Journey Optimizer] te halen. Of u tactische patronen-als suppressielogica zoekt, verpersoonlijkingstechnieken, of reis uitgangsstrategieën-of volledige scenario&#39;s van begin tot eind die marketing en technische werkschema&#39;s behandelen, zult u hieronder verbindingen aan relevante steekproeven vinden.
...
<tr style="border: 0;">
  <td>
    ...
    <br> Leer gemeenschappelijke patronen en scalable benaderingen om u te helpen van de Gebeurtenissen van de Ervaring in [!DNL Adobe Journey Optimizer] het beste maken. Deze gebruiksgevallen zijn ontworpen om u te helpen veelvoorkomende uitdagingen op te lossen, zoals het beheren van opt-outs, het controleren van berichtfrequentie, het personaliseren van inhoud die op gebruikersgedrag wordt gebaseerd, en het reageren op signalen in real time.
    </div>
      <div>
...
<img alt="E-mails alleen verzenden tijdens weekdagen" src="../assets/do-not-localize/icon-first-journey.svg">
</a>
<div>
<a href="weekday-email-uc.md"><strong> verzend e-mails slechts op weekdagen </strong></a>
</div>
<p>
</td>
<td></td>
...
Blader naar videozelfstudies om belangrijke stappen te leren om veelgebruikte gebruiksscenario&#39;s samen te stellen met [!DNL Adobe Journey Optimizer] .
