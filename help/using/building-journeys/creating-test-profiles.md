...
1. In de **sectie van de Groepen van het Gebied**, op de linkerzijde, klik **Add$ en selecteer de aangewezen gebiedsgroepen. Zorg ervoor u de **de testdetails van het Profiel** gebiedsgroep toevoegt.
