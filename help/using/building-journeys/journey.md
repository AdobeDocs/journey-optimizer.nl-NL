...
description: Ga aan de slag met reizen - Leer over reistypes, werkschema, mogelijkheden, en beste praktijken voor het creëren van gepersonaliseerde klantenervaringen in  [!DNL Adobe Journey Optimizer]
...
[!DNL Adobe Journey Optimizer] biedt drie benaderingen aan om klanten te bereiken: **Reizen** (1 :1 in real time orchestratie), **Campagnes** (eenvoudige partij of API-teweeggebrachte levering), en **Geordende campagnes** (de werkschema&#39;s van het partijcanvas met multi-entiteitgegevens).

**Snelle beslissing:**

* Gebruik **Reizen** voor multi-stap, gedrag-gedreven ervaringen waar elke klant bij hun eigen tempo vordert
* De Actie van het gebruik **en API-teweeggebrachte campagnes** voor eenvoudige, geplande of teweeggebrachte berichtlevering aan publiek
* Het gebruik **Orchestrated campagnes** voor complexe partijwerkschema&#39;s die multi-entiteitsegmentatie en nauwkeurige pre-verzendt tellingen vereisen
...
[!DNL Adobe Journey Optimizer] ondersteunt vier soorten reizen, elk ontworpen voor verschillende entry-mechanismen en bedrijfsscenario&#39;s:
...
[Gebruiksvoorwaarden](conditions.md)
:::
...
Gebruik contextuele gegevens van gebeurtenissen, [!DNL Adobe Experience Platform] of externe API-services.
...
[&#x200B; doorblader allen → &#x200B;](jo-use-cases.md) | [&#x200B; de gevallenbibliotheek van het Gebruik → &#x200B;](../../rp_landing_pages/journey-use-cases-landing-page.md)
:::
...
[Alle reismogelijkheden weergeven →](../../rp_landing_pages/manage-journey-landing-page.md)
...
[!DNL Adobe Journey Optimizer] biedt drie mogelijkheden:
...
* **Geordende campagnes**: De multi-step partijwerkschema&#39;s met complexe segmentatie die relationele gegevens gebruiken (profielen + producten/opslag/boekingen). Alle profielen die samen met nauwkeurige aantallen pre-send worden verwerkt. Het beste voor seizoensgebonden promoties, productlanceringen, campagnes die gegevens van meerdere entiteiten vereisen.

**Zeer belangrijk verschil**: De reizen handhaven individuele klantenstaat voor acties in real time; De actie en API-teweeggebrachte campagnes leveren eenvoudige berichten in partij; De geordende campagnes verstrekken het canvas van het partijwerkschema van multi-entiteitsegmenteringsmogelijkheden.
...
Gebruik deze verbindingen om begeleiding, het oplossen van problemen, en middelen te vinden.
...
* **[het Oplossen van problemen](../../rp_landing_pages/troubleshoot-journey-landing-page.md)** - onderzoekt en bevestigt kwesties
...
* **[hub van het het beheersbeleid van de Reis](../../rp_landing_pages/manage-journey-landing-page.md)** - Hulpmiddelen voor het filtreren, optimalisering, en profielbeheer
* **[de activiteitenverwijzing van de Reis](../../rp_landing_pages/about-journey-building-landing-page.md)** - Volledige gids aan alle activiteitentypes
