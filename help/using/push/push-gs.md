...
1. Het eerder gegenereerde pushtoken wordt doorgegeven aan Adobe Experience Platform en gesynchroniseerd met het Real-time klantprofiel. Dit gebeurt OOTB met een eenvoudig te integreren client-SDK
   ...
   >[!NOTE]
   >
   >Tokenverwerking verschilt per platform. Op **Android (FCM)**, worden de tekenen automatisch duidelijk als ongeldig wanneer de gebruikers toepassingsgeheime voorgeheugen ontruimen of app opnieuw installeren, die een nieuw teken en ECID produceren. Op **iOS (APNs)**, worden de tekenen niet constant duidelijk zoals ongeldig in deze scenario&#39;s. Als een profiel meerdere ECID&#39;s met geldige tokens bevat, worden pushmeldingen verzonden naar alle gekoppelde apparaten.
