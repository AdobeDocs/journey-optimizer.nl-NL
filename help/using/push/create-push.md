...
U kunt pushmeldingen maken voor mobiele apparaten (iOS en Android). Deze pagina begeleidt u door het proces om een pushmelding in een reis of campagne op te zetten.
...
1. Kies in de sectie **[!UICONTROL Actions]** de **[!UICONTROL Push notification]** en selecteer of maak een nieuwe configuratie.
   ...
   Leer meer over de configuratie van de Duw voor mobiel op [&#x200B; deze pagina &#x200B;](push-configuration.md).
