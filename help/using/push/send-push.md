...
Klik hiertoe op **[!UICONTROL Simulate content]** . Vervolgens kunt u het type apparaat selecteren dat u wilt voorvertonen met inhoud: **[!UICONTROL iOS]**, **[!UICONTROL Android]** of **[!UICONTROL Web]** .
...
* [Pushkanaal configureren voor web](push-configuration-web.md)
