...
## Vereisten {#genstudio-prerequisites}

Als u de [!DNL GenStudio for Performance Marketing] integratie met [!DNL Journey Optimizer] wilt gebruiken, moet u aan de volgende vereisten voldoen:

* Uw organisatie moet een actieve licentie voor [!DNL GenStudio for Performance Marketing] hebben.
...
## GenStudio-mogelijkheden in Journey Optimizer benutten {#use-genstudio}
...
### Belangrijkste mogelijkheden {#genstudio-capabilities}

Deze integratie ontgrendelt krachtige mogelijkheden voor uw marketingorganisatie:

* **op AI-Gerichte inhoudsgeneratie**: Hefboomwerking generatieve AI van Adobe om veelvoudige online e-mailvariaties efficiënt tot stand te brengen, met intelligente exemplaarsuggesties en ontwerpelementen.

* **naadloze werkschemaintegratie**: De malplaatjes van de uitvoer Journey Optimizer e-mail naar GenStudio, creeer variaties met AI herinneringen, en voer hen terug in Journey Optimizer in een gestroomlijnd proces in.

* **Gecentraliseerd activabeheer**: Toegang GenStudio ContentHub, aangedreven door Adobe Experience Manager Assets, om alle digitale activa in één gecentraliseerde plaats te organiseren, op te slaan en terug te winnen.

* **Inhoud experimenteren**: De veelvoudige de e-mailvariaties van GenStudio van de invoer in Journey Optimizer en hefboomwerking experimenteringsmogelijkheden om de best-presterende inhoud te testen en te identificeren.

* **Prestatie-gedreven inzichten**: De campagneprestaties van het spoor met AI-Aangedreven analyses om te begrijpen welke creatieve elementen met uw publiek resoneren en toekomstige campagnes optimaliseren.

### Vaak voorkomende gebruiksscenario&#39;s {#genstudio-use-cases}

De integratie tussen [!DNL GenStudio for Performance Marketing] en [!DNL
Journey Optimizer ] steunt diverse marketing scenario&#39;s:
...
* **Vakantie en seizoensgebonden bevorderingen**: Produceer tijd-gevoelige campagneinhoud op schaal gebruikend de malplaatjes van GenStudio, die merkconsistentie terwijl het ontmoeten van strakke termijnen verzekeren.

* **A/B het testen bij schaal**: Creeer talrijke inhoudsvariaties in GenStudio en test hen systematisch in Journey Optimizer om e-mailprestaties onophoudelijk te verbeteren.

* **Multi-segment verpersoonlijking**: produceer op maat gemaakte inhoud voor verschillende klantenpersoonlijkheden in GenStudio, dan stel elke variatie aan zijn overeenkomstig segment in Journey Optimizer voor maximumrelevantie op.

## De GenStudio-integratie gebruiken {#how-to-use}

De integratieworkflow bestaat uit twee hoofdstappen: het exporteren van een sjabloon van Journey Optimizer naar GenStudio en het importeren van GenStudio-ervaringen naar Journey Optimizer.
...
Zoek antwoorden op veelgestelde vragen over de [!DNL GenStudio for Performance Marketing] integratie met [!DNL Journey Optimizer] .

+++Kan ik de GenStudio-integratie gebruiken voor andere kanalen dan e-mail?

De integratie met [!DNL GenStudio for Performance Marketing] is momenteel alleen beschikbaar voor het e-mailkanaal. Ondersteuning voor extra kanalen kan in toekomstige releases worden toegevoegd.
+++

+++Is de integratie van GenStudio beschikbaar voor alle klanten van Journey Optimizer?

De integratie is momenteel niet beschikbaar voor organisaties die het **gebruiken van het Schild van de Gezondheidszorg of** de Invoegsel van de Privacy en van het Schild van de Veiligheid **.**
+++
...
GenStudio gebruikt merkcontroles door AI om ervoor te zorgen dat alle gegenereerde inhoud voldoet aan uw merkstandaarden en -richtlijnen. Wanneer u sjablonen uploadt die uw merkelementen bevatten, past GenStudio deze standaarden toe op alle variaties in inhoud die binnen het platform worden gemaakt.
+++

+++Kan ik met andere teamleden samenwerken op GenStudio-ervaringen?

Ja, GenStudio is ontworpen voor samenwerking. Meerdere teamleden met de juiste machtigingen kunnen samenwerken aan het maken en verfijnen van e-mailervaringen voordat ze deze importeren in [!DNL Journey Optimizer] .
+++
