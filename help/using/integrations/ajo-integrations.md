...
>[!NOTE]
>
> Voortgebouwd op Adobe Experience Platform, wordt Adobe Journey Optimizer native verbonden met [&#x200B; Adobe Real-time het Profiel van de Klant &#x200B;](https://experienceleague.adobe.com/docs/experience-platform/profile/home.html?lang=nl){target="_blank"}. Deze ingebouwde gegevensbron is vooraf geconfigureerd en is ontworpen om gegevens op te halen en te gebruiken uit het Real-time profiel van de Klant (bijvoorbeeld, controleer of de persoon die een reis is aangegaan een klant is of niet). Hiermee kunt u profielgegevens gebruiken. [Meer info](../datasource/adobe-experience-platform-data-source.md).
...
[![&#x200B; leer meer &#x200B;](../assets/do-not-localize/learn-more-button.svg)](aem-fragments.md)
...
Een overzicht van de belangrijkste stap van deze integratie is beschikbaar [&#x200B; in dit blogbericht &#x200B;](https://experienceleaguecommunities.adobe.com/t5/journey-optimizer-blogs/accelerating-go-to-market-how-workfront-workfront-fusion-aep-and/ba-p/653685?profile.language=nl){target="_blank"}.
