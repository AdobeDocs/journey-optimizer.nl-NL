...
Met het productprofiel **[!UICONTROL Journey Approver]** kunnen gebruikers leveringen goedkeuren en publiceren. Zij kunnen later het succes van hun leveringen controleren met **[!UICONTROL Message]** en **[!UICONTROL Journey]** rapporten.
...
Met het productprofiel **[!UICONTROL Journey Manager]** kunnen gebruikers **[!UICONTROL Journeys]** maken en bewerken en elke mogelijkheid die aan **[!UICONTROL Journeys]** is gekoppeld, maar kunnen deze niet publiceren.
...
Met het productprofiel **[!UICONTROL Journey viewer]** hebt u alleen-lezentoegang tot de mogelijkheden **[!UICONTROL Journeys]**, **[!UICONTROL Goals]**, **[!UICONTROL Messages]** en **[!UICONTROL Decision management]**.
