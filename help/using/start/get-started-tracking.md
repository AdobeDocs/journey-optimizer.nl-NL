...
Begrijpen hoe de klanten met uw mededelingen in wisselwerking staan is zeer belangrijk aan het creëren van zinvolle ervaringen en het drijven resultaten. Journey Optimizer biedt uitgebreide mogelijkheden voor bijhouden en controleren die u inzicht geven in het gedrag van klanten, de prestaties van de levering en de systeemstatus. Dit alles met eerbiediging van de privacy en het behoud van de naleving.

>[!BEGINSHADEBOX]

**wat u in Journey Optimizer kunt volgen:**
...
### Push notification tracking {#push-tracking}
...
### In-app berichten bijhouden {#inapp-tracking}
...
### SMS en MMS bijhouden {#sms-tracking}
...
### Op code gebaseerde ervaring bijhouden {#code-based-tracking}
...
### Tekstspatiëring van inhoudskaarten {#content-card-tracking}
...
## Uw openingspagina&#39;s controleren {#landing-page-tracking}
...
## Optimalisatieprestaties beheren {#optimization-tracking}

Journey Optimizer volgt automatisch optimalisatieexperimenten en doelgerichte strategieën. Configureer uw optimalisaties voor een correcte gegevensverzameling.
...
**Vereisten voor code-gebaseerd het volgen:**

Als u beslissingen in op code gebaseerde ervaringen wilt bijhouden, moet u ervoor zorgen dat uw implementatie interactiegebeurtenissen (weergaven en klikken) naar Adobe Experience Platform verzendt met gebruik van Web SDK of Mobile SDK. [Meer informatie](../experience-decisioning/gs-experience-decisioning.md)
...
## Volgende stappen: toegang tot uw volgende gegevens {#access-tracking-data}

Zodra het volgen wordt gevormd, kunt u tot uw gegevens door ingebouwde het melden van Journey Optimizer mogelijkheden toegang hebben:

* **Realtime controle** - bekijk levende metriek als reizen en campagnes voeren uit om kwesties snel te identificeren
* **Historische analyse** - analyseer het verleden prestaties om tendensen te begrijpen en toekomstige campagnes te optimaliseren
* **Geavanceerde analyses** - verbind met Customer Journey Analytics voor verfijnde dwars-kanaalanalyse en attributiemodellering

[ worden begonnen met het melden ](../reports/gs-reports.md) | [ Leer over de integratie van Customer Journey Analytics ](../reports/cja-ajo.md)

## Belangrijke onderwerpen verkennen {#explore-topics}
