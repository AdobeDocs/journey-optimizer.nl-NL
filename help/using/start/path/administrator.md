...
* **[Berichten van het Product](../../rn/releases.md#staying-informed)**: Leer hoe te aan e-mail en in-productalarm voor updates van Journey Optimizer, met inbegrip van systeemonderhoud, veiligheidsupdates, en kritieke productaankondigingen in te schrijven. Als beheerder moet u alle kritieke systeemmeldingen inschakelen
