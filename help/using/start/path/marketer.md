...
Journey Optimizer brengt realtime klantinzichten, moderne omnichannel orchestratie en intelligente besluitvorming samen in één toepassing. Maak persoonlijke, verbonden klantervaringen via e-mail, SMS, push, web push, in-app, web, direct mail, inhoudskaarten en nog veel meer.
...
Het werk met uw [&#x200B; Beheerders &#x200B;](administrator.md) om toegang en met [&#x200B; Ingenieurs van Gegevens &#x200B;](data-engineer.md) aan opstellingspubliek, gegevens, en relationele schema&#39;s voor geavanceerde segmentatie te verkrijgen. Zie [&#x200B; begonnen worden met gegevensbeheer &#x200B;](../../data/gs-data.md) overzicht om te begrijpen welke gegevensopstelling nodig is alvorens u reizen en campagnes kunt bouwen.
...
1. **inhoud van het Ontwerp**. Maak aansprekende berichten via alle kanalen, waaronder e-mail, SMS, push, webpush, in-app, web, direct mail en inhoudskaarten:
...
1. **voeg aanbiedingen en besluit** toe. Lever de beste aanbieding aan elke klant op het juiste ogenblik gebruikend AI-GEDreven besluit. Met Beslissing kunt u push-, SMS- en andere kanalen personaliseren. Leer over [&#x200B; Beheer van het Besluit &#x200B;](../../offers/get-started/starting-offer-decisioning.md) en [&#x200B; Beslissing &#x200B;](../../experience-decisioning/gs-experience-decisioning.md).
...
1. **bouwt klantenreizen**. Maak real-time, persoonlijke ervaringen met het canvas van de reis. Het gebruik **Journey Agent** in AI Medewerker om reizen van natuurlijke taalherinneringen tot stand te brengen. [&#x200B; Leer over Journey Agent &#x200B;](../ai-features.md#journey-agent)
   ...
   * Gebruik de verenigde **activiteit van de Actie** voor alle kanaalacties (e-mail, duw, SMS, en meer). [&#x200B; leer over de activiteit van de Actie &#x200B;](../../building-journeys/journey-action.md)
   * Voeg de **het besluitvormingsactiviteit van de Inhoud** toe om gepersonaliseerde aanbiedingen direct in uw reisstroom te integreren. [&#x200B; Leer over de activiteit van het inhoudsbesluit &#x200B;](../../building-journeys/content-decision.md)
   ...
   * Gebruik **golf die** verzendt om berichten in gecontroleerde partijen (Beperkte Beschikbaarheid voor reizen) te leveren
...
1. **Lancering orchestrated campagnes**. Ontwerp complexe, uit meerdere stappen bestaande batchcampagnes op schaal met een visueel canvas:
   ...
   * Het gebruik **golf die** verzendt om berichten in gecontroleerde partijen voor betere leverbaarheid en ladingscontrole te leveren
...
1. **Monitor en optimaliseer**. Prestaties bijhouden en resultaten in de loop der tijd verbeteren:
   ...
   * Beheer **berichtfrequentie en prioritering** met de regels van het conflictbeheer om overmededeling te verhinderen
   * Het gebruik **stille uren** (op tijd-gebaseerde uitsluitingen) om het verzenden tijdens specifieke periodes te vermijden. [&#x200B; Leer over conflictbeheer &#x200B;](../../conflict-prioritization/gs-conflict-prioritization.md) en [&#x200B; stille uren &#x200B;](../../conflict-prioritization/quiet-hours.md)
...
3. **sluit zich aan bij de gemeenschap**: Verbind met andere gebruikers van Journey Optimizer in de [&#x200B; Gemeenschap van Experience League &#x200B;](https://experienceleaguecommunities.adobe.com/t5/journey-optimizer/ct-p/journey-optimizer?profile.language=nl){target="_blank"}
