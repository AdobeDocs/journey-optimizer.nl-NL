...
1. **Werk met actieconfiguraties**: Uw [&#x200B; Beheerder &#x200B;](administrator.md) of [&#x200B; Ingenieur van Gegevens &#x200B;](data-engineer.md) zal de douaneactie in Journey Optimizer vormen, bepalend het API eindpunt URL, authentificatiemethode, en parameters. U geeft hen uw API-specificatie. Leer over [&#x200B; configuratie van de douaneactie &#x200B;](../../action/about-custom-action-configuration.md). U kunt een facultatieve **lading van de foutenreactie van de foutenreactie** voor rijkere reservelogica in onderbrekings/foutentakken bepalen.
...
1. **gezondheid van de douaneactie van de Monitor**: Gebruik het dashboard van de douaneactie om succesvolle vraag, fouten, productie, reactietijden, en rij wachttijden te volgen. Leer over [&#x200B; douaneactie die &#x200B;](../../action/reporting.md) rapporteert.
...
1. **De migratie APIs van de Beslissing**: Migreer de entiteiten van het Beslissingsbeheer programmatisch aan Beslissing met flexibele werkingsgebied, geautomatiseerde bevestiging, en terugdraaisteun. Leer meer in de [&#x200B; gids van de migratie API van de Beslissing &#x200B;](../../experience-decisioning/decisioning-migration-api.md).

1. **Webhooks van SMS**: Vorm binnenkomende webhooks om inkomende berichten te vangen en koppelt webhooks terug om leveringsontvangstbewijzen en statusupdates te ontvangen. [Meer info](../../sms/sms-webhook.md).
