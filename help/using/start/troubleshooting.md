...
# Veelgestelde vragen over probleemoplossing {#ajo-troubleshooting}
...
Wanneer u contact opneemt met Adobe-ondersteuning voor onopgeloste problemen, neemt u de omgevingsdetails, het effectniveau, replicatiestappen, logbestanden of screenshots en relevante id&#39;s op. [&#x200B; leer wat in steunkaartjes &#x200B;](user-interface.md#support-ticket-guidelines) te omvatten.
...
**toe te laten Profielen** metrisch wijst op het aantal unieke profielen die door reizen of campagnes in de afgelopen 12 maanden worden betrokken. Een plotselinge toename kan het gevolg zijn van reizen of campagnes gericht op grote doelgroepen die onlangs niet zijn betrokken, of van veranderingen in datasets die voor de Dienst van het Profiel worden toegelaten.

Om dit probleem te onderzoeken en op te lossen, moet u de logica voor het tellen van profielen begrijpen, reizen en campagnes onderzoeken gericht op grote doelgroepen, adequaat filteren publiek, veranderingen van gegevensreeksen controleren, en potentieel uw adresseerbare publieksgrootte verminderen.

Leer hoe te om toe te laten verhogingen problemen op te lossen en op te lossen van Profielen en het de vergunningsgebruik van uw organisatie in de [&#x200B; documentatie van het Dashboard van het Gebruik van de Vergunning &#x200B;](../audience/license-usage.md#troubleshooting-engageable-profiles) te controleren.
