...
* **Testprofielen maken** om testprofielen te maken met onze CSV-sjabloon om persoonlijke berichten en reizen te testen. Leer hoe u deze gebruiksaanwijzing implementeert [op deze pagina](../audience/creating-test-profiles.md#use-case-1).
