...
**Uiteinde:** De nieuwe gebruikers kunnen van de **3&rbrace; pagina beginnen van het Huis &lbrace;om tot recente punten toegang te hebben en gevallen te gebruiken, of het** pictogram van de Hulp **in de hoogste bar voor contextuele begeleiding te gebruiken.**

## Functies in de bovenste balk {#top-bar}

### Universeel zoeken {#universal-search}

Met het zoekpictogram kunt u snel reizen, campagnes, middelen en andere objecten zoeken in Journey Optimizer. Typ trefwoorden om relevante resultaten van alle platformen te zien. [&#x200B; leer meer over universeel onderzoek &#x200B;](search-filter-categorize.md#unified-search).
...
* **de details van het Milieu** - Naam van Sandbox, organisatie identiteitskaart, en productgebied (b.v., Reizen, Campagnes, Beslissing)
* **niveau van de Gevolgen** - Ernst van de kwestie (b.v., geblokkeerde productie, beperkte functionaliteit, cosmetisch)
* **stappen van de Replicatie** - Duidelijk, geleidelijke instructies om de kwestie te reproduceren
...
| Connecties | Bronnen en bestemmingen |
...
* **Kanalen** - vorm kanaalmontages en leverbaarheid. [&#x200B; de configuraties van het opstellingskanaal &#x200B;](../configuration/channel-surfaces.md) | [&#x200B; begonnen met configuratie &#x200B;](../configuration/get-started-configuration.md)
...
>abstract="Splitsen, combineren, verrijken en manipuleren van relationele gegevenssets om uw publiek te definiëren"



>[!CONTEXTUALHELP]
>id="ajo_oc_campaign_ovv_2"
>title="Gegevens van meerdere entiteiten benutten"
>abstract="Leer hoe de Geordende campagnes uit relationele datasets kunnen voordeel halen om gegevens voor segmentatie &amp; verpersoonlijking te verrijken"



>[!CONTEXTUALHELP]
>id="ajo_oc_campaign_ovv_3"
>title="Ad-hocsegmentatie en exacte aantallen"
>abstract="Bouw uw segment stap voor stap met nauwkeurige tellingen"
...
>abstract="De Incrementele vraag is een het richten activiteit die een gegevensbestandvraag in werking stelt telkens als de Geordende campagnelooppas. Het keert slechts nieuwe verslagen terug en sluit iedereen uit die reeds in een vorige looppas inbegrepen was, zodat vermijd u het opnieuw richten van de zelfde mensen of het opnieuw uitvoeren van de zelfde rijen."

>[!CONTEXTUALHELP]
>id="ajo_orchestration_incrementalquery_processeddata"
>title="Verwerkte gegevens"
>abstract="Kies onder Verwerkte gegevens hoe u records van eerdere uitvoeringen wilt uitsluiten. Met de resultaten van vorige uitvoering uitsluiten, houdt de activiteit een lijst van verslagen bij die in vroegere looppas zijn teruggekeerd; elke looppas sluit die uit en keert slechts nieuwe degenen terug. Met de optie Een datumveld gebruiken gebruikt de activiteit een geselecteerd datumveld in plaats van individuele id&#39;s te volgen, en elke run retourneert alleen rijen waarvan de datum na de laatste uitvoering valt."

>[!CONTEXTUALHELP]
>id="ajo_orchestration_incrementalquery_history"
>title="Geschiedenis in dagen"
>abstract="Met deze instelling bepaalt u hoe lang de lijst wordt bewaard. Een waarde van 0 betekent een onbepaalde retentie; er worden geen records verwijderd."
