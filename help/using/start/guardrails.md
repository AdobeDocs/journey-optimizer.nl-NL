...
* Bij het invoeren van gegevens zijn e-mails hoofdlettergevoelig. Dit betekent dat dubbele profielen kunnen worden gemaakt (bijvoorbeeld één profiel voor John.Greene@luma.com, een ander profiel voor john.green@luma.com) en kunnen worden gebruikt wanneer u deze profielen gebruikt voor uw [!DNL Journey Optimizer] -reizen en -campagnes.
