...
Hieronder vindt u instructies en beperkingen bij het gebruik van [!DNL Adobe Journey Optimizer] .
...
## Systeem en platform {#system-platform}
...
## Kanalen en berichten {#channel-guardrails}

In deze sectie worden instructies beschreven voor alle communicatiekanalen, waaronder e-mail, SMS, inkomende kanalen (web, in-app, op code gebaseerd, inhoudskaarten) en transactionele berichten.
...
* Journey Optimizer ondersteunt een piekvolume van 5.000 binnenkomende verzoeken per seconde. Deze graadlijn is op alle binnenkomende verzoeken van toepassing, die uit om het even welke Journey Optimizer gesteunde binnenkomende kanalen ([&#x200B; Web &#x200B;](../web/get-started-web.md), [&#x200B; In-app &#x200B;](../in-app/get-started-in-app.md), [&#x200B; code-gebaseerde ervaringen &#x200B;](../code-based/get-started-code-based.md), [&#x200B; inhoudskaarten &#x200B;](../../rp_landing_pages/content-card-landing-page.md)) kunnen voortkomen.
  ...
  Binnenkomende Journey Optimizer-kanalen zijn gericht op nieuwe profielen die mogelijk nog niet eerder zijn ingeschakeld op andere kanalen. Dit zal uw totaal [&#x200B; toe te laten &#x200B;](../audience/license-usage.md) telling van Profielen verhogen, die kostenimplicaties kan hebben als het contractuele aantal Ingageable Profielen u kocht wordt overschreden.

  De metriek van de vergunning voor elk pakket is vermeld op de [&#x200B; pagina van de Beschrijving van het Product van Journey Optimizer &#x200B;](https://helpx.adobe.com/nl/legal/product-descriptions/adobe-journey-optimizer.html){target="_blank"}. U kunt het aantal toe te laten Profielen in het [&#x200B; dashboard van het vergunningsgebruik &#x200B;](../audience/license-usage.md) controleren.
...
## Inhoud en Assets {#content-assets}

Deze sectie behandelt instructies voor het maken en beheren van inhoud, inclusief bestemmingspagina&#39;s, subdomeinen en fragmenten.
...
## Soorten publiek en profielen {#audiences-profiles}

In deze sectie worden instructies beschreven voor het beheren van het publiek, het hanteren van profielen en het maken van inzetbare profielen.
...
In de afdelingen Beslissingen en Besluitbeheer worden de volgende informatie gegeven:
...
Deze sectie behandelt trajecten en beperkingen voor reizen, met inbegrip van algemene reisbeperkingen, reisonderdelen (acties, evenementen, gegevensbronnen), reisactiviteiten en specifieke kenmerken, zoals aangepaste acties en expressies-editors.
...
* Voor elk profiel en elke reisversie, houdt runtime een interne rij van maximaal 10 hangende gebeurtenissen terwijl één wordt verwerkt. Als deze limiet is bereikt, worden extra gebeurtenissen met de reden `maxInstanceStackEventsReached` genegeerd totdat de stapel is leeggemaakt. Zie [&#x200B; Verworpen gebeurtenissen met maxInstanceStackEventsReached &#x200B;](../building-journeys/troubleshooting-execution.md#max-instance-stack-events-reached).
...
#### Validatie van de payload op reis {#journey-payload-size}

Wanneer u een reis bewaart of publiceert, bevestigt Journey Optimizer de totale grootte van de reislading om stabiliteit en prestaties te bewaren.

**Standaardconfiguratie**

* **Standaard maximumverzoekgrootte**: 2 MB (2.000.000 bytes). Sommige organisaties hebben aangepaste limieten die door Adobe zijn geconfigureerd.
* **drempel van de Waarschuwing**: 90% van de maximumgrens.
* **drempel van de Fout**: 100% van de maximumgrens. Het bewaren of het publiceren wordt geblokkeerd en het verzoek keert **HTTP 413 de Te Grote Entiteit van het Verzoek** terug.

**de ervaringsscenario&#39;s van de Gebruiker**

* **nuttige lading &lt; 90% van grens**: De reis bewaart en publiceert met succes. Er worden geen waarschuwingen of fouten weergegeven.
* **nuttige lading 90-99% van grens**: De reis bewaart en publiceert met succes, met een waarschuwing om te optimaliseren. Het bericht van de waarschuwing: **Waarschuwing**: De grootte van de ladingslading van de reis is dicht bij de grens. De grootste knoop: &quot;[ NodeName ]&quot; (type: [ NodeType ]&#39;, grootte: [ N ] bytes).
* **nuttige lading >= 100% van grens**: De reis sparen of publiceert wordt geblokkeerd met een fout. Het bericht van de fout: **Fout**: De grootte van de ladingslading van de reis overschrijdt grens. De grootste knoop: &quot;[ NodeName ]&quot; (type: [ NodeType ]&#39;, grootte: [ N ] bytes).

**de reactiedetails van de Fout**

Als het verzoek de maximum toegestane grootte overschrijdt, omvat de reactie **Te Grote Entiteit van het Verzoek**. De lading van de reis overschrijdt de maximaal toegestane grootte. Bekijk de foutdetails en optimaliseer uw reis.

**het Oplossen van problemen en aanbevelingen**

* Controleer het grootste knooppunt dat in de waarschuwing of fout is gemarkeerd.
* Vereenvoudig voorwaarden, verminder gegevenstoewijzingen en verwijder overbodige stappen of parameters.
* Overweeg de reis zo nodig op te splitsen in kleinere ritten.
* Neem contact op met uw Adobe-vertegenwoordiger als u van mening bent dat uw organisatie een hogere limiet nodig heeft.

### Pakketbeperkingen selecteren voor reizen per eenheid {#select-package-limitations}

>[!NOTE]
>
>Deze beperkingen zijn niet op Gelezen de reizen van het Publiek of van de BedrijfsGebeurtenis met het **Uitgezochte** pakket van toepassing. Als u complexere reislogica met veelvoudige acties, voorwaarden, of wachtende activiteiten nodig hebt, overweeg een verbetering van uw vergunningspakket of het gebruiken van de ritten van het publiek van de Leesheid waar toepasselijk.

Voor klanten die het **Uitgezochte** vergunningspakket gebruiken, zijn de volgende extra beperkingen specifiek op eenheidsreizen, reizen van toepassing die met een gebeurtenis of een publiekskwalificatie beginnen:

* **UITGEZOCHT pakket: slechts één actie toegestaan in eenheidsreis (ERR_PKG_SELECT_8)**: De eenheidstrajecten kunnen slechts één actiesactiviteit bevatten. U kunt niet meerdere e-mail-, push-, SMS- of andere activiteiten toevoegen binnen dezelfde rit.

* **UITGEZOCHT pakket: geen voorwaarde toegestaan in één enkele reis (ERR_PKG_SELECT_7)**: De activiteiten van de voorwaarde kunnen niet in unitaire reizen worden gebruikt. De reis moet één enkele, lineaire weg zonder vertakkende logica volgen.

* **UITGEZOCHT pakket: geen wachttijd toegestaan in één enkele reis (ERR_PKG_SELECT_6)**: De activiteiten van de wachttijd kunnen niet aan unitaire reizen worden toegevoegd. Handelingen moeten onmiddellijk en zonder vertraging worden uitgevoerd.

* **SELECT pakket: timeout/error overgang van knoop moet aan eindknoop slechts richten (ERR_PKG_SELECT_2)**: Als u onderbreking of foutenovergangen voor een actie, zoals een e-mailactie vormt, moeten deze wegen aan een eindknoop direct richten. Zij kunnen geen verband houden met andere activiteiten of acties tijdens de reis.
...
* **[!UICONTROL Campaign Standard]** -activiteiten kunnen niet worden gebruikt met andere kanaalactiviteiten: kaart, ervaring op basis van code, e-mail, pushberichten, sms, In-app-berichten, web.
* **[!UICONTROL Campaign v7/v8]** -activiteiten kunnen worden gebruikt in combinatie met native-kanaalactiviteiten op dezelfde reis.
...
* De activiteiten in de app kunnen niet worden gebruikt met **[!UICONTROL Campaign Standard]** -activiteiten.
...
* Bij het ingaan van de reis, gebruiken de profielen kenmerkwaarden van de momentopname van het partijpubliek. Nochtans, wanneer een profiel a **&#x200B;**&#x200B;activiteit wacht, verfrist de reis automatisch profielattributen door de recentste gegevens van de Verenigde Dienst van het Profiel (UPS) te halen. Dit betekent dat profielkenmerken tijdens de uitvoering van de reis kunnen veranderen.
* De **Gelezen activiteit van het publiek** kan niet met de activiteiten van Adobe Campaign worden gebruikt.
* De **Gelezen activiteit van het Publiek** kan slechts als eerste activiteit in een reis, of na een bedrijfsgebeurtenisactiviteit worden gebruikt.
* Een reis kan slechts één **Gelezen activiteit van het Publiek** hebben.
* De **Gelezen activiteit van het Publiek** kan slechts één publiek per reis richten. Als u meerdere soorten publiek nodig hebt, voegt u deze eerst samen tot één publiek. [&#x200B; leer hoe te om publiek te combineren gebruikend samenstellingswerkschema&#39;s &#x200B;](../audience/get-started-audience-orchestration.md).
* Elke organisatie kan tot vijf **Gelezen instanties van het publiek** gelijktijdig (gepland of zaken-gebeurtenis teweeggebracht), over alle zandbakken en reizen in werking stellen. Vermijd het hebben van meer dan vijf reizen met **Gelezen publiek** die bij de nauwkeurige tijd beginnen; spreid hen 5 tot 10 minuten uit elkaar. Leer meer over de tarieven van de reisverwerking in [&#x200B; deze sectie &#x200B;](../building-journeys/entry-management.md#journey-processing-rate).
* De productie van zandbak: het systeem beheert verwerking per zandbak met een maximum van 20.000 profielen per seconde die over alle **worden gedeeld las de activiteiten van het Publiek**. Individuele activiteiten kunnen worden geconfigureerd tussen 500 en 20.000 profielen per seconde. Als de sandboxlimieten worden bereikt, kunnen taken in de wachtrij worden geplaatst.
* De onderbrekingen van de verwerking van de baan: **las de banen van het publiek** die niet binnen 12 uren kunnen worden verwerkt worden automatisch schoongemaakt en zullen niet uitvoeren.
...
Zie ook [&#x200B; aanbevelingen en configuratie &#x200B;](../building-journeys/read-audience.md#must-read) voor de Gelezen activiteit van het Publiek.
