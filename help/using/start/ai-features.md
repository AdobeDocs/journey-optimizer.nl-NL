...
title: AI en intelligente functies
description: Leer hoe AI en machine leren de mogelijkheden van Adobe Journey Optimizer verbeteren
feature: Overview
...
Adobe Journey Optimizer maakt gebruik van de kracht van kunstmatige intelligentie en het leren van machines om u te helpen uitzonderlijke klantervaringen te creëren, te optimaliseren en te leveren. Van het genereren van gepersonaliseerde inhoud tot het voorspellen van optimale verzendtijden, stroomlijnen AI-mogelijkheden uw workflow en maximaliseren de impact.
...
AI-agents zijn beschikbaar voor klanten met AI Assistant-toegang. Neem contact op met uw Adobe-vertegenwoordiger voor specifieke licentie- en activeringsgegevens.
...
* **ben specifiek** - verstrek duidelijke, gedetailleerde herinneringen voor betere resultaten
...
[Meer informatie over Afbeelding naar HTML](../email/image-to-html.md)
