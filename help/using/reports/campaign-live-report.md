...
U kunt het live campagnerapport rechtstreeks vanuit uw campagne openen via de **[!UICONTROL Reports]** knop.

![](assets/campaign_report_1.png)

Na het selecteren van **[!UICONTROL Last 24hrs]** tabblad, de campagne **[!UICONTROL Live report]** Deze pagina wordt weergegeven met de volgende tabbladen:
