...
De **[!UICONTROL Journey Statistics]** Belangrijkste Indicatoren van Prestaties (KPIs) functioneren als volledig omringend dashboard, dat een analyse van essentiële metriek verstrekt verbonden aan uw reis in de afgelopen 24 uren. Dit omvat details zoals het aantal ingegane profielen en gevallen van mislukte individuele reizen, die een uitvoerig inzicht in de doeltreffendheid van uw reis en niveau van betrokkenheid aanbieden.
