...
title: Lijst met fouten
description: Meer informatie over fouten die optreden tijdens het verzenden
feature: Reporting
...
# Redenen voor fouten {#error-list}
...
| EmailNoAddressDefinedInPreset | 050021 | Email | Er wordt een uitsluitingsgebeurtenis gegenereerd wanneer het uitvoeringsadres niet in het oppervlak is gedefinieerd. |
