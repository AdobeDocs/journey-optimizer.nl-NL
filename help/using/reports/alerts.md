...
1. Blader naar de reisinventaris en selecteer de optie **[!UICONTROL Subscribe to alerts]** voor een specifieke reis.
   ...
   ![&#x200B; het Abonneren aan een alarm voor een specifieke reis &#x200B;](assets/subscribe-journey-alert.png){width=80%}
...
Fouten in aangepaste handelingen kunnen om verschillende redenen optreden. U kunt:
...
Om dit te vermijden, kunt u de gegevens in stapgebeurtenissen vragen om te begrijpen waar en waarom het profiel in de reis ontbrak.
