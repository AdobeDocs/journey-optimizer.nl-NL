...
* Signaleringen die specifiek zijn voor reizen:
   ...
   * het [&#x200B; Gegraveerde 1&rbrace; alarm van de Actie van de Douane Beheerd van de Actie](#alert-custom-action-capping)
...
1. Kies de waarschuwing(en). Het volgende alarm is beschikbaar: [&#x200B; het Tarief van de Weigering van het Profiel dat &#x200B;](#alert-discard-rate) wordt overschreden, [&#x200B; het Tarief van de Fout van de Actie van de Douane overschreden &#x200B;](#alert-custom-action-error-rate), [&#x200B; het Tarief van de Fout van het Profiel dat &#x200B;](#alert-profile-error-rate), [&#x200B; Gepubliceerde Weg &#x200B;](#alert-journey-published), [&#x200B; Afgewerkte Weg &#x200B;](#alert-journey-finished), en [&#x200B; Gecteerde die&rbrace; Actie van de Actie van de Afbeelding in werking van de Aangepast.](#alert-custom-action-capping)
...
>[!AVAILABILITY]
>
>Deze waarschuwing is momenteel beschikbaar met beperkte functionaliteit. U kunt zich wel op deze waarschuwing abonneren, maar de meldingen zijn nog niet volledig operationeel.
