...
1. Open uw reis en sleep vervolgens een **[!UICONTROL Action]** -activiteit vanuit de **[!UICONTROL Actions]** -sectie van het palet. Leer meer over de [ activiteit van de Actie ](../building-journeys/journey-action.md).
...
1. Selecteer **[!UICONTROL Email]** als actietype.
...
1. U wordt naar het tabblad **[!UICONTROL Actions]** geleid. Selecteer of maak de e-mailconfiguratie die u wilt gebruiken. [Meer informatie](email-settings.md)

   ![](assets/email-action-config.png)

1. Daarnaast:

   * U kunt afkapregels toepassen op uw e-mailactie door een regel te selecteren die is ingesteld in de vervolgkeuzelijst **[!UICONTROL Business rules]** . [Meer informatie](../conflict-prioritization/channel-capping.md)
...
1. Selecteer de knop **[!UICONTROL Edit content]** en maak de gewenste inhoud met de Designer-e-mail. [Meer informatie](#define-email-content)
