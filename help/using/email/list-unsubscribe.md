...
>
>Voor de **[!UICONTROL Mailto (unsubscribe)]** optie, moet u de nieuwe vraagparameters gebruiken die in **worden beschreven Brievenbus (unsubscribe) met douanekenmerken (Beperkte Beschikbaarheid)** sectie [&#x200B; hieronder &#x200B;](#configure-decrypt-api).
...
>[!NOTE]
>
>De volgorde van de UTM-parameters die aan de URL worden toegevoegd, is willekeurig en kan niet worden ingesteld. Als uw systeem parameters in een specifieke orde vereist, zult u hen op uw kant moeten ontleden en opnieuw in orde brengen.
...
>[!CAUTION]
>
>Als u de vorige implementatie gebruikte (bijvoorbeeld: https://platform.adobe.io/journey/imp/consent/decrypt?emailParams=&lt;v1.xxx>), moet u de nieuwe parameters **emailParamsSub** en **emailParamsBody** gebruiken in plaats van &lt;ph id=&#39;f 226&#39;/>emailParams **.** Neem contact op met uw Adobe-vertegenwoordiger voor meer informatie.
