...
>[!CAUTION]
>
>Wanneer zowel het **etiket** als **URL** van een knoop in een fragment editable worden gemaakt, toont het volgen rapporten URL in plaats van het knoopetiket. In het veld `_experience.customerJourneyManagement.messageInteraction.label` in de volgende gegevensset wordt de URL-waarde geregistreerd.
