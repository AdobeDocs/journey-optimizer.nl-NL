...
De zes stappen hieronder laten u door het volledige proces van de gegevensopstelling, van identiteitsconfiguratie aan het verifiëren dat de gegevens correct in Journey Optimizer stromen:

1. Uw identiteitsstrategie definiëren
1. Ontwerpschema&#39;s voor profiel- en gebeurtenisgegevens
1. Profielgebaseerde datasets maken
1. Gegevens uit uw bronnen verzamelen
1. Gegevensbronnen configureren in Journey Optimizer
1. Gegevens bijhouden, feedback geven en gegevens over reizen controleren

+++ Uw identiteitsstrategie definiëren
...
+++ Gegevens uit uw bronnen verzamelen
...
+++ Gegevensbronnen configureren in Journey Optimizer
...
+++ Gegevens bijhouden, feedback geven en gegevens over reizen controleren
...
Leer hoe u XDM-schema&#39;s maakt in Adobe Experience Platform, de juiste klasse- en veldgroepen kiest en uw profielkenmerken en gedragsgebeurtenissen modelleert.

[Meer informatie](get-started-schemas.md)
:::
...
Begrijp hoe te om profiel-toegelaten en gebeurtenisdatasets tot stand te brengen, gegevensopname te controleren, en de systeem-geproduceerde datasets te onderzoeken die Journey Optimizer automatisch voor het volgen, terugkoppelt, en gebeurtenissen van de reisstap leidt.

[Meer informatie](get-started-datasets.md)
:::
...
Stapsgewijze instructies voor het instellen van de ingebouwde Adobe Experience Platform-gegevensbron en optionele externe gegevensbronnen om profielvelden en externe API-reacties binnen uw reizen beschikbaar te maken.

[Meer informatie](../datasource/about-data-sources.md)
:::
...
Ontdek hoe u berichten tijdens runtime verrijkt met referentie- of transactiegegevens van AEP-gegevenssets, zonder die gegevens op te slaan in het realtime-klantprofiel.

[Meer informatie](lookup-aep-data.md)
:::
...
De Dienst van de Vraag van het gebruik om de datasets van Journey Optimizer te analyseren, te verifiëren dat de gebeurtenissen correct stromen, en rapportvragen bij te bouwen verzenden, open, klik, en stuitgegevens.

[Meer informatie](get-started-queries.md)
:::
...
Ontdek hoe het Real-Time klantprofiel in Journey Optimizer werkt en hoe u in de gebruikersinterface van het platform kunt bladeren naar individuele profielen van klanten, deze kunt inspecteren en valideren.

[Meer informatie](../audience/get-started-profiles.md)
:::
