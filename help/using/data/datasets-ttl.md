...
De lijst hieronder maakt een lijst van alle beïnvloede datasets en hun respectieve tijd-aan-Leef in het gegevensmeer en de [&#x200B; Opslag van het Profiel &#x200B;](https://experienceleague.adobe.com/docs/experience-platform/profile/home.html?lang=nl-NL#profile-data-store){target="_blank"}.
...
| Dataset voor tweede feedbackgebeurtenis van AJO | 13 maanden | nvt |
...
TTL is slechts op tijdreeksdatasets van toepassing. Gegevenssets van het type records (zoals entiteitsgegevens, classificatiegegevenssets en gegevensbanken voor besluitvormingsobjecten) zijn niet onderworpen aan GVTO en verschijnen daarom niet in de tabel met betrokken gegevensbestanden hierboven.
