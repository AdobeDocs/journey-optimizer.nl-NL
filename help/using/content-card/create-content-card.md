...
1. Selecteer **[!UICONTROL Card]** als actietype.

   ![](assets/content-card-jo-1.png)

   >[!NOTE]
   >
   >Aangezien **Kaart** een binnenkomende ervaringsactiviteit is, komt het met een 3 dagen **wachten** activiteit. [Meer informatie](../building-journeys/wait-activity.md#auto-wait-node)
...
1. U wordt naar het tabblad **[!UICONTROL Actions]** geleid. Van daar, selecteer of creeer de configuratie van de inhoudskaart aan gebruik. [Meer informatie](content-card-configuration.md)
...
1. U kunt een of meer binnenkomende acties toevoegen aan uw inhoudskaart door op de knop **[!UICONTROL Add action]** te klikken. [Meer informatie](../building-journeys/journey-action.md#multi-action)
...
1. Selecteer een [&#x200B; configuratie Inbox &#x200B;](../inbox/inbox-configuration.md) die de inbox oppervlakte voor deze **kaart van de Inhoud** bepaalt.
