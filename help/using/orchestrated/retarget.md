...
Op feedback gebaseerde regel voor opnieuw toewijzen stelt u in staat ontvangers opnieuw als doel in te stellen op basis van gebeurtenissen voor het verzenden van berichten die zijn vastgelegd in het **[!UICONTROL Message Feedback]** -schema. Deze gebeurtenissen omvatten uitkomsten zoals berichten die worden verzonden, geopend, teruggestuurd of gemarkeerd als spam.
...
1. Om snel aan de slag te gaan, kunt u een ingebouwd filter **[!UICONTROL Campaign Feedback]** gebruiken om ontvangers te richten op basis van gebeurtenissen voor het verzenden van berichten.

   +++ Gedetailleerd, stap voor stap

   1. Klik in de **[!UICONTROL Rule Builder]** op **[!UICONTROL Select or save a filter]** en kies **[!UICONTROL Campaign feedback]** in de lijst.
   ...
   1. Klik ![&#x200B; omslagpictogram &#x200B;](assets/do-not-localize/folder-search.svg) om de specifieke campagne te selecteren u wilt opnieuw richten. U hebt twee opties:
      ...
      * **[!UICONTROL Campaign from transition]**: Verwijs naar een campagne van een vorige activiteit in uw Geordende campagne.

   +++

1. U kunt ook handmatig aangepaste regels maken. Klik in de **[!UICONTROL Rule Builder]** op **[!UICONTROL Add Condition]** en selecteer **[!UICONTROL Message Feedback]** in de **[!UICONTROL Attributes Picker]** . Klik **[!UICONTROL Confirm]** om de Terugkoppeling van het a **Bericht tot stand te brengen bestaat zoals** voorwaarde.
...
Het volgen-gebaseerde opnieuw richten van regel richt ontvangers die op hun interactie met een bericht worden gebaseerd, gebruikend gegevens van het **[!UICONTROL Email Tracking]** schema. Hiermee worden gebruikersacties vastgelegd, zoals het openen van e-mail en het klikken op koppelingen.
...
1. Om snel aan de slag te gaan, kunt u een ingebouwd filter **[!UICONTROL Campaign Feedback]** gebruiken om ontvangers te richten op basis van gebeurtenissen voor het verzenden van berichten.
   ...
   1. Selecteer de filterregel en kies de **[!UICONTROL Behavior]** die u als doel wilt instellen, zoals **[!UICONTROL Message opened]** of **[!UICONTROL Message clicked]** .
...
1. U kunt ook handmatig aangepaste regels maken. Klik in de **[!UICONTROL Rule Builder]** op **[!UICONTROL Add Condition]** en selecteer **[!UICONTROL Email Tracking]** in de **[!UICONTROL Attributes Picker]** .
