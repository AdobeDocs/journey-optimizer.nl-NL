...
|-----|------------|
| ![](assets/last-24hours.png){zoomable="yes"}{width="50%"} | Met de **[!UICONTROL Live report]** kunt u de impact en prestaties van uw georkestreerde campagnes in een ingebouwd dashboard in real-time meten en visualiseren. Gegevens zijn beschikbaar in de **[!UICONTROL Live report]** zodra de georkestreerde campagne wordt uitgevoerd via het menu **[!UICONTROL View last 24 hours report]** . Leer meer over levende rapporten [ in deze sectie ](../reports/live-report.md). |
| ![](assets/all-time-report.png){zoomable="yes"}{width="50%"} | De geordende campagnerapportage is volledig geïntegreerd met de mogelijkheden van Customer Journey Analytics, die rapportering over beide platforms standaardiseren en gegevensconsistentie en betrouwbaarheid verbeteren.  Leer meer over alle tijdrapporten [ in deze sectie ](../reports/report-gs-cja.md). |
