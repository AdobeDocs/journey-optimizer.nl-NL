...
Als u een geordende campagne wilt testen, opent u de campagne en selecteert u **[!UICONTROL Start]** . Elke activiteit in de campagne wordt opeenvolgend uitgevoerd tot het einde van het canvas wordt bereikt.

![&#x200B; knoop van het Begin in de toolbar van het campagnecanvas &#x200B;](assets/campaign-start.png){zoomable="yes"}

Voor **teweeggebrachte georkesterde campagnes**, wacht het systeem op een API vraag om de campagne te beginnen. U moet het signaal verzenden om de test voort te zetten. [&#x200B; Leer hoe te om signaal-teweeggebrachte campagnes &#x200B;](trigger-orchestrated-campaign.md#complete-and-test) te testen.
...
Als u kanaalactiviteiten hebt toegevoegd aan het canvas, kunt u de inhoud van uw berichten voorvertonen en testen met de knop **[!UICONTROL Simulate Content]** . [&#x200B; Leer hoe te met kanaalactiviteiten te werken en inhoud &#x200B;](activities/channels.md#simulate-content-test-profiles) te simuleren.
...
De campagne is niet gepubliceerd en de workflow is gestopt. De campagne keert aan **1&rbrace; status van het Ontwerp terug &lbrace;.** U kunt de geïdentificeerde kwesties nu bevestigen, dan [&#x200B; test de campagne &#x200B;](#test) en [&#x200B; publiceren het &#x200B;](#publish) opnieuw wanneer klaar.
